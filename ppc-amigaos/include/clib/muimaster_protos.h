...
LONG    MUI_RequestA           (Object *app, Object *win, ULONG flags, CONST_STRPTR title, CONST_STRPTR gadgets, CONST_STRPTR format, APTR params);
LONG    MUI_Request            (Object *app, Object *win, ULONG flags, CONST_STRPTR title, CONST_STRPTR gadgets, CONST_STRPTR format, ...);
LONG    MUI_Error              (VOID);
APTR    MUI_AllocAslRequest    (ULONG reqType, struct TagItem *tagList);
APTR    MUI_AllocAslRequestTags(ULONG reqType, Tag Tag1, ...);
...
LONG                    MUI_ObtainPen        (struct MUI_RenderInfo *mri, const struct MUI_PenSpec *spec, ULONG flags);
