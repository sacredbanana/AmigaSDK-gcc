...
#ifdef __amigaos4__
#define BASE_OR_IFACE_PARAM  struct CharsetIFace            *csi
#define BASE_OR_MIFACE_PARAM struct LibraryManagerInterface *csmi
#define BASE_OR_MIFACE_ARG                                   csmi
#define FETCHBASE            struct DriverBase              *db = (struct DriverBase *)csi->Data.LibBase;
#define FETCHBASEM           struct DriverBase              *db = (struct DriverBase *)csmi->Data.LibBase;
...
#ifndef __amigaos4__
extern CONST struct LibInitStruct LibInitTable;
#endif
...
#ifdef VECTABLE_68K
extern VOID * VecTable68K[]; /* charset_68k.S */
#endif
...
#ifdef __amigaos4__
STATIC struct Library * LIB_Open(struct LibraryManagerInterface *csmi,
                                 ULONG version)
#else
                            ...
                            REG(d0, ULONG character))
{
    ...
    {
        /* Only TAB and SPACE separate words */
        return TRUE;
    }
    return FALSE;
}
