...
#define INTERNAL_LANGUAGEDRIVERS_H

/*
**    $VER: languagedrivers.h 51.7 (10.11.2005)
**
**    language driver stuff for locale.library
**
**    (C) Copyright 1991-2005 Hyperion Entertainment VOF and Amiga, Inc.
**        All Rights Reserved
*/
 ...
 * returned by the GetDriverInfo() entry point of a language or charset
 * driver.
 *
 * The value returned by GetDriverInfo() specifies which function this driver
 * implements. If any functions are not implemented in a language driver,
 * then the equivalent functions in the charset driver are used instead.
 * If not implemented in the charset driver, then the equivalent functions
 * in locale.library are used instead. These built-in functions
 * are for the english language and ISO-8859-1 charset.
 */
...
#endif /* INTERNAL_LANGUAGEDRIVERS_H */
