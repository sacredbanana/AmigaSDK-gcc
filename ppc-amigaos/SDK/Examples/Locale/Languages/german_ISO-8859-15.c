...
#include "german_ISO-8859-15.language_rev.h"

#define LIBNAME "german_ISO-8859-15.language"

#define OWN_STRNCMP

/* constants for GetLocaleStr() */
#define GLS_CODE         "deu"        /* ISO-639-2/T 3-letter lowercase language code */

#define GLS_DAY_1        "Sonntag"    /* Sunday    */
#define GLS_DAY_2        "Montag"     /* Monday    */
#define GLS_DAY_3        "Dienstag"   /* Tuesday   */
#define GLS_DAY_4        "Mittwoch"   /* Wednesday */
#define GLS_DAY_5        "Donnerstag" /* Thursday  */
#define GLS_DAY_6        "Freitag"    /* Friday    */
#define GLS_DAY_7        "Samstag"    /* Saturday  */

#define GLS_ABDAY_1      "So"         /* Sun */
#define GLS_ABDAY_2      "Mo"         /* Mon */
#define GLS_ABDAY_3      "Di"         /* Tue */
#define GLS_ABDAY_4      "Mi"         /* Wed */
#define GLS_ABDAY_5      "Do"         /* Thu */
#define GLS_ABDAY_6      "Fr"         /* Fri */
#define GLS_ABDAY_7      "Sa"         /* Sat */

#define GLS_MON_1        "Januar"     /* January   */
#define GLS_MON_2        "Februar"    /* February  */
#define GLS_MON_3        "März"       /* March     */
#define GLS_MON_4        "April"      /* April     */
#define GLS_MON_5        "Mai"        /* May       */
...
#define GLS_MON_12       "Dezember"   /* December  */

#define GLS_ABMON_1      "Jan"        /* Jan */
#define GLS_ABMON_2      "Feb"        /* Feb */
#define GLS_ABMON_3      "Mär"        /* Mar */
#define GLS_ABMON_4      "Apr"        /* Apr */
#define GLS_ABMON_5      "Mai"        /* May */
...
#define GLS_ABMON_12     "Dez"        /* Dec */

#define GLS_YESSTR       "Ja"         /* affirmative response for yes/no queries */
#define GLS_NOSTR        "Nein"       /* negative response for yes/no queries    */

#define GLS_AM_STR       "vorm."      /* AM */
#define GLS_PM_STR       "nachm."     /* PM */
...
#define GLS_YESTERDAYSTR "Gestern"    /* Yesterday */
#define GLS_TODAYSTR     "Heute"      /* Today     */
#define GLS_TOMORROWSTR  "Morgen"     /* Tomorrow  */
#define GLS_FUTURESTR    "Zukunft"    /* Future    */

#define GLS_LANGNAME     "deutsch (¤)" /* native language name */
...
/* Special table for german alphabet
 ...
 */
            ...
            do
            {
                ...
                if ((c1 == 'ß') && (c2 != 'ß') && (length != 1))
                {
                    c1 = 'S';
                    c2 = *string2++;
                    length--;
                }
                else if ((c1 != 'ß') && (c2 == 'ß') && (length != 1))
                {
                    c1 = *string1++;
                    c2 = 'S';
                    length--;
