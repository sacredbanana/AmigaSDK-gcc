...
#include "english_ISO-8859-15.language_rev.h"

#define LIBNAME "english_ISO-8859-15.language"

#define LOWERCASE_FIRST

/* constants for GetLocaleStr() */
#define GLS_CODE         "eng"        /* ISO-639-2/T 3-letter lowercase language code */

#define GLS_DAY_1        "Sunday"     /* Sunday    */
#define GLS_DAY_2        "Monday"     /* Monday    */
#define GLS_DAY_3        "Tuesday"    /* Tuesday   */
#define GLS_DAY_4        "Wednesday"  /* Wednesday */
#define GLS_DAY_5        "Thursday"   /* Thursday  */
#define GLS_DAY_6        "Friday"     /* Friday    */
#define GLS_DAY_7        "Saturday"   /* Saturday  */

#define GLS_ABDAY_1      "Sun"        /* Sun */
#define GLS_ABDAY_2      "Mon"        /* Mon */
#define GLS_ABDAY_3      "Tue"        /* Tue */
#define GLS_ABDAY_4      "Wed"        /* Wed */
#define GLS_ABDAY_5      "Thu"        /* Thu */
#define GLS_ABDAY_6      "Fri"        /* Fri */
#define GLS_ABDAY_7      "Sat"        /* Sat */

#define GLS_MON_1        "January"    /* January   */
#define GLS_MON_2        "February"   /* February  */
#define GLS_MON_3        "March"      /* March     */
#define GLS_MON_4        "April"      /* April     */
#define GLS_MON_5        "May"        /* May       */
#define GLS_MON_6        "June"       /* June      */
#define GLS_MON_7        "July"       /* July      */
#define GLS_MON_8        "August"     /* August    */
#define GLS_MON_9        "September"  /* September */
#define GLS_MON_10       "October"    /* October   */
...
#define GLS_YESSTR       "Yes"        /* affirmative response for yes/no queries */
...
#define GLS_YESTERDAYSTR "Yesterday"  /* Yesterday */
#define GLS_TODAYSTR     "Today"      /* Today     */
#define GLS_TOMORROWSTR  "Tomorrow"   /* Tomorrow  */
#define GLS_FUTURESTR    "Future"     /* Future    */

#define GLS_LANGNAME     "english (¤)" /* native language name */
...
/* Special table for english alphabet
