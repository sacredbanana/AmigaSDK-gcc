...
/* The following are AmigaOS specific definitions. */

/* This should be in <pthreads.h> on AmigaOS but it currently is not. */
#define _POSIX_THREAD_ATTR_STACKSIZE 1

#ifndef PYTHONPATH
#define PYTHONPATH "PYTHON:Lib/,PYTHON:Lib/plat-amiga/,PYTHON:Lib/lib-dynload/,PYTHON:Lib/site-packages/"
#endif
