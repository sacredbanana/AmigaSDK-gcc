...
/*
**    $VER: printer.h 54.16 (22.08.2022)
**
...
/* V44 private commands */
#define PRD_PRIVATECMD     (CMD_NONSTD+13)   /* PRIVATE: do not use! */

/* unimplemented commands */
#define PRD_LASTSAVEDPREFS (CMD_NONSTD+14)   /* PRIVATE: do not use! */
