...
#define MLF_NoLocalEcho (1<<4)                  /* ignore my own messages */
...
#define MLINK_ErrorCode     (MLINK_Base+12)     /* (uint32 *) - Error Code buffer for returning CME_ error codes. */
#define MLINK_Name          (MLINK_Base+13)     /* (STRPTR) - Link name */
#define MLINK_NoLocalEcho   (MLINK_Base+14)     /* (BOOL) - Ignore messages sent from same Node */
...
#define MIDI_ErrorCode          (MIDI_Base+12)  /* (uint32 *) - Error Code buffer for returning CME_ error codes. */
...
#define PackSysExFilter0()              ((uint32)SXFM_Off << 24)
#define PackSysExFilter1(id1)           ((uint32)(SXFM_1Byte | 1) << 24 | (uint32)(id1) << 16)
#define PackSysExFilter2(id1,id2)       ((uint32)(SXFM_1Byte | 2) << 24 | (uint32)(id1) << 16 | (id2) << 8)
#define PackSysExFilter3(id1,id2,id3)   ((uint32)(SXFM_1Byte | 3) << 24 | (uint32)(id1) << 16 | (id2) << 8 | (id3))
