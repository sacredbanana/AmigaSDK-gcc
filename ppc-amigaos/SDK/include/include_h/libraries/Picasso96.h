/*
 * $VER: Picasso96.h 54.16 (22.08.2022)
 *
...
#define RGBFF_YUV420P			(1<<RGBFB_YUV420P)
#define RGBFF_YUV410P			(1<<RGBFB_YUV410P)
#define RGBFF_ALPHA8				(1<<RGBFB_ALPHA8)
...
#define P96PIP_ColorKeyPen					(P96PIP_Dummy+29)
#define P96PIP_NumberOfBuffers			(P96PIP_Dummy+30)
#define P96PIP_VisibleBuffer				(P96PIP_Dummy+31)
#define P96PIP_WorkBuffer					(P96PIP_Dummy+32)
#define P96PIP_DisplayedBuffer			(P96PIP_Dummy+33)
#define P96PIP_ColorKeyARGB					(P96PIP_Dummy+34)
...
#define P96BD_PCIVendorID				(P96BD_Dummy+10)
#define P96BD_PCIProductID				(P96BD_Dummy+11)

#define P96BD_MonitorVendorID           (P96BD_Dummy+12) /* new 2.354 */
#define P96BD_MonitorProduct            (P96BD_Dummy+13) /* new 2.354 */
#define P96BD_MonitorProductID          (P96BD_Dummy+14) /* new 2.354 */
#define P96BD_MonitorHSyncMin           (P96BD_Dummy+15) /* new 2.354 */
#define P96BD_MonitorHSyncMax           (P96BD_Dummy+16) /* new 2.354 */
#define P96BD_MonitorVSyncMin           (P96BD_Dummy+17) /* new 2.354 */
#define P96BD_MonitorVSyncMax           (P96BD_Dummy+18) /* new 2.354 */
#define P96BD_MonitorDotClockMin        (P96BD_Dummy+19) /* new 2.354 */
#define P96BD_MonitorDotClockMax        (P96BD_Dummy+20) /* new 2.354 */
#define P96BD_MonitorInputType          (P96BD_Dummy+21) /* new 2.354 */
#define P96BD_MonitorEDIDVer            (P96BD_Dummy+22) /* new 2.354 */
#define P96BD_MonitorEDIDRev            (P96BD_Dummy+23) /* new 2.354 */
#define P96BD_MonitorDisplayWidth       (P96BD_Dummy+24) /* new 2.354 */
#define P96BD_MonitorDisplayHeight      (P96BD_Dummy+25) /* new 2.354 */

#define P96BD_BoardDriver 			       (P96BD_Dummy+26) /* new 2.359 */
#define P96BD_ChipDriver 			       (P96BD_Dummy+27) /* new 2.359 */
#define P96BD_InternalMemorySize	       (P96BD_Dummy+28) /* new 2.359 */
/************************************************************************/
