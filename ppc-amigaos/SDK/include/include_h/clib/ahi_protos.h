...
struct AHIAudioCtrl * AHI_AllocAudio(Tag tag1, ...) __attribute__((linearvarargs));
...
ULONG AHI_ControlAudio(struct AHIAudioCtrl * AudioCtrl, Tag tag1, ...) __attribute__((linearvarargs));
...
BOOL AHI_GetAudioAttrs(ULONG ID, struct AHIAudioCtrl * Audioctrl, Tag tag1, ...) __attribute__((linearvarargs));
ULONG AHI_BestAudioIDA(struct TagItem * tagList);
ULONG AHI_BestAudioID(Tag tag1, ...) __attribute__((linearvarargs));

/* Functions for the audio mode requester */
struct AHIAudioModeRequester * AHI_AllocAudioRequestA(struct TagItem * tagList);
struct AHIAudioModeRequester * AHI_AllocAudioRequest(Tag tag1, ...) __attribute__((linearvarargs));
BOOL AHI_AudioRequestA(struct AHIAudioModeRequester * Requester, struct TagItem * tagList);
BOOL AHI_AudioRequest(struct AHIAudioModeRequester * Requester, Tag tag1, ...) __attribute__((linearvarargs));
...
void AHI_Play(struct AHIAudioCtrl * Audioctrl, Tag tag1, ...) __attribute__((linearvarargs));
