...
/*
**    $VER: pointerclass.h 54.16 (22.08.2022)
**
...
#define POINTERA_ImageData   (POINTERA_Dummy + 0x07)  // V52
#define POINTERA_Width       (POINTERA_Dummy + 0x08)  // V52
#define POINTERA_Height      (POINTERA_Dummy + 0x09)  // V52
...
/* Pointer type definitions for WA_PointerType (OpenWindowTags() and
