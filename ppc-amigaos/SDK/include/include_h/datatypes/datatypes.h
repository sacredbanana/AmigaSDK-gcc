...
struct DTHookContext
{
    ...
    struct FileInfoBlock * dthc_FIB;          /* Deprecated FileInfoBlock, Use ExamineData from V54+ */
    ...
    uint32                 dthc_BufferLength; /* Length of the buffer */

    /* Fields introduced in V50.
     * They're guaranteed to exists when your comparsion
     * routine is PPC native code.
     */
    uint32                 dthc_Length;       /* size of this structure */
    ...
    /* New in V54. */
    struct ExamineData *   dthc_ExData;       /* Pointer to ExamineData */
};
