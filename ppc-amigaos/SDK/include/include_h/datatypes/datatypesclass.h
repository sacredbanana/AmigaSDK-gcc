...
/*
**    $VER: datatypesclass.h 54.16 (22.08.2022)
**
...
#define DTA_Progressive    (DTA_Dummy+60)
    /* New for V45. (BOOL) Indicate that the object should use
...
#define DTA_CurrentLevel    (DTA_Dummy+61)
    /* New for V45. (ULONG) Notifies the filling level of the object
...
#define STM_DONE            0 /* marks end of DTMethod array */
#define STM_END				STM_DONE
#define STM_PAUSE           1
#define STM_PLAY            2
