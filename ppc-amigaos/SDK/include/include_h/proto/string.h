...
/****************************************************************************/
  ...
  extern struct AmigaOS::Library * StringBase;
 #else
...
/****************************************************************************/
 ...
 #include <intuition/classes.h>
  ...
  #if defined(__cplusplus) && defined(__USE_AMIGAOS_NAMESPACE__)
   extern AmigaOS::Class * StringClass;
  #else
 ...
 #include <interfaces/string.h>
  ...
  #include <inline4/string.h>
 #endif /* __USE_INLINE__ */
 #ifndef CLIB_STRING_PROTOS_H
  #define CLIB_STRING_PROTOS_H 1
 #endif /* CLIB_STRING_PROTOS_H */
 #ifndef __NOGLOBALIFACE__
  #if defined(__cplusplus) && defined(__USE_AMIGAOS_NAMESPACE__)
   extern struct AmigaOS::StringIFace * IString;
  #else
