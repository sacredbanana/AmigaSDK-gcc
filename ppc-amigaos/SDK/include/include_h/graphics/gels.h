...
/* address of special animation procedure */
    WORD            (*AnimCRoutine)(struct GraphicsIFace *, struct AnimComp *);
...
/* --------------------- USER VARIABLES ----------------------------------- */
    ...
    WORD RingYTrans, RingXTrans; /* ring translation values */
                                 ...
                                 /* address of special animation
                                    procedure */
    WORD (*AnimORoutine)(struct GraphicsIFace *, struct AnimOb *);
...
struct collTable
{
     ...
     */
    LONG (*collPtrs[16])(struct GraphicsIFace *,
                         struct VSprite *,
                         struct VSprite *);
};
