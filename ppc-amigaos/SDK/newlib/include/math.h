...
#endif /* !defined(__STRICT_ANSI__) || __ISO_C_VISIBLE >= 1999 */

extern double drem (double, double);
extern float dremf (float, float);
#if defined(__amigaos4__) || defined(__CYGWIN__)
extern long double dreml (long double, long double);
#endif /* __amigaos4__ || __CYGWIN__ */
...
#ifdef __amigaos4__
#define __signgam_r(ptr) signgam
#else
