...
#define GLS_DAY_1        "Søndag"     /* Sunday    */
...
#define GLS_DAY_7        "Lørdag"     /* Saturday  */

#define GLS_ABDAY_1      "Søn"        /* Sun */
...
#define GLS_YESTERDAYSTR "i går"      /* Yesterday */
...
/* ISO-8859-15 with special handling of ÆØÅ to be sorted after Z,
   thorn as T, Ä=Æ, Ö=Ø, OE=Ø, Ü=Y. */
...
/*186*/ V_O,        /* º */
/*187*/ V_QUOTE,    /* » */
/*188*/ V_OSLASH,   /* ¼ */ /* capital ligature OE */ /* OE=Ø */
/*189*/ V_OSLASH,   /* ½ */ /* small ligature OE */ /* OE=Ø */
...
/*195*/ V_A,        /* Ã */
/*196*/ V_AE,       /* Ä */ /* Ä=Æ */
/*197*/ V_ARING,    /* Å */ /* Extra letter 29 of danish alphabet */
/*198*/ V_AE,       /* Æ */ /* Extra letter 27 of danish alphabet */
/*199*/ V_C,        /* Ç */
/*200*/ V_E,        /* È */
/*201*/ V_E,        /* É */
/*202*/ V_E,        /* Ê */
...
/*214*/ V_OSLASH,   /* Ö */ /* Ö=Ø */
/*215*/ V_PUNCT,    /* × */
/*216*/ V_OSLASH,   /* Ø */ /* Extra letter 28 of danish alphabet */
/*217*/ V_U,        /* Ù */
/*218*/ V_U,        /* Ú */
/*219*/ V_U,        /* Û */
/*220*/ V_Y,        /* Ü */ /* Ü=Y */
...
/*227*/ V_A,        /* ã */
/*228*/ V_AE,       /* ä */ /* Ä=Æ */
/*229*/ V_ARING,    /* å */ /* Extra letter 29 of danish alphabet */
/*230*/ V_AE,       /* æ */ /* Extra letter 27 of danish alphabet */
/*231*/ V_C,        /* ç */
/*232*/ V_E,        /* è */
/*233*/ V_E,        /* é */
/*234*/ V_E,        /* ê */
...
/*246*/ V_OSLASH,   /* ö */ /* Ö=Ø */
/*247*/ V_PUNCT,    /* ÷ */
/*248*/ V_OSLASH,   /* ø */ /* Extra letter 28 of danish alphabet */
/*249*/ V_U,        /* ù */
/*250*/ V_U,        /* ú */
/*251*/ V_U,        /* û */
/*252*/ V_Y,        /* ü */ /* Ü=Y */
 ...
 */
            ...
            do
            {
                ...
                if (((c1 == 'Þ') || (c1 == 'þ')) && !((c2 == 'Þ') || (c2 == 'þ')) && (length != 1))
                {
                    c1 = 'H';
                    c2 = *string2++;
                    length--;
                }
                else if (!((c1 == 'Þ') || (c1 == 'þ')) && ((c2 == 'Þ') || (c2 == 'þ')) && (length != 1))
                {
                    c1 = *string1++;
                    c2 = 'H';
                    length--;
        ...
        case SC_COLLATE2:
            ...
            do
            {
                ...
                if (c1 != c2)
                {
                    if (table[c1] == table[c2])
                    {
                        if (((c1 == 'Þ') || (c1 == 'þ')) && !((c2 == 'Þ') || (c2 == 'þ')))
                        {
                            res = 1;
                        }
                        else if (!((c1 == 'Þ') || (c1 == 'þ')) && ((c2 == 'Þ') || (c2 == 'þ')))
                        {
                            res = -1;
                        }
                        else if ((c1 == 'Þ') && (c2 == 'þ'))
