/*
 * C language and StrnCmp library code by TetiSoft@apg.lahn.de (Detlef Würkner)
 */
...
STATIC CONST CONST_APTR LibFuncTable[] =
{
    ...
    /* public functions */
    &LIB_GetDriverInfo,
    &LIB_Reserved, // ConvToLower
    &LIB_Reserved, // ConvToUpper
    &LIB_GetCodeSet,
    &LIB_GetLocaleStr,
...
/*-------------------------------------------------------------------------*/
/* All following functions now get their library base in A6               */
...
{
    UNUSEDBI
    return GDIF_GETCODESET|GDIF_GETLOCALESTR|GDIF_STRNCMP;
}
