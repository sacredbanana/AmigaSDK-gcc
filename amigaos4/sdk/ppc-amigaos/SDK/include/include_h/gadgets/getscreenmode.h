...
struct gsmRequest
{
    ...
    struct Window * gsmr_Window; /* The window that will be locked when
...
#define RequestScreenMode(obj, win) IIntuition->IDoMethod(obj, GSM_REQUEST, win)
#elif defined (__amigaos4__)
#define RequestScreenMode(obj, win) IDoMethod(obj, GSM_REQUEST, win)
#else
