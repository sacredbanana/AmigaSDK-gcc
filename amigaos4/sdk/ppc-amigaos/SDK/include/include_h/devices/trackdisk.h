...
/*
**
**    $VER: trackdisk.h 54.16 (22.08.2022)
**
...
/*
 * The following commands are deprecated and shouldn't be
 * used by clients (e.g., filesystems). Use the corresponding
 * new style counter parts instead (see devices/newstyle.h)
 * after you have verified that the device supports them.
 * Device implementors may or may not implement these. If
 * implemented, make sure to return them in an NSD query
 * command.
 */
