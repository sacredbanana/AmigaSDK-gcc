...
/*
**    $VER: hardblocks.h 54.16 (22.08.2022)
**
...
**    Copyright (C) 1999 Joanne Dow to be licensed to Amiga Inc
**        All Rights Reserved
**    Copyright (C) 2002 Andrea Vallinotto to be licensed to Hyperion
**        All Rights Reserved
*/
/*    Changes
**      Expanded envec
...
**    Changes for V50
**      Added AmigaOne booter
**      Created new 'BOOT' sector type, to be used for the AmigaOne booter.
**      Obsoleted rdb_BadBlockList
**/
 ...
 *
 *    V44 adds some modest storage spaces for inserting
 ...
 *    ever required.
 *
 *    V50 adds support for booting off the AmigaOne by the use
 *    of the "secondary bootstrap code" in the RDSK. The structure
 *    is also expanded to include the optional filename of the
 *    bootstrapper; this grows the structure to 512 bytes.
 *    The bad block list is now tagged as obsolete, since it was
 *    used for XT drives.
 *
...
struct PartitionBlock
{
    ...
    TEXT  pb_DriveName[32];   /* preferred DOS device name: BSTR form */
