...
/*
**    $VER: preferences.h 54.16 (22.08.2022)
**
...
struct Preferences
{
    /* the default font height - DOSLIB can modify this value on boot. */
    ...
    UBYTE Pad[ 7 ];   /* This was UBYTE WorkName[FILENAME_SIZE];   */
                      /* (temp file for printer) in old versions.  */

    UBYTE PrinterDevPrivateFlags;   /* system private (V51)         */
    ULONG PrtDevOpenDeviceFlags;    /* flags for device below (V51) */
...
#define DIMENSIONS_MASK  (BOUNDED_DIMENSIONS | ABSOLUTE_DIMENSIONS | \
