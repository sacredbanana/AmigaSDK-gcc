...
/****************************************************************************/
  ...
  extern struct AmigaOS::Library * FuelGaugeBase;
 #else
...
/****************************************************************************/
 ...
 #include <intuition/classes.h>
  ...
  #if defined(__cplusplus) && defined(__USE_AMIGAOS_NAMESPACE__)
   extern AmigaOS::Class * FuelGaugeClass;
  #else
 ...
 #include <interfaces/fuelgauge.h>
  ...
  #include <inline4/fuelgauge.h>
 #endif /* __USE_INLINE__ */
 #ifndef CLIB_FUELGAUGE_PROTOS_H
  #define CLIB_FUELGAUGE_PROTOS_H 1
 #endif /* CLIB_FUELGAUGE_PROTOS_H */
 #ifndef __NOGLOBALIFACE__
  #if defined(__cplusplus) && defined(__USE_AMIGAOS_NAMESPACE__)
   extern struct AmigaOS::FuelGaugeIFace * IFuelGauge;
  #else
