...
struct NewGadget
{
    WORD             ng_LeftEdge;   /* gadget position */
    WORD             ng_TopEdge;    /* gadget position */
    WORD             ng_Width;      /* gadget size */
    WORD             ng_Height;     /* gadget size */
    STRPTR           ng_GadgetText; /* gadget label */
...
#define GTMENUITEM_USERDATA(menuitem) \
        (* ( (APTR *)(((struct MenuItem *)menuitem)+1) ) )
...
#define GTPA_IndicatorWidth  GT_TagBase+19 /* Width of current-color
                                            * indicator */
#define GTPA_IndicatorHeight GT_TagBase+20 /* Height of current-color
                                            * indicator */
...
#define GTST_String          GT_TagBase+45 /* String gadget's displayed
                                            * string */
...
#define GTLV_ShowSelected    GT_TagBase+53 /* show selected entry beneath
                                            * listview, set tag data = NULL
                                            * for display-only, or pointer
...
#define GTMX_Spacing         GT_TagBase+61 /* Added to font height to
                                            * figure spacing between mx
                                            * choices. Use this instead of
...
#define GTMN_FullMenu        GT_TagBase+62 /* Asks CreateMenus() to
                                            * validate that this is a complete
                                            * menu structure
                                            */
...
#define GT_Underscore        GT_TagBase+64 /* ti_Data points to the symbol
                                            * that preceeds the character you'd
                                            * like to underline in a gadget
                                            * label
                                            */
...
#define GTMN_Checkmark       GT_TagBase+65 /* ti_Data is checkmark image
                                              to use */
#define GTMN_AmigaKey        GT_TagBase+66 /* ti_Data is Amiga-key image
                                              to use */
...
#define GTLV_CallBack        GT_TagBase+83 /* general-purpose listview call
                                            * back
                                            */
#define GTLV_MaxPen          GT_TagBase+84 /* maximum pen number used by call
                                            * back
                                            */
...
/* New to V50 GadTools.  Ignored by GadTools V36-V40 */
#define GTBB_EdgesOnly       GT_TagBase+90 /* Make BevelBox edges-only */

/* New to V51.4 GadTools.  Ignored by older versions */
#define GTMN_CharSet         GT_TagBase+91 /* Menu charset */

/* New to V51.7 GadTools.  Ignored by older versions. Read-only */
