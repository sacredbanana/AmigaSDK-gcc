...
#define SJA_Type         (SJA_Dummy+1) /* force type to mouse,
                                        * joy, game controller */
#define SJA_Reinitialize (SJA_Dummy+2) /* free potgo bits,
                                        * reset to autosense   */
...
#define JP_BUTTON_MASK     ( JPF_BUTTON_BLUE    | JPF_BUTTON_RED     | \
