...
/*
** $VER: mididefs.h 54.16 (22.08.2022)
** 
...
**                       - Darius Taghavy
**
** Copyright 1988 Commodore Amiga
**
...
#define MRP_CoarseTune	0x0002
#define MRP_CourseTune	0x0002 // spelling error
...
#define MakeMIDX(id0,id1,id2) ((uint32)(id0)<<16 | (id1)<<8 | (id2))
