...
#define BEVEL_FillPattern (BEVEL_Dummy+13)
    /* (UWORD *) (OM_NEW/OM_SET) - optional fill pattern for inner
       fill/disable */
...
#define BVS_NONE         4 /* Do not render any bevel. */
 ...
 * The vertical bar is mostly used as a seperator in horizontal groups and
 * the horizontal bar is used as a seperator in vertical groups.
 *
