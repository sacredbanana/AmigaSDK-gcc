...
#define EndUpdate(___layer, ___flag) \
      LP2NR(0x54, EndUpdate , struct Layer *, ___layer, a0, ULONG, ___flag, d0,\
      , LAYERS_BASE_NAME)
...
#define WhichLayer(___li, ___x, ___y) \
      LP3(0x84, struct Layer *, WhichLayer , struct Layer_Info *, ___li, a0, LONG, ___x, d0, LONG, ___y, d1,\
      , LAYERS_BASE_NAME)
...
#define SortLayerCR(___layer, ___dx, ___dy) \
      LP3NR(0xd2, SortLayerCR , struct Layer *, ___layer, a0, LONG, ___dx, d0, LONG, ___dy, d1,\
      , LAYERS_BASE_NAME)
...
#define LayerOccluded(___layer) \
      LP1(0xde, BOOL, LayerOccluded , struct Layer *, ___layer, a0,\
      , LAYERS_BASE_NAME)

#define HideLayer(___layer) \
      LP1(0xe4, LONG, HideLayer , struct Layer *, ___layer, a0,\
      , LAYERS_BASE_NAME)

#define ShowLayer(___layer, ___in_front_of) \
      LP2(0xea, LONG, ShowLayer , struct Layer *, ___layer, a0, struct Layer *, ___in_front_of, a1,\
      , LAYERS_BASE_NAME)

#define SetLayerInfoBounds(___li, ___bounds) \
      LP2(0xf0, BOOL, SetLayerInfoBounds , struct Layer_Info *, ___li, a0, CONST struct Rectangle *, ___bounds, a1,\
      , LAYERS_BASE_NAME)
