...
#define BUTTON_TextPadding		(BUTTON_Dummy+40)
	/* (BOOL) Put some extra horizontal padding around button's text label? */
...
#define BUTTON_EraseBackground		(BUTTON_Dummy+57) /* OS4ONLY */

#define BUTTON_HorizAlignment		(BUTTON_Dummy+58) /* OS4ONLY */

#define BUTTON_VertAlignment		(BUTTON_Dummy+59) /* OS4ONLY */
...
#define BALIGN_LEFT   0 /* OS4ONLY */
#define BALIGN_TOP    0 /* OS4ONLY */
#define BALIGN_CENTER 1 /* OS4ONLY */
#define BALIGN_RIGHT  2 /* OS4ONLY */
#define BALIGN_BOTTOM 2 /* OS4ONLY */
...
#define BAG_POPDATE	13	/* popup date glyph (V47) */
#define BAG_POPCOLOR	14	/* popup colour glyph (V47) */
#define BAG_POPCOLOUR	BAG_POPCOLOR
