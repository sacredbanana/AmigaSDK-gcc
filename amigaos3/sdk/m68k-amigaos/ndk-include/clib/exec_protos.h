...
/*------ misc ---------------------------------------------------------*/
APTR  __stdargs CreateIORequest( struct MsgPort *port, ULONG size );
...
/*------ task trees ---------------------------------------------------*/
/*------ future expansion ---------------------------------------------*/
APTR  __stdargs CachePreDMA( CONST_APTR address, ULONG *length, ULONG flags );
VOID  __stdargs CachePostDMA( CONST_APTR address, ULONG *length, ULONG flags );
/*------ New, for V39*/
