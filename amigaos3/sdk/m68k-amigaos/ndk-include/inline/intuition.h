...
#define DrawImage(___rp, ___image, ___leftOffset, ___topOffset) \
      LP4NR(0x72, DrawImage , struct RastPort *, ___rp, a0, CONST struct Image *, ___image, a1, WORD, ___leftOffset, d0, WORD, ___topOffset, d1,\
      , INTUITION_BASE_NAME)
...
#define ReportMouse1(___window, ___flag) \
      LP2NR(0xea, ReportMouse1 , struct Window *, ___window, a0, BOOL, ___flag, d0,\
      , INTUITION_BASE_NAME)
...
#define EasyRequestArgs(___window, ___easyStruct, ___idcmpPtr, ___args) \
      LP4(0x24c, LONG, EasyRequestArgs , struct Window *, ___window, a0, CONST struct EasyStruct *, ___easyStruct, a1, ULONG *, ___idcmpPtr, a2, CONST_APTR, ___args, a3,\
      , INTUITION_BASE_NAME)

#ifndef NO_INLINE_VARARGS
#define EasyRequest(___window, ___easyStruct, ___idcmpPtr, ...) \
     ({_sfdc_vararg _args[] = { __VA_ARGS__ }; EasyRequestArgs((___window), (___easyStruct), (___idcmpPtr), (CONST_APTR) _args); })
...
#define BuildEasyRequest(___window, ___easyStruct, ___idcmp, ...) \
     ({_sfdc_vararg _args[] = { __VA_ARGS__ }; BuildEasyRequestArgs((___window), (___easyStruct), (___idcmp), (CONST_APTR) _args); })
#endif /* !NO_INLINE_VARARGS */
...
#define OpenWindowTags(___newWindow, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; OpenWindowTagList((___newWindow), (CONST struct TagItem *) _tags); })
...
#ifndef NO_INLINE_STDARG
#define OpenScreenTags(___newScreen, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; OpenScreenTagList((___newScreen), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define DrawImageState(___rp, ___image, ___leftOffset, ___topOffset, ___state, ___drawInfo) \
      LP6NR(0x26a, DrawImageState , struct RastPort *, ___rp, a0, CONST struct Image *, ___image, a1, WORD, ___leftOffset, d0, WORD, ___topOffset, d1, ULONG, ___state, d2, struct DrawInfo *, ___drawInfo, a2,\
      , INTUITION_BASE_NAME)

#define PointInImage(___point, ___image) \
      LP2(0x270, BOOL, PointInImage , ULONG, ___point, d0, CONST struct Image *, ___image, a0,\
      , INTUITION_BASE_NAME)

#define EraseImage(___rp, ___image, ___leftOffset, ___topOffset) \
      LP4NR(0x276, EraseImage , struct RastPort *, ___rp, a0, CONST struct Image *, ___image, a1, WORD, ___leftOffset, d0, WORD, ___topOffset, d1,\
      , INTUITION_BASE_NAME)
...
#ifndef NO_INLINE_STDARG
#define NewObject(___classPtr, ___classID, ___tag1, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1, __VA_ARGS__ }; NewObjectA((___classPtr), (___classID), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define SetAttrs(___object, ___tag1, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1, __VA_ARGS__ }; SetAttrsA((___object), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define SetGadgetAttrs(___gadget, ___window, ___requester, ___tag1, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1, __VA_ARGS__ }; SetGadgetAttrsA((___gadget), (___window), (___requester), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define NextObject(___objectPtrPtr) \
      LP1(0x29a, APTR, NextObject , CONST_APTR, ___objectPtrPtr, a0,\
      , INTUITION_BASE_NAME)
...
#ifndef NO_INLINE_VARARGS
#define DoGadgetMethod(___gad, ___win, ___req, ___MethodID, ...) \
    ({_sfdc_vararg _message[] = { ___MethodID, __VA_ARGS__ }; DoGadgetMethodA((___gad), (___win), (___req), (Msg) _message); })
#endif /* !NO_INLINE_VARARGS */
...
#ifndef NO_INLINE_STDARG
#define SetWindowPointer(___win, ___tag1, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1, __VA_ARGS__ }; SetWindowPointerA((___win), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define ShowWindow(___window, ___other) \
      LP2(0x342, BOOL, ShowWindow , struct Window *, ___window, a0, struct Window *, ___other, a1,\
      , INTUITION_BASE_NAME)

#define HideWindow(___window) \
      LP1(0x348, BOOL, HideWindow , struct Window *, ___window, a0,\
      , INTUITION_BASE_NAME)

#define IntuitionControlA(___object, ___taglist) \
      LP2(0x4bc, ULONG, IntuitionControlA , APTR, ___object, a0, CONST struct TagItem *, ___taglist, a1,\
      , INTUITION_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define IntuitionControl(___object, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; IntuitionControlA((___object), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
