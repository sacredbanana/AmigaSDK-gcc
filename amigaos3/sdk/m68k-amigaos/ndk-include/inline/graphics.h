...
#define CMove(___copList, ___destination, ___data) \
      LP3(0x174, LONG, CMove , struct UCopList *, ___copList, a1, APTR, ___destination, d0, WORD, ___data, d1,\
      , GRAPHICS_BASE_NAME)

#define CWait(___copList, ___v, ___h) \
      LP3(0x17a, LONG, CWait , struct UCopList *, ___copList, a1, WORD, ___v, d0, WORD, ___h, d1,\
      , GRAPHICS_BASE_NAME)
...
#define GfxAssociate(___associateNode, ___gfxNodePtr) \
      LP2NR(0x2a0, GfxAssociate , APTR, ___associateNode, a0, APTR, ___gfxNodePtr, a1,\
      , GRAPHICS_BASE_NAME)
...
#define GfxLookUp(___associateNode) \
      LP1(0x2be, APTR, GfxLookUp , CONST_APTR, ___associateNode, a0,\
      , GRAPHICS_BASE_NAME)
...
#define VideoControlTags(___colorMap, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; VideoControl((___colorMap), (struct TagItem *) _tags); })
...
#define GetDisplayInfoData(___handle, ___buf, ___size, ___tagID, ___displayID) \
      LP5(0x2f4, ULONG, GetDisplayInfoData , DisplayInfoHandle, ___handle, a0, APTR, ___buf, a1, ULONG, ___size, d0, ULONG, ___tagID, d1, ULONG, ___displayID, d2,\
      , GRAPHICS_BASE_NAME)
...
#define WeighTAMatch(___reqTextAttr, ___targetTextAttr, ___targetTags) \
      LP3(0x324, WORD, WeighTAMatch , CONST struct TextAttr *, ___reqTextAttr, a0, CONST struct TextAttr *, ___targetTextAttr, a1, CONST struct TagItem *, ___targetTags, a2,\
      , GRAPHICS_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define WeighTAMatchTags(___reqTextAttr, ___targetTextAttr, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; WeighTAMatch((___reqTextAttr), (___targetTextAttr), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define ExtendFontTags(___font, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; ExtendFont((___font), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define ObtainBestPen(___cm, ___r, ___g, ___b, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; ObtainBestPenA((___cm), (___r), (___g), (___b), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define GetExtSprite(___ss, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; GetExtSpriteA((___ss), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define AllocSpriteData(___bm, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; AllocSpriteDataA((___bm), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define ChangeExtSprite(___vp, ___oldsprite, ___newsprite, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; ChangeExtSpriteA((___vp), (___oldsprite), (___newsprite), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define SetRPAttrs(___rp, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; SetRPAttrsA((___rp), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define GetRPAttrsA(___rp, ___tags) \
      LP2NR(0x414, GetRPAttrsA , struct RastPort *, ___rp, a0, CONST struct TagItem *, ___tags, a1,\
      , GRAPHICS_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define GetRPAttrs(___rp, ___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; GetRPAttrsA((___rp), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define BestModeID(___tag1Type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1Type, __VA_ARGS__ }; BestModeIDA((CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define WriteChunkyPixels(___rp, ___xstart, ___ystart, ___xstop, ___ystop, ___array, ___bytesperrow) \
      LP7NR(0x420, WriteChunkyPixels , struct RastPort *, ___rp, a0, UWORD, ___xstart, d0, UWORD, ___ystart, d1, UWORD, ___xstop, d2, UWORD, ___ystop, d3, UBYTE *, ___array, a2, LONG, ___bytesperrow, d4,\
      , GRAPHICS_BASE_NAME)
