...
#define WriteChunkBytes(___iff, ___buf, ___numBytes) \
      LP3(0x42, LONG, WriteChunkBytes , struct IFFHandle *, ___iff, a0, CONST_APTR, ___buf, a1, LONG, ___numBytes, d0,\
      , IFFPARSE_BASE_NAME)
...
#define WriteChunkRecords(___iff, ___buf, ___bytesPerRecord, ___numRecords) \
      LP4(0x4e, LONG, WriteChunkRecords , struct IFFHandle *, ___iff, a0, CONST_APTR, ___buf, a1, LONG, ___bytesPerRecord, d0, LONG, ___numRecords, d1,\
      , IFFPARSE_BASE_NAME)
...
#define LocalItemData(___localItem) \
      LP1(0xc0, APTR, LocalItemData , struct LocalContextItem *, ___localItem, a0,\
      , IFFPARSE_BASE_NAME)

#define SetLocalItemPurge(___localItem, ___purgeHook) \
      LP2NR(0xc6, SetLocalItemPurge , struct LocalContextItem *, ___localItem, a0, struct Hook *, ___purgeHook, a1,\
      , IFFPARSE_BASE_NAME)
...
#define InitIFF(___iff, ___flags, ___streamHook) \
      LP3NR(0xe4, InitIFF , struct IFFHandle *, ___iff, a0, LONG, ___flags, d0, struct Hook *, ___streamHook, a1,\
      , IFFPARSE_BASE_NAME)
