    ...
    app.SubWindow.0="bwin"
     ...
     bwin.Contents="mbgroup"
      mbgroup.0="TheBar"
       ...
       TheBar.Framed=1
       TheBar.DragBar=1
       TheBar.SpacerIndex=6
       TheBar.AutoID=1
       TheBar.ViewMode="GFX"

        TheBar.Pics.0="back"
        TheBar.Pics.1="forward"
        TheBar.Pics.2="reload"
        TheBar.Pics.3="stop"
        TheBar.Pics.4="home"
        TheBar.Pics.5="find"
        TheBar.Pics.6="space"
        ...
        TheBar.Pics.8="arexx"
        TheBar.Pics.9="book"
        TheBar.Pics.10="folder"

        TheBar.0.Img=0
        TheBar.0.Text="Back"
        TheBar.0.Help="Move back."

        TheBar.1.Img=1
        TheBar.1.Text="Forward"
        TheBar.1.Help="Move forward."

        TheBar.2.Img="Bar"

        TheBar.3.Img=2
        TheBar.3.Text="Reload"
        TheBar.3.Help="Reload stuff."

        TheBar.4.Img=3
        TheBar.4.Text="Stop"
        TheBar.4.Help="Stop loading."

        TheBar.5.Img="Button"

        TheBar.6.Img=4
        TheBar.6.Text="Home"
        TheBar.6.Help="Go Home."

        TheBar.7.Img=5
        TheBar.7.Text="Find"
        TheBar.7.Help="Find something."
        ...
        TheBar.11.Help="Book mode selection."

        TheBar.12.Img=10
        TheBar.12.Text="folder"
        TheBar.12.Exclude=2**11
        TheBar.12.Help="Folder mode selection."
