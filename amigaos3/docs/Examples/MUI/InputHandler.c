...
int main(UNUSED int argc, UNUSED char *argv[])
{
	...
	mcc->mcc_Class->cl_ID = (ClassID)"InputHandler";

	app = ApplicationObject,
		MUIA_Application_Title      , "InputHandler",
		MUIA_Application_Version    , "$VER: InputHandler 21.2 (24.01.2017)",
		...
		MUIA_Application_Base       , "InputHandler",
