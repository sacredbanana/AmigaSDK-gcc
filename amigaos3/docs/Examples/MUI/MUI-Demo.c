...
#define List(ftxt)               FloattextObject, MUIA_Weight, 50, MUIA_List_Input, FALSE, MUIA_Frame, MUIV_Frame_ReadList, MUIA_Background, MUII_ReadListBack, MUIA_Floattext_Text, ftxt, MUIA_Floattext_TabSize, 4, MUIA_Floattext_Justify, TRUE, End
...
*/
	...
	AP_Demo = ApplicationObject,
		...
		MUIA_Application_Version       , "$VER: MUI-Demo 21.1 (08.02.2018)",
		...
		SubWindow,
			WI_String = DemoWindow("String",MAKE_ID('S','T','R','G'),IN_String),
				Child, LV_Brian = ListObject, InputListFrame, MUIA_List_Input, TRUE, End,
				...
				Child, HGroup,
					...
					Child, VGroup,
						Child, ColGroup(2), GroupFrameT("Cycle Gadgets"),
							...
							End,
						Child, LV_Computer = ListObject, InputListFrame, MUIA_List_Input, TRUE, End,
						End,
					End,
				End,
			End,
		...
		SubWindow,
			WI_Listviews = DemoWindow("Listviews",MAKE_ID('L','I','S','T'),IN_Listviews),
				Child, HGroup, GroupFrameT("Dir & Volume List"),
					Child, LV_Directory = DirlistObject, InputListFrame, MUIA_List_Input, TRUE, MUIA_List_MultiSelect, TRUE, MUIA_Dirlist_Directory, "ram:", MUIA_List_Title, TRUE, End,
					Child, BalanceObject, End,
					Child, LV_Volumes = VolumelistObject, InputListFrame, MUIA_Weight, 20, MUIA_List_Input, TRUE, MUIA_Dirlist_Directory, "ram:", End,
					End,
				End,
			End,
...
*/
	...
	DoMethod(LV_Volumes ,MUIM_Notify,MUIA_List_DoubleClick,TRUE,AP_Demo,2,MUIM_Application_ReturnID,ID_NEWVOL);
