...
*
*	$VER: xadmaster.i 12.1 (02.01.2003)
*	xadmaster.library defines and structures
*
*	Copyright © 1998-2001 by Dirk Stöcker
*	All Rights Reserved.
*
...
* private type
#define XADOBJ_STRING	EQU	$0101 * an typed XAD string (V12)
...
XADERR_SHORTBUFFER	EQU	$0018 * buffer was to short
