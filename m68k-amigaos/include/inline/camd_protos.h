...
struct MidiNode * __CreateMidiA(__reg("a6") struct Library * , __reg("a0") CONST struct TagItem * tags ) = "\tjsr\t-42(a6)";
...
BOOL __SetMidiAttrsA(__reg("a6") struct Library * , __reg("a0") struct MidiNode * mi , __reg("a1") CONST struct TagItem * tags ) = "\tjsr\t-54(a6)";
...
ULONG __GetMidiAttrsA(__reg("a6") struct Library * , __reg("a0") struct MidiNode * mi , __reg("a1") CONST struct TagItem * tags ) = "\tjsr\t-60(a6)";
...
struct MidiNode * __FindMidi(__reg("a6") struct Library * , __reg("a1") CONST_STRPTR name ) = "\tjsr\t-72(a6)";
...
struct MidiLink * __AddMidiLinkA(__reg("a6") struct Library * , __reg("a0") struct MidiNode * mi , __reg("d0") LONG type , __reg("a1") CONST struct TagItem * tags ) = "\tjsr\t-84(a6)";
...
BOOL __SetMidiLinkAttrsA(__reg("a6") struct Library * , __reg("a0") struct MidiLink * ml , __reg("a1") CONST struct TagItem * tags ) = "\tjsr\t-96(a6)";
...
ULONG __GetMidiLinkAttrsA(__reg("a6") struct Library * , __reg("a0") struct MidiLink * ml , __reg("a1") CONST struct TagItem * tags ) = "\tjsr\t-102(a6)";
...
struct MidiCluster * __FindCluster(__reg("a6") struct Library * , __reg("a0") CONST_STRPTR name ) = "\tjsr\t-132(a6)";
