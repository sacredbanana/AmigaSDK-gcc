...
#define CreateMidi(___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; CreateMidiA((CONST struct TagItem *) _tags); })
...
#define SetMidiAttrsA(___mi, ___tags) \
      LP2(0x36, BOOL, SetMidiAttrsA , struct MidiNode *, ___mi, a0, CONST struct TagItem *, ___tags, a1,\
      , CAMD_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define SetMidiAttrs(___mi, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; SetMidiAttrsA((___mi), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define GetMidiAttrsA(___mi, ___tags) \
      LP2(0x3c, ULONG, GetMidiAttrsA , struct MidiNode *, ___mi, a0, CONST struct TagItem *, ___tags, a1,\
      , CAMD_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define GetMidiAttrs(___mi, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; GetMidiAttrsA((___mi), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define FindMidi(___name) \
      LP1(0x48, struct MidiNode *, FindMidi , CONST_STRPTR, ___name, a1,\
      , CAMD_BASE_NAME)
...
#define AddMidiLink(___mi, ___type, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; AddMidiLinkA((___mi), (___type), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define SetMidiLinkAttrsA(___ml, ___tags) \
      LP2(0x60, BOOL, SetMidiLinkAttrsA , struct MidiLink *, ___ml, a0, CONST struct TagItem *, ___tags, a1,\
      , CAMD_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define SetMidiLinkAttrs(___ml, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; SetMidiLinkAttrsA((___ml), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define GetMidiLinkAttrsA(___ml, ___tags) \
      LP2(0x66, ULONG, GetMidiLinkAttrsA , struct MidiLink *, ___ml, a0, CONST struct TagItem *, ___tags, a1,\
      , CAMD_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define GetMidiLinkAttrs(___ml, ___tags, ...) \
    ({_sfdc_vararg _tags[] = { ___tags, __VA_ARGS__ }; GetMidiLinkAttrsA((___ml), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define FindCluster(___name) \
      LP1(0x84, struct MidiCluster *, FindCluster , CONST_STRPTR, ___name, a0,\
      , CAMD_BASE_NAME)
