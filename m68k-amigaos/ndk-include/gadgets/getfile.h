...
#define GETFILE_AllowEmptyFileSelection	(GETFILE_Dummy+24) // OS4ONLY

#define GETFILE_FilterHook		(GETFILE_Dummy+25) // OS4ONLY

#define GETFILE_InitialShowVolumes	(GETFILE_Dummy+26) // OS4ONLY
