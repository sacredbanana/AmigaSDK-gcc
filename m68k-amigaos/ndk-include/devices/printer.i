...
**
   ...
   DEVCMD   PRD_QUERY
   DEVCMD   PRD_RESETPREFS ; PRIVATE: do not use!
   DEVCMD   PRD_LOADPREFS  ; PRIVATE: do not use! 
   DEVCMD   PRD_USEPREFS   ; PRIVATE: do not use!
   DEVCMD   PRD_SAVEPREFS  ; PRIVATE: do not use!
   DEVCMD   PRD_READPREFS
   DEVCMD   PRD_WRITEPREFS
   DEVCMD   PRD_EDITPREFS
   DEVCMD   PRD_SETERRHOOK
   DEVCMD   PRD_DUMPRPORTTAGS
   DEVCMD   PRD_PRIVATECMD     ; PRIVATE: do not use!
   DEVCMD   PRD_LASTSAVEDPREFS ; PRIVATE: do not use!
...
PDERR_BADPREFERENCES	EQU	9 	; preferences file corrupt
*
