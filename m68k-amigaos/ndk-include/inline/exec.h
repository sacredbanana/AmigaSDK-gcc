...
#define InsertMinNode(___minlist, ___minnode, ___minpred) \
      LP3NR(0xea, InsertMinNode , struct MinList *, ___minlist, a0, struct MinNode *, ___minnode, a1, struct MinNode *, ___minpred, a2,\
      , EXEC_BASE_NAME)
...
#define AddHeadMinList(___minlist, ___minnode) \
      LP2NR(0xf0, AddHeadMinList , struct MinList *, ___minlist, a0, struct MinNode *, ___minnode, a1,\
      , EXEC_BASE_NAME)
...
#define AddTailMinList(___minlist, ___minnode) \
      LP2NR(0xf6, AddTailMinList , struct MinList *, ___minlist, a0, struct MinNode *, ___minnode, a1,\
      , EXEC_BASE_NAME)
...
#define RemoveMinNode(___minnode) \
      LP1NR(0xfc, RemoveMinNode , struct MinNode *, ___minnode, a1,\
      , EXEC_BASE_NAME)
...
#define RemHeadMinList(___minlist) \
      LP1(0x102, struct MinNode *, RemHeadMinList , struct MinList *, ___minlist, a0,\
      , EXEC_BASE_NAME)
...
#define RemTailMinList(___minlist) \
      LP1(0x108, struct MinNode *, RemTailMinList , struct MinList *, ___minlist, a0,\
      , EXEC_BASE_NAME)
...
#define CreateIORequest(___port, ___size) \
      LP2(0x28e, APTR, CreateIORequest , struct MsgPort *, ___port, a0, ULONG, ___size, d0,\
      , EXEC_BASE_NAME)
...
#define CachePreDMA(___address, ___length, ___flags) \
      LP3(0x2fa, APTR, CachePreDMA , CONST_APTR, ___address, a0, ULONG *, ___length, a1, ULONG, ___flags, d0,\
      , EXEC_BASE_NAME)

#define CachePostDMA(___address, ___length, ___flags) \
      LP3NR(0x300, CachePostDMA , CONST_APTR, ___address, a0, ULONG *, ___length, a1, ULONG, ___flags, d0,\
      , EXEC_BASE_NAME)
