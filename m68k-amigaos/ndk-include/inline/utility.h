...
#define UnpackStructureTags(___pack, ___packTable, ___tagList) \
      LP3(0xd8, ULONG, UnpackStructureTags , CONST_APTR, ___pack, a0, CONST ULONG *, ___packTable, a1, struct TagItem *, ___tagList, a2,\
      , UTILITY_BASE_NAME)
...
#define AllocNamedObject(___name, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; AllocNamedObjectA((___name), (CONST struct TagItem *) _tags); })
...
#define VSNPrintf(___buffer, ___bufsize, ___fmt, ___data) \
      LP4(0x138, LONG, VSNPrintf , STRPTR, ___buffer, a0, ULONG, ___bufsize, d0, CONST_STRPTR, ___fmt, a1, CONST_APTR, ___data, a2,\
      , UTILITY_BASE_NAME)

#ifndef NO_INLINE_VARARGS
#define SNPrintf(___buffer, ___bufsize, ___fmt, ...) \
     ({_sfdc_vararg _args[] = { __VA_ARGS__ }; VSNPrintf((___buffer), (___bufsize), (___fmt), (CONST_APTR) _args); })
#endif /* !NO_INLINE_VARARGS */

#define Strncpy(___dst, ___src, ___size) \
      LP3(0x1b6, STRPTR, Strncpy , STRPTR, ___dst, a1, CONST_STRPTR, ___src, a0, ULONG, ___size, d0,\
      , UTILITY_BASE_NAME)

#define Strncat(___dst, ___src, ___size) \
      LP3(0x1bc, STRPTR, Strncat , STRPTR, ___dst, a1, CONST_STRPTR, ___src, a0, ULONG, ___size, d0,\
      , UTILITY_BASE_NAME)

#define SDivMod64(___hi, ___lo, ___divisor) \
      LP3(0x1c2, LONG, SDivMod64 , LONG, ___hi, d1, LONG, ___lo, d0, LONG, ___divisor, d2,\
      , UTILITY_BASE_NAME)

#define UDivMod64(___hi, ___lo, ___divisor) \
      LP3(0x1c8, ULONG, UDivMod64 , ULONG, ___hi, d1, ULONG, ___lo, d0, ULONG, ___divisor, d2,\
      , UTILITY_BASE_NAME)
