...
#define AllocAslRequest(___reqType, ___tagList) \
      LP2(0x30, APTR, AllocAslRequest , ULONG, ___reqType, d0, CONST struct TagItem *, ___tagList, a0,\
      , ASL_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define AllocAslRequestTags(___reqType, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; AllocAslRequest((___reqType), (CONST struct TagItem *) _tags); })
...
#define AslRequest(___requester, ___tagList) \
      LP2(0x3c, BOOL, AslRequest , APTR, ___requester, a0, CONST struct TagItem *, ___tagList, a1,\
      , ASL_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define AslRequestTags(___requester, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; AslRequest((___requester), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
