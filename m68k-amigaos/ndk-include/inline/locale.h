...
#define FormatDate(___locale, ___fmtTemplate, ___date, ___putCharFunc) \
      LP4NR(0x3c, FormatDate , struct Locale *, ___locale, a0, CONST_STRPTR, ___fmtTemplate, a1, CONST struct DateStamp *, ___date, a2, struct Hook *, ___putCharFunc, a3,\
      , LOCALE_BASE_NAME)

#define FormatString(___locale, ___fmtTemplate, ___dataStream, ___putCharFunc) \
      LP4(0x42, APTR, FormatString , struct Locale *, ___locale, a0, CONST_STRPTR, ___fmtTemplate, a1, APTR, ___dataStream, a2, struct Hook *, ___putCharFunc, a3,\
      , LOCALE_BASE_NAME)

#define GetCatalogStr(___catalog, ___stringNum, ___defaultString) \
      LP3(0x48, STRPTR, GetCatalogStr , CONST struct Catalog *, ___catalog, a0, LONG, ___stringNum, d0, CONST_STRPTR, ___defaultString, a1,\
      , LOCALE_BASE_NAME)
...
#define OpenCatalog(___locale, ___name, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; OpenCatalogA((___locale), (___name), (CONST struct TagItem *) _tags); })
...
#define ParseDate(___locale, ___date, ___fmtTemplate, ___getCharFunc) \
      LP4(0xa2, BOOL, ParseDate , CONST struct Locale *, ___locale, a0, struct DateStamp *, ___date, a1, CONST_STRPTR, ___fmtTemplate, a2, struct Hook *, ___getCharFunc, a3,\
      , LOCALE_BASE_NAME)

#define StrConvert(___locale, ___string, ___buffer, ___bufferSize, ___type) \
      LP5(0xae, ULONG, StrConvert , struct Locale *, ___locale, a0, CONST_STRPTR, ___string, a1, APTR, ___buffer, a2, ULONG, ___bufferSize, d0, ULONG, ___type, d1,\
      , LOCALE_BASE_NAME)

#define StrnCmp(___locale, ___string1, ___string2, ___length, ___type) \
      LP5(0xb4, LONG, StrnCmp , struct Locale *, ___locale, a0, CONST_STRPTR, ___string1, a1, CONST_STRPTR, ___string2, a2, LONG, ___length, d0, ULONG, ___type, d1,\
      , LOCALE_BASE_NAME)
