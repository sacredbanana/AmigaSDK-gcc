...
#define AllocDosObjectTags(___type, ___tag1type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1type, __VA_ARGS__ }; AllocDosObjectTagList((___type), (CONST struct TagItem *) _tags); })
...
#define LockRecords(___recArray, ___timeout) \
      LP2(0x114, BOOL, LockRecords , CONST struct RecordLock *, ___recArray, d1, ULONG, ___timeout, d2,\
      , DOS_BASE_NAME)
...
#define UnLockRecords(___recArray) \
      LP1(0x120, BOOL, UnLockRecords , CONST struct RecordLock *, ___recArray, d1,\
      , DOS_BASE_NAME)
...
#define FWrite(___fh, ___block, ___blocklen, ___number) \
      LP4(0x14a, LONG, FWrite , BPTR, ___fh, d1, CONST_APTR, ___block, d2, ULONG, ___blocklen, d3, ULONG, ___number, d4,\
      , DOS_BASE_NAME)
...
#define VFPrintf(___fh, ___format, ___argarray) \
      LP3(0x162, LONG, VFPrintf , BPTR, ___fh, d1, CONST_STRPTR, ___format, d2, CONST_APTR, ___argarray, d3,\
      , DOS_BASE_NAME)

#ifndef NO_INLINE_VARARGS
#define FPrintf(___fh, ___format, ...) \
     ({_sfdc_vararg _args[] = { __VA_ARGS__ }; VFPrintf((___fh), (___format), (CONST_APTR) _args); })
#endif /* !NO_INLINE_VARARGS */
...
#define Fault(___code, ___header, ___buffer, ___len) \
      LP4(0x1d4, BOOL, Fault , LONG, ___code, d1, CONST_STRPTR, ___header, d2, STRPTR, ___buffer, d3, LONG, ___len, d4,\
      , DOS_BASE_NAME)
...
#ifndef NO_INLINE_STDARG
#define CreateNewProcTags(___tag1type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1type, __VA_ARGS__ }; CreateNewProcTagList((CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define SetArgStr(___string) \
      LP1(0x21c, STRPTR, SetArgStr , STRPTR, ___string, d1,\
      , DOS_BASE_NAME)
...
#ifndef NO_INLINE_STDARG
#define SystemTags(___command, ___tag1type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1type, __VA_ARGS__ }; System((___command), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define NewLoadSegTags(___file, ___tag1type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1type, __VA_ARGS__ }; NewLoadSegTagList((___file), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define ParsePattern(___pat, ___patbuf, ___patbuflen) \
      LP3(0x348, LONG, ParsePattern , CONST_STRPTR, ___pat, d1, UBYTE *, ___patbuf, d2, LONG, ___patbuflen, d3,\
      , DOS_BASE_NAME)

#define MatchPattern(___patbuf, ___str) \
      LP2(0x34e, BOOL, MatchPattern , CONST UBYTE *, ___patbuf, d1, CONST_STRPTR, ___str, d2,\
      , DOS_BASE_NAME)
...
#define VPrintf(___format, ___argarray) \
      LP2(0x3ba, LONG, VPrintf , CONST_STRPTR, ___format, d1, CONST_APTR, ___argarray, d2,\
      , DOS_BASE_NAME)

#ifndef NO_INLINE_VARARGS
#define Printf(___format, ...) \
     ({_sfdc_vararg _args[] = { __VA_ARGS__ }; VPrintf((___format), (CONST_APTR) _args); })
#endif /* !NO_INLINE_VARARGS */

#define ParsePatternNoCase(___pat, ___patbuf, ___patbuflen) \
      LP3(0x3c6, LONG, ParsePatternNoCase , CONST_STRPTR, ___pat, d1, UBYTE *, ___patbuf, d2, LONG, ___patbuflen, d3,\
      , DOS_BASE_NAME)

#define MatchPatternNoCase(___patbuf, ___str) \
      LP2(0x3cc, BOOL, MatchPatternNoCase , CONST UBYTE *, ___patbuf, d1, CONST_STRPTR, ___str, d2,\
      , DOS_BASE_NAME)
...
#define VolumeRequestHook(___vol) \
      LP1(0x3f6, LONG, VolumeRequestHook , CONST_STRPTR, ___vol, d1,\
      , DOS_BASE_NAME)

#define GetCurrentDir() \
      LP0(0x402, BPTR, GetCurrentDir ,\
      , DOS_BASE_NAME)

#define PutErrStr(___str) \
      LP1(0x468, LONG, PutErrStr , CONST_STRPTR, ___str, d1,\
      , DOS_BASE_NAME)

#define ErrorOutput() \
      LP0(0x46e, LONG, ErrorOutput ,\
      , DOS_BASE_NAME)

#define SelectError(___fh) \
      LP1(0x474, LONG, SelectError , BPTR, ___fh, d1,\
      , DOS_BASE_NAME)

#define DoShellMethodTagList(___method, ___tags) \
      LP2(0x480, APTR, DoShellMethodTagList , ULONG, ___method, d0, CONST struct TagItem *, ___tags, a0,\
      , DOS_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define DoShellMethod(___method, ___tag1type, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1type, __VA_ARGS__ }; DoShellMethodTagList((___method), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define ScanStackToken(___seg, ___defaultstack) \
      LP2(0x486, LONG, ScanStackToken , BPTR, ___seg, d1, LONG, ___defaultstack, d2,\
      , DOS_BASE_NAME)
