...
#define ReadExpansionByte(___board, ___offset) \
      LP2(0x60, UBYTE, ReadExpansionByte , CONST_APTR, ___board, a0, ULONG, ___offset, d0,\
      , EXPANSION_BASE_NAME)

#define ReadExpansionRom(___board, ___configDev) \
      LP2NR(0x66, ReadExpansionRom , CONST_APTR, ___board, a0, struct ConfigDev *, ___configDev, a1,\
      , EXPANSION_BASE_NAME)
