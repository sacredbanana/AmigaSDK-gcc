...
#define ConvertHSBToRGB(___hsb, ___rgb) \
      LP2NR(0x1e, ConvertHSBToRGB , CONST struct ColorWheelHSB *, ___hsb, a0, struct ColorWheelRGB *, ___rgb, a1,\
      , COLORWHEEL_BASE_NAME)

#define ConvertRGBToHSB(___rgb, ___hsb) \
      LP2NR(0x24, ConvertRGBToHSB , CONST struct ColorWheelRGB *, ___rgb, a0, struct ColorWheelHSB *, ___hsb, a1,\
      , COLORWHEEL_BASE_NAME)
