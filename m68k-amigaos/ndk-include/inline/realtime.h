...
#define CreatePlayer(___tag1, ...) \
    ({_sfdc_vararg _tags[] = { ___tag1, __VA_ARGS__ }; CreatePlayerA((CONST struct TagItem *) _tags); })
...
#ifndef NO_INLINE_STDARG
#define SetPlayerAttrs(___player, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; SetPlayerAttrsA((___player), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define GetPlayerAttrsA(___player, ___tagList) \
      LP2(0x54, ULONG, GetPlayerAttrsA , struct Player *, ___player, a0, CONST struct TagItem *, ___tagList, a1,\
      , REALTIME_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define GetPlayerAttrs(___player, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; GetPlayerAttrsA((___player), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
