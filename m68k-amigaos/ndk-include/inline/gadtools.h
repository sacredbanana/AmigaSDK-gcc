...
#define CreateGadget(___kind, ___gad, ___ng, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; CreateGadgetA((___kind), (___gad), (___ng), (CONST struct TagItem *) _tags); })
...
#ifndef NO_INLINE_STDARG
#define GT_SetGadgetAttrs(___gad, ___win, ___req, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; GT_SetGadgetAttrsA((___gad), (___win), (___req), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define CreateMenus(___newmenu, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; CreateMenusA((___newmenu), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define LayoutMenuItems(___firstitem, ___vi, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; LayoutMenuItemsA((___firstitem), (___vi), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define LayoutMenus(___firstmenu, ___vi, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; LayoutMenusA((___firstmenu), (___vi), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define DrawBevelBox(___rport, ___left, ___top, ___width, ___height, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; DrawBevelBoxA((___rport), (___left), (___top), (___width), (___height), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define GetVisualInfo(___screen, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; GetVisualInfoA((___screen), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define SetDesignFontA(___vi, ___tattr, ___tags) \
      LP3(0x8a, LONG, SetDesignFontA , APTR, ___vi, a0, struct TextAttr *, ___tattr, a1, CONST struct TagItem *, ___tags, a2,\
      , GADTOOLS_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define SetDesignFont(___vi, ___tattr, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; SetDesignFontA((___vi), (___tattr), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */

#define ScaleGadgetRectA(___ng, ___tags) \
      LP2(0x90, LONG, ScaleGadgetRectA , struct NewGadget *, ___ng, a0, CONST struct TagItem *, ___tags, a1,\
      , GADTOOLS_BASE_NAME)

#ifndef NO_INLINE_STDARG
#define ScaleGadgetRect(___ng, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; ScaleGadgetRectA((___ng), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#ifndef NO_INLINE_STDARG
#define GT_GetGadgetAttrs(___gad, ___win, ___req, ____tag1, ...) \
    ({_sfdc_vararg _tags[] = { ____tag1, __VA_ARGS__ }; GT_GetGadgetAttrsA((___gad), (___win), (___req), (CONST struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
