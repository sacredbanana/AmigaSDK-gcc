...
struct xfdScanHook {
  BOOL	(* xfdsh_Entry)(void);	/* Entrypoint of hook code */
...
struct xfdSlave {
  ...
  BOOL		(* xfds_RecogBuffer)(void);    /* buffer recognition code (or NULL) */
  BOOL		(* xfds_DecrunchBuffer)(void); /* buffer decrunch code (or NULL) */
  BOOL		(* xfds_RecogSegment)(void);   /* segment recognition code (or NULL) */
  BOOL		(* xfds_DecrunchSegment)(void);/* segment decrunch code (or NULL) */
