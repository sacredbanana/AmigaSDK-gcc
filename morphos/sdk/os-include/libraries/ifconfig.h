 ...
 */
#define IFCONFIGNAME "ifconfig.library"
#define IFCONFIGVERSION 51
...
#define IF_HWAddress	IFTM_HEXSTRING(  3) /* Sana-II HW-address */
...
#define IF_UseDHCP	IFTM_SWITCH(    41) /* Use DHCP to configure iface */
#define IF_DriverArgs	IFTM_STRING(    42) /* Exec device flags used as a string */
#define IF_MAXTAGS	                42  /* # of defined tag codes */
...
struct ifconfig {
	...
	LONG             ifc_type;       /* IFCT_SANA, IFCT_LOOPBACK, IFCT_SLIP, IFCT_PPP, IFCT_PPTP */
