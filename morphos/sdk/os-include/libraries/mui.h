...
#define MUIV_List_EndEdit_Done           0
#define MUIV_List_EndEdit_Abort          1
#define MUIV_List_EndEdit_Prev           2
#define MUIV_List_EndEdit_Next           3
#define MUIV_List_EndEdit_Up             4
#define MUIV_List_EndEdit_Down           5

#define MUIV_Dirlist_Rename_Active         -1
#define MUIV_Dirlist_SetComment_Active     -1
#define MUIV_Dirlist_SetProtection_Active  -1

#define MUIV_DoDrag_Async 1
...
struct MUI_EventHandlerNode
{
	...
	Boopsiobject  *ehn_Object;   /* object which should receive MUIM_HandleEvent. */
...
#define StringscrollObject  MUI_NewObject(MUIC_Stringscroll
...
#define PopcolorObject      MUI_NewObject(MUIC_Popcolor
...
@class MUIString;
#else
typedef Boopsiobject MUIApplication;
typedef Boopsiobject MUIArea;
typedef Boopsiobject MUIDataspace;
typedef Boopsiobject MUIMenustrip;
typedef Boopsiobject MUIMenuitem;
typedef Boopsiobject MUIWindow;
typedef Boopsiobject MUIPendisplay;
typedef Boopsiobject MUIScrollgroup;
typedef Boopsiobject MUIVirtgroup;
typedef Boopsiobject MUIScrollbar;
typedef Boopsiobject MUIString;
#endif
...
#define MUIF_Slave_Delegate_ForceSlave (1<<0) /* skip caller task check and always dispatch on Slave thread
                                                 useful when calling from a process which is neither
                                                 MUI's main process nor the Slave process */
...
struct  MUIP_Export                         { ULONG MethodID; MUIDataspace *dataspace; };
struct  MUIP_FindObject                     { ULONG MethodID; Boopsiobject *findme; };
...
struct  MUIP_Import                         { ULONG MethodID; MUIDataspace *dataspace; };
struct  MUIP_KillNotify                     { ULONG MethodID; ULONG TrigAttr; };
struct  MUIP_KillNotifyObj                  { ULONG MethodID; ULONG TrigAttr; Boopsiobject *dest; };
...
struct  MUIP_SetAsString                    { ULONG MethodID; ULONG attr; STRPTR format; ULONG val; /* ... */ };
...
struct  MUIP_WriteString                    { ULONG MethodID; STRPTR str; STRPTR memory; };

/* Attributes */

#define MUIA_ApplicationObject              0x8042d3ee /* V4  ..g MUIApplication *  */
#define MUIA_AppMessage                     0x80421955 /* V5  .sg struct AppMessage * */
#define MUIA_CSSFilePath                    0x804225d8 /* V22 ..g CONST_STRPTR      */
...
#define MUIA_Parent                         0x8042e35f /* V11 ..g Boopsiobject *    */
...
struct  MUIP_Family_AddHead                 { ULONG MethodID; Boopsiobject *obj; };
struct  MUIP_Family_AddTail                 { ULONG MethodID; Boopsiobject *obj; };
struct  MUIP_Family_DoChildMethods          { ULONG MethodID; };
struct  MUIP_Family_GetChild                { ULONG MethodID; LONG nr; Boopsiobject *ref; };
struct  MUIP_Family_Insert                  { ULONG MethodID; Boopsiobject *obj; Boopsiobject *pred; };
struct  MUIP_Family_Remove                  { ULONG MethodID; Boopsiobject *obj; };
struct  MUIP_Family_Reorder                 { ULONG MethodID; Boopsiobject *after; Boopsiobject *array[1]; };
struct  MUIP_Family_Sort                    { ULONG MethodID; Boopsiobject *obj[1]; };
struct  MUIP_Family_Transfer                { ULONG MethodID; Boopsiobject *family; };

/* Attributes */

#define MUIA_Family_Child                   0x8042c696 /* V8  i.. Boopsiobject *    */
...
#define MUIM_Menustrip_WillOpen             0x804230e9 /* V20 */
struct  MUIP_Menustrip_ExitChange           { ULONG MethodID; };
struct  MUIP_Menustrip_InitChange           { ULONG MethodID; };
struct  MUIP_Menustrip_Popup                { ULONG MethodID; Boopsiobject *parent; ULONG flags; int x; int y; };
struct  MUIP_Menustrip_WillOpen             { ULONG MethodID; };

/* Attributes */

#define MUIA_Menustrip_CaseSensitive        0x8042d718 /* V20 i.g LONG              */
...
#define MUIA_Menuitem_Menuitem              0x80424b21 /* V20 isg Boopsiobject *    */
...
struct  MUIP_Application_AboutMUI           { ULONG MethodID; MUIWindow *refwindow; };
...
struct  MUIP_Application_PushMethod         { ULONG MethodID; Boopsiobject *dest; LONG count; /* ... */ };
...
struct  MUIP_Application_ShowHelp           { ULONG MethodID; MUIWindow *window; STRPTR name; STRPTR node; LONG line; };
struct  MUIP_Application_UnpushMethod       { ULONG MethodID; Boopsiobject *targetobj; ULONG methodid; ULONG method; };
...
#define MUIA_Application_DoubleStart        0x80423bc6 /* V4  .sg BOOL              */
#define MUIA_Application_DropObject         0x80421266 /* V5  is. Boopsiobject *    */
...
#endif /* MUI_OBSOLETE */
#define MUIA_Application_MenuAction         0x80428961 /* V4  isg ULONG             */
#define MUIA_Application_MenuHelp           0x8042540b /* V4  ..g ULONG             */
#define MUIA_Application_Menustrip          0x804252d9 /* V8  i.g MUIMenustrip *    */
#define MUIA_Application_RexxHook           0x80427c42 /* V7  isg struct Hook *     */
#define MUIA_Application_RexxMsg            0x8042fd88 /* V4  .sg struct RexxMsg *  */
...
#define MUIA_Application_Window             0x8042bfe0 /* V4  i.. Boopsiobject *    */
...
struct  MUIP_Window_SetCycleChain           { ULONG MethodID; Boopsiobject *obj[1]; };
...
#define MUIA_Window_ActiveObject            0x80427925 /* V4  .sg MUIArea *         */
...
#define MUIA_Window_DefaultObject           0x804294d7 /* V4  isg MUIArea *         */
...
#define MUIA_Window_HasAlpha                0x8042e632 /* V20 isg BOOL              */
...
#define MUIA_Window_Menustrip               0x8042855e /* V8  isg MUIMenustrip *    */
#define MUIA_Window_MouseObject             0x8042bf9b /* V10 ..g MUIArea *         */
...
#define MUIA_Window_PanelWindow             0x80429528 /* V20 i.. BOOL              */
#define MUIA_Window_PublicScreen            0x804278e4 /* V6  isg STRPTR            */
#define MUIA_Window_RefWindow               0x804201f4 /* V4  is. MUIWindow *       */
#define MUIA_Window_RootObject              0x8042cba5 /* V4  isg MUIArea *         */
...
#define MUIA_Window_TabletMessages          0x804217b7 /* V20 i.g BOOL              */
...
#define MUIA_Window_VisibleOnMaximize       0x8042acfd /* V20 isg BOOL              */
...
#define MUIA_Aboutmui_Application           0x80422523 /* V11 i.. MUIApplication *  */
...
#define MUIM_Backfill                       0x80428d73 /* V11 */
#define MUIM_CheckShortHelp                 0x80423c79 /* V20 */
#define MUIM_Cleanup                        0x8042d985 /* Custom Class */ /* V4  */
#define MUIM_CloseCustomFont                0x8042b27c /* Custom Class */ /* V22 */
...
#define MUIM_ExitResize                     0x80428431 /* Custom Class */ /* V22 */
...
#define MUIM_InitResize                     0x804292bd /* Custom Class */ /* V22 */
#define MUIM_Layout                         0x8042845b /* V4  */
#define MUIM_OpenCustomFont                 0x8042f3dc /* Custom Class */ /* V22 */
...
#define MUIM_Text                           0x8042ee70 /* Custom Class */ /* V20 */
#define MUIM_TextDim                        0x80422ad7 /* Custom Class */ /* V20 */
...
struct  MUIP_CloseCustomFont                { ULONG MethodID; Boopsiobject *font; }; /* Custom Class */
struct  MUIP_ContextMenuAdd                 { ULONG MethodID; MUIMenustrip *menustrip; LONG mx; LONG my; LONG *mxp; LONG *myp; };
struct  MUIP_ContextMenuBuild               { ULONG MethodID; LONG mx; LONG my; };
struct  MUIP_ContextMenuChoice              { ULONG MethodID; MUIMenuitem *item; };
struct  MUIP_CreateBubble                   { ULONG MethodID; LONG x; LONG y; STRPTR txt; ULONG flags; };
...
struct  MUIP_DragBegin                      { ULONG MethodID; MUIArea *obj; };
struct  MUIP_DragDrop                       { ULONG MethodID; MUIArea *obj; LONG x; LONG y; ULONG qualifier; };
struct  MUIP_DragEvent                      { ULONG MethodID; struct Window *objwindow; Boopsiobject *obj; struct MUI_DragImage *di; struct IntuiMessage *imsg; LONG muikey; ULONG mouseptrtype; ULONG flags; }; /* Custom Class */
struct  MUIP_DragFinish                     { ULONG MethodID; MUIArea *obj; LONG dropfollows; };
struct  MUIP_DragQuery                      { ULONG MethodID; MUIArea *obj; };
struct  MUIP_DragReport                     { ULONG MethodID; MUIArea *obj; LONG x; LONG y; LONG update; ULONG qualifier; };
...
struct  MUIP_ExitResize                     { ULONG MethodID; ; }; /* Custom Class */
...
struct  MUIP_InitResize                     { ULONG MethodID; ULONG flags; }; /* Custom Class */
struct  MUIP_Layout                         { ULONG MethodID; LONG left; LONG top; LONG width; LONG height; ULONG flags; };
struct  MUIP_OpenCustomFont                 { ULONG MethodID; STRPTR spec; }; /* Custom Class */
...
struct  MUIP_Text                           { ULONG MethodID; LONG left;LONG top;LONG width;LONG height;STRPTR text;LONG len;STRPTR preparse;ULONG flags; }; /* Custom Class */
struct  MUIP_TextDim                        { ULONG MethodID; STRPTR text;LONG len;STRPTR preparse;ULONG flags; }; /* Custom Class */
struct  MUIP_UpdateConfig                   { ULONG MethodID; ULONG cfgid; LONG redrawcount; Boopsiobject *redrawobj[64]; UBYTE redrawflags[64]; };

/* Attributes */

#define MUIA_Background                     0x8042545b /* V4  is. LONG              */
#define MUIA_BottomEdge                     0x8042e552 /* V4  ..g LONG              */
#define MUIA_BuiltinFont                    0x8042256f /* V22 isg ULONG             */
#define MUIA_ContextMenu                    0x8042b704 /* V11 isg MUIMenustrip *    */
#define MUIA_ContextMenuTrigger             0x8042a2c1 /* V11 ..g MUIMenuitem *     */
#define MUIA_ControlChar                    0x8042120b /* V4  isg char              */
#define MUIA_CustomBackfill                 0x80420a63 /* V11 isg BOOL              */
#define MUIA_CustomFont                     0x80423fc5 /* V20 isg STRPTR            */
...
#define MUIA_DoubleClick                    0x8042f057 /* V20 ..g LONG              */
...
#define MUIA_Font                           0x8042be50 /* V4  isg struct TextFont * */
...
#define MUIA_TextColor                      0x8042dba6 /* V22 ..g ULONG             */
#define MUIA_Timer                          0x80426435 /* V4  ..g LONG              */
#define MUIA_TopEdge                        0x8042509b /* V4  ..g LONG              */
#define MUIA_Unicode                        0x8042e7d0 /* V22 i.g BOOL              */
...
#define MUIA_WindowObject                   0x8042669e /* V4  ..g MUIWindow *       */

#define MUIV_BuiltinFont_Inherit 0
#define MUIV_BuiltinFont_Normal -1
#define MUIV_BuiltinFont_List -2
#define MUIV_BuiltinFont_Tiny -3
#define MUIV_BuiltinFont_Fixed -4
#define MUIV_BuiltinFont_Title -5
#define MUIV_BuiltinFont_Big -6
#define MUIV_BuiltinFont_Button -7
#define MUIV_BuiltinFont_Slider -8
#define MUIV_BuiltinFont_Gauge -9
#define MUIV_BuiltinFont_Menu -10
#define MUIV_BuiltinFont_Tab -11
#define MUIV_BuiltinFont_Bubble -12
#define MUIV_BuiltinFont_Huge -13
#define MUIV_BuiltinFont_Last -13
#define MUIV_BuiltinFont_Count 14
...
#define MUIA_Dtpic_FreeHoriz                0x8042d360 /* V22 i.g BOOL              */
#define MUIA_Dtpic_FreeVert                 0x80424c12 /* V22 i.g BOOL              */
#define MUIA_Dtpic_LightenOnMouse           0x8042966a /* V20 i.g BOOL              */
#define MUIA_Dtpic_MinHeight                0x80423ecc /* V20 i.g BOOL              */
#define MUIA_Dtpic_MinWidth                 0x8042c417 /* V20 i.g BOOL              */
...
#define MUIA_Image_BuiltinSpec              0x8042b907 /* V21 isg ULONG             */
#define MUIA_Image_FontMatch                0x8042815d /* V4  i.. BOOL              */
#define MUIA_Image_FontMatchHeight          0x80429f26 /* V4  i.. BOOL              */
#define MUIA_Image_FontMatchString          0x804263c1 /* V20 is. STRPTR            */
...
#define MUIA_Image_Spec                     0x804233d5 /* V4  isg STRPTR            */
...
#define MUIA_String_AttachedList            0x80420fd2 /* V4  isg Boopsiobject *    */
...
#define MUIA_String_Editable                0x8042c94b /* V21 isg BOOL              */
...
#define MUIA_String_Integer64               0x80424820 /* V20 isg QUAD *            */
#define MUIA_String_LonelyEditHook          0x80421569 /* V11 isg BOOL              */
#define MUIA_String_MaxLen                  0x80424984 /* V4  i.g LONG              */
#define MUIA_String_Multiline               0x8042d18b /* V21 i.g BOOL              */
#define MUIA_String_Placeholder             0x8042ae65 /* V21 isg STRPTR            */
#define MUIA_String_Reject                  0x8042179c /* V4  isg STRPTR            */
#define MUIA_String_ScrollHeight            0x8042be8b /* V22 ..g LONG              */
#define MUIA_String_ScrollLeft              0x8042bd0d /* V22 ..g LONG              */
#define MUIA_String_ScrollTop               0x8042f4e5 /* V22 ..g LONG              */
#define MUIA_String_ScrollVisibleHeight     0x8042791e /* V22 ..g LONG              */
#define MUIA_String_ScrollVisibleWidth      0x8042d280 /* V22 ..g LONG              */
#define MUIA_String_ScrollWidth             0x80420fb5 /* V22 ..g LONG              */
#define MUIA_String_Secret                  0x80428769 /* V4  i.g BOOL              */
#define MUIA_String_SpellChecking           0x804266c6 /* V21 isg BOOL              */
...
#define MUIA_Boopsi_Object                  0x80420178 /* V4  ..g Boopsiobject *    */
...
#define MUIA_Pendisplay_ARGB                0x804278d0 /* V22 isg ULONG             */
#define MUIA_Pendisplay_Pen                 0x8042a748 /* V13 ..g ULONG             */
#define MUIA_Pendisplay_Reference           0x8042dc24 /* V13 isg MUIPendisplay *   */
...
#define MUIA_Pendisplay_XRGB                0x8042de8a /* V22 isg ULONG             */
...
struct  MUIP_Group_AddHead                  { ULONG MethodID; Boopsiobject *obj; };
struct  MUIP_Group_AddTail                  { ULONG MethodID; Boopsiobject *obj; };
...
struct  MUIP_Group_MoveMember               { ULONG MethodID; Boopsiobject *o; LONG pos; };
struct  MUIP_Group_Remove                   { ULONG MethodID; Boopsiobject *obj; };
struct  MUIP_Group_Reorder                  { ULONG MethodID; Boopsiobject *after; Boopsiobject *array[1]; };
struct  MUIP_Group_Sort                     { ULONG MethodID; Boopsiobject *obj[1]; };

/* Attributes */

#define MUIA_Group_ActivePage               0x80424199 /* V5  isg LONG              */
#define MUIA_Group_Child                    0x804226e6 /* V4  i.. Boopsiobject *    */
...
#define MUIA_Group_ForwardDepth             0x80428488 /* V20 .s. BOOL              */
...
#define MUIM_List_EndEdit                   0x804203ee /* V22 */
...
#define MUIM_List_SortEntries               0x80429e32 /* V21 */
#define MUIM_List_TestPos                   0x80425f48 /* V11 */
struct  MUIP_List_Clear                     { ULONG MethodID;  };
struct  MUIP_List_Compare                   { ULONG MethodID; APTR entry1; APTR entry2; ULONG column; };
...
struct  MUIP_List_CreateImage               { ULONG MethodID; Boopsiobject *obj; ULONG flags; };
struct  MUIP_List_DeleteImage               { ULONG MethodID; APTR listimg; };
struct  MUIP_List_Destruct                  { ULONG MethodID; APTR entry; APTR pool; };
struct  MUIP_List_Display                   { ULONG MethodID; APTR entry; STRPTR *array; LONG row; };
struct  MUIP_List_Edit                      { ULONG MethodID; LONG row; LONG column; };
struct  MUIP_List_EditDone                  { ULONG MethodID; LONG row; LONG column; APTR entry; Boopsiobject *editobj; };
struct  MUIP_List_EndEdit                   { ULONG MethodID; ULONG mode; };
...
struct  MUIP_List_SortEntries               { ULONG MethodID; APTR *entries; };
...
#define MUIA_List_AgainClick                0x804214c2 /* V20 isg BOOL              */
#define MUIA_List_AutoLineHeight            0x8042bc08 /* V20 isg BOOL              */
#define MUIA_List_AutoVisible               0x8042a445 /* V11 isg BOOL              */
#define MUIA_List_ClickColumn               0x8042d1b3 /* V7  .sg LONG              */
...
#define MUIA_List_DoubleClick               0x80424635 /* V4  isg BOOL              */
...
#define MUIA_List_LineHeight                0x80425880 /* V20 ..g ULONG             */
...
#define MUIA_List_Title                     0x80423e66 /* V6  isg STRPTR            */
#define MUIA_List_TitleArray                0x80427d95 /* V21 isg STRPTR *          */
#define MUIA_List_TitleClick                0x80422fd9 /* V20 .sg LONG              */
#define MUIA_List_TopPixel                  0x80429df3 /* V4  .sg LONG              */
...
#define MUIA_Dirlist_NumBytes64             0x80428050 /* V20 ..g QUAD *            */
...
struct  MUIP_Mccprefs_ConfigToGadgets       { ULONG MethodID; Boopsiobject *configdata; };
struct  MUIP_Mccprefs_GadgetsToConfig       { ULONG MethodID; Boopsiobject *configdata; Boopsiobject *originator; };
struct  MUIP_Mccprefs_RegisterGadget        { ULONG MethodID; Boopsiobject *gadget; ULONG id; ULONG params; STRPTR title; ULONG attr; Boopsiobject *label; };
...
struct  MUIP_Settingsgroup_ConfigToGadgets  { ULONG MethodID; Boopsiobject *configdata; };
struct  MUIP_Settingsgroup_GadgetsToConfig  { ULONG MethodID; Boopsiobject *configdata; Boopsiobject *originator; };
...
#define MUIA_Scrollgroup_Contents           0x80421261 /* V4  i.g MUIVirtgroup *    */
#define MUIA_Scrollgroup_FreeHoriz          0x804292f3 /* V9  i.. BOOL              */
#define MUIA_Scrollgroup_FreeVert           0x804224f2 /* V9  i.. BOOL              */
#define MUIA_Scrollgroup_HorizBar           0x8042b63d /* V16 ..g MUIScrollbar *    */
...
#define MUIA_Scrollgroup_VertBar            0x8042cdc0 /* V16 ..g MUIScrollbar *    */
...
#define MUIA_Listview_List                  0x8042bcce /* V4  i.g Boopsiobject *    */
...
#define MUIA_Popstring_Button               0x8042d0b9 /* V7  i.g MUIArea *         */
...
#define MUIA_Popstring_String               0x804239ea /* V7  i.g MUIArea *         */
...
#define MUIA_Popobject_Object               0x804293e3 /* V7  i.g MUIArea *         */
...
#define MUIA_Popasl_MUIFontStyles           0x8042897f /* V22 isg BOOL              */
...
struct  MUIP_Dataspace_Merge                { ULONG MethodID; MUIDataspace *dataspace; };
...
#define MUIM_Panel_Run                      0x8042d789 /* V20 */
struct  MUIP_Panel_Run                      { ULONG MethodID; MUIApplication *app; MUIWindow *win; };
...
#define MUIM_Filepanel_AddRow               0x80421d3b /* V20 */
struct  MUIP_Filepanel_AddRow               { ULONG MethodID; MUIArea *label; MUIArea *contents; };
...
#define MUIA_Keyadjust_ForceKeyCode         0x8042fbad /* V20 isg ULONG             */
...
#define MUIA_Coloradjust_Alpha              0x8042a1f1 /* V22 isg UBYTE             */
#define MUIA_Coloradjust_ARGB               0x804250ca /* V22 isg ULONG             */
...
#define MUIA_Coloradjust_ShowAlpha          0x8042e102 /* V22 isg BOOL              */
#define MUIA_Coloradjust_XRGB               0x8042cc13 /* V22 isg ULONG             */
...
struct  MUIP_Process_Process                { ULONG MethodID; ULONG *kill; Boopsiobject *proc; };
...
#define MUIM_Title_FindPage                 0x80423d0d /* V20 */
#define MUIM_Title_New                      0x804247a6 /* V20 */
struct  MUIP_Title_Close                    { ULONG MethodID; Boopsiobject *tito; };
struct  MUIP_Title_FindPage                 { ULONG MethodID; Boopsiobject *titlebutton; };
struct  MUIP_Title_New                      { ULONG MethodID;  };
...
#ifdef _DCC
extern char MUIC_Transition[];
#else
#define MUIC_Transition "Transition.mui"
#endif
...
#ifdef _DCC
extern char MUIC_Switchpanel[];
#else
#define MUIC_Switchpanel "Switchpanel.mui"
#endif

/* Methods */

#define MUIM_Switchpanel_Create             0x80427bb4 /* V20 */
struct  MUIP_Switchpanel_Create             { ULONG MethodID; Boopsiobject *switchitem; };

/* Attributes */

#define MUIA_Switchpanel_Current            0x80427e97 /* V20 isg Boopsiobject *    */

#define MUIV_Switchpanel_Current_First -1
#define MUIV_Switchpanel_Current_Last -2
#define MUIV_Switchpanel_Current_Prev -3
#define MUIV_Switchpanel_Current_Next -4
#define MUIV_Switchpanel_Current_PrevGroup -5
#define MUIV_Switchpanel_Current_NextGroup -6
...
#ifdef _DCC
extern char MUIC_Switchitem[];
#else
#define MUIC_Switchitem "Switchitem.mui"
#endif

/* Methods */

#define MUIM_Switchitem_Create              0x80421ef8 /* V20 */
struct  MUIP_Switchitem_Create              { ULONG MethodID; };
...
struct  MUIP_Datamap_Iterate                { ULONG MethodID; IPTR *counter; };
struct  MUIP_Datamap_IterationKey           { ULONG MethodID; IPTR *counter; };
...
#define MUIA_Datamap_Count                  0x80427580 /* V20 ..g ULONG             */
...
#define MUIA_Slave_Application              0x80427767 /* V20 i.. Boopsiobject *    */
#define MUIA_Slave_Class                    0x80420f8c /* V20 i.. Boopsiobject *    */
#define MUIA_Slave_Object                   0x804202ab /* V20 i.. Boopsiobject *    */
...
struct  MUIP_Objectmap_Iterate              { ULONG MethodID; IPTR *counter; };
struct  MUIP_Objectmap_IterationKey         { ULONG MethodID; IPTR *counter; };
struct  MUIP_Objectmap_Remove               { ULONG MethodID; CONST_STRPTR key; };
struct  MUIP_Objectmap_Set                  { ULONG MethodID; Boopsiobject *o; CONST_STRPTR key; };
...
#ifdef _DCC
extern char MUIC_FSProtectionBits[];
#else
...
#define MUIA_FSProtectionBits_Flags         0x8042330c /* V21 isg ULONG             */
...
#ifdef _DCC
extern char MUIC_Popcolor[];
#else
#define MUIC_Popcolor "Popcolor.mui"
#endif

/* Attributes */

#define MUIA_Popcolor_ShowAlpha             0x8042e102 /* V22 i.. BOOL              */
...
#ifdef _DCC
extern char MUIC_Stringscroll[];
#else
#define MUIC_Stringscroll "Stringscroll.mui"
#endif
...
#define MUIA_Stringscroll_HorizBar          0x8042e049 /* V22 i.. MUIScrollbar *    */
#define MUIA_Stringscroll_NoInput           0x8042b2f3 /* V22 i.. BOOL              */
#define MUIA_Stringscroll_SetMin            0x8042cbbb /* V22 i.. BOOL              */
#define MUIA_Stringscroll_SetVMin           0x80420115 /* V22 i.. BOOL              */
#define MUIA_Stringscroll_String            0x804256a2 /* V22 ..g MUIString *       */
#define MUIA_Stringscroll_UseWinBorder      0x80422a61 /* V22 i.. BOOL              */
#define MUIA_Stringscroll_VertBar           0x804232f8 /* V22 i.. MUIScrollbar *    */
#define MUIA_Stringscroll_VertScrollerOnly  0x8042873b /* V22 i.. BOOL              */
...
{
   ULONG priv0;
	Boopsiobject *mgi_ApplicationObject;
...
#define MUIF_DRAGIMAGE_NOSHADOWS     (1<<2) /* set to disable bottom/right edge shadows */
...
#define MUIREQ_MOVEALONG (1<<30)
#define MUIREQ_BOTTOM    (1<<29)
#define MUIREQ_RIGHT     (1<<28)
#define MUIREQ_LISTPOS   (1<<27)
...
{
	Boopsiobject    *mri_WindowObject;  /* valid between MUIM_Setup/MUIM_Cleanup */
...
#define MUIA_Textinput_AttachedList MCC_TI_ID(125)          /* V1 isg Boopsiobject */
