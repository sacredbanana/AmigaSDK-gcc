...
**
**	Copyright � 1996-2008 by Vision Factory Development
**	All Rights reserved.
**
*/
...
#define CYBRMATTR_COLORMAP    (0x8000000A) /* returns colormap associated with that bitmap (v50) */
...
#define PIXFMT_BGR15    (2UL)  /* NOTE: Source code compatibility only, really RGB15X */
