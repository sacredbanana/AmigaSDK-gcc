...
/* Values for cah_CardNode.ln_Type */

#define CNT_68KCARDHANDLE  0
#define CNT_PPCCARDHANDLE  1


/* Structures used by card.resource */
...
struct PPCCardHandle
{
	...
	UBYTE             cah_CardFlags;
	UBYTE             cah_PPCType;
	struct Interrupt *cah_PPCCardRemoved;
	struct Interrupt *cah_PPCCardInserted;
	struct Interrupt *cah_PPCCardStatus;
};
