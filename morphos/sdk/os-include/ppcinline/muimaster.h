...
#define MUI_MakeObjectA(__p0, __p1) \
	LP2(120, Boopsiobject *, MUI_MakeObjectA, \
		LONG , __p0, d0, \
		ULONG *, __p1, a0, \
		, MUIMASTER_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define MUI_NewObjectA(__p0, __p1) \
	LP2(30, Boopsiobject *, MUI_NewObjectA, \
		char *, __p0, a0, \
...
#define MUI_GetRGBColor(__p0, __p1, __p2) \
	LP3(690, LONG , MUI_GetRGBColor, \
		const struct MUI_RenderInfo *, __p0, a0, \
		const struct MUI_PenSpec *, __p1, a1, \
		ULONG *, __p2, a2, \
		, MUIMASTER_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define MUI_RequestObjectA(__p0, __p1, __p2, __p3, __p4, __p5, __p6, __p7) \
	LP8(756, LONG , MUI_RequestObjectA, \
		APTR , __p0, d0, \
		APTR , __p1, d1, \
		ULONG , __p2, d2, \
		STRPTR , __p3, a0, \
		STRPTR , __p4, a1, \
		Boopsiobject *, __p5, a2, \
		STRPTR , __p6, a3, \
		APTR , __p7, a4, \
		, MUIMASTER_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define MUI_RequestObject(__p0, __p1, __p2, __p3, __p4, __p5, __p6, ...) \
	({ULONG _tags[] = { __VA_ARGS__ }; \
	MUI_RequestObjectA(__p0, __p1, __p2, __p3, __p4, __p5, __p6, (APTR )_tags);})
