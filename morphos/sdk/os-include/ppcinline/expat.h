...
#define XML_GetCurrentLineNumber(__p0) \
	LP1(258, XML_Size , XML_GetCurrentLineNumber, \
		XML_Parser , __p0, a0, \
		, EXPAT_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define XML_GetCurrentColumnNumber(__p0) \
	LP1(264, XML_Size , XML_GetCurrentColumnNumber, \
		XML_Parser , __p0, a0, \
		, EXPAT_BASE_NAME, 0, 0, 0, 0, 0, 0)
...
#define XML_ParserCreate_M68K(__p0) \
	LP1(30, XML_Parser , XML_ParserCreate_M68K, \
		const XML_Char *, __p0, a0, \
		, EXPAT_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define XML_ParserCreateNS_M68K(__p0, __p1) \
	LP2(36, XML_Parser , XML_ParserCreateNS_M68K, \
		const XML_Char *, __p0, a0, \
		XML_Char , __p1, d0, \
		, EXPAT_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define XML_ParserCreate_MM_M68K(__p0, __p1, __p2) \
	LP3(42, XML_Parser , XML_ParserCreate_MM_M68K, \
		const XML_Char *, __p0, a0, \
		const XML_Memory_Handling_Suite *, __p1, a1, \
		const XML_Char *, __p2, a2, \
		, EXPAT_BASE_NAME, 0, 0, 0, 0, 0, 0)

#define XML_SetHashSalt(__p0, __p1) \
	(((int (*)(XML_Parser , unsigned long ))*(void**)((long)(EXPAT_BASE_NAME) - 532))(__p0, __p1))

#define XML_SetBillionLaughsAttackProtectionMaximumAmplification(__p0, __p1) \
	(((XML_Bool (*)(XML_Parser , float ))*(void**)((long)(EXPAT_BASE_NAME) - 538))(__p0, __p1))

#define XML_SetBillionLaughsAttackProtectionActivationThreshold(__p0, __p1) \
	(((XML_Bool (*)(XML_Parser , unsigned long long ))*(void**)((long)(EXPAT_BASE_NAME) - 544))(__p0, __p1))
