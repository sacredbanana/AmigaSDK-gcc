...
#define SMARTC_TEST_AVAIL        0x00 /* private */
...
#define SMART_ATTRIBUTE_ID_VALID(id) ((id)>0 && (id)<254)

/* Magic-ID for the TEST_AVAIL command */
#define SMART_MAGIC_ID 0x534D5254 /* SMRT */


#pragma pack(1) /* packed to 1 */
...
struct SMARTAttributes /* 512 bytes */
{
   UWORD sa_Revision;
...
struct SMARTThresholds /* 512 bytes */
{
   UWORD st_Revision;
