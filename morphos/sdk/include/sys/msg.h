...
/* Extra msgctl() cmd defines to retrieve pointers to msginfo and msqids */
#define GETMSGINFO 8
#define GETMSQIDSA 9
...
struct msqid_ds_t32 {
	...
	pid_t   msg_lspid;      /* pid of last msgsnd() */
	pid_t   msg_lrpid;      /* pid of last msgrcv() */
	time32_t msg_stime;     /* time of last msgsnd() */
	long    msg_pad1;
	time32_t msg_rtime;     /* time of last msgrcv() */
	long    msg_pad2;
	time32_t msg_ctime;     /* time of last msgctl() */
	long    msg_pad3;
	long    msg_pad4[4];
};
#endif
