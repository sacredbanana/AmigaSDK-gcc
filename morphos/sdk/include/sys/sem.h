...
struct sem {
	...
	pid_t __ALIGN2__ sempid;        /* pid of last operation */
...
#define GETSEMINFO 10   /* Return pointer to seminfo struct */
#define GETSEMA 11      /* Return pointer to sema array */
#define SEMLCK  12      /* Lock semaphore structs */
#define SEMUNLK 13      /* Unlock semaphore structs */
...
struct sem_undo {
	...
	struct  Task *un_proc;          /* owner of this structure */
	short   un_cnt;                 /* # of active entries */
	struct undo {
		short   un_adjval;      /* adjust on exit values */
		short   un_num;         /* semaphore # */
		int    __ALIGN2__ un_id;/* semid */
	} __PACKED__ un_ent[1];         /* undo entries */
} __PACKED__;
 ...
 */
#define SEMU(i) ((struct sem_undo *)(((long)semu)+i * SEMUSZ))
