...
#define OPTION_MASK_P10_FUSION_2ADD (HOST_WIDE_INT_1U << 32)
#define OPTION_MASK_P10_FUSION_2LOGICAL (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_P10_FUSION_ADDLOG (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_P10_FUSION_LD_CMPI (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_P10_FUSION_LOGADD (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_P9_MINMAX (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_P9_MISC (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_P9_VECTOR (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_PREFIXED (HOST_WIDE_INT_1U << 46)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1U << 47)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1U << 48)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1U << 49)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1U << 50)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1U << 51)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1U << 52)
#define OPTION_MASK_TOC_FUSION (HOST_WIDE_INT_1U << 53)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1U << 54)
#if defined(HOST_BITS_PER_WIDE_INT) && 55 > HOST_BITS_PER_WIDE_INT
...
#define TARGET_P10_FUSION_2ADD ((rs6000_isa_flags & OPTION_MASK_P10_FUSION_2ADD) != 0)
#define TARGET_P10_FUSION_2ADD_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_P10_FUSION_2ADD) != 0)
...
#define TARGET_P10_FUSION_ADDLOG ((rs6000_isa_flags & OPTION_MASK_P10_FUSION_ADDLOG) != 0)
#define TARGET_P10_FUSION_ADDLOG_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_P10_FUSION_ADDLOG) != 0)
...
#define TARGET_P10_FUSION_LOGADD ((rs6000_isa_flags & OPTION_MASK_P10_FUSION_LOGADD) != 0)
#define TARGET_P10_FUSION_LOGADD_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_P10_FUSION_LOGADD) != 0)
...
enum opt_code
{
  ...
  /* OPT_Waltivec_long_deprecated = 433, */  /* -Waltivec-long-deprecated */
  ...
  OPT_faltivec = 858,                        /* -faltivec */
  OPT_fanalyzer = 859,                       /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 860,        /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 861,              /* -fanalyzer-checker= */
  OPT_fanalyzer_feasibility = 862,           /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 863,          /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 864,  /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_state_merge = 865,           /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 866,           /* -fanalyzer-state-purge */
  OPT_fanalyzer_transitivity = 867,          /* -fanalyzer-transitivity */
  OPT_fanalyzer_verbose_edges = 868,         /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 869, /* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 870,            /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 871, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 872, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 873, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 874, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 875,            /* -fasan-shadow-offset= */
  OPT_fasm = 876,                            /* -fasm */
  OPT_fassert = 877,                         /* -fassert */
  OPT_fassociative_math = 878,               /* -fassociative-math */
  OPT_fassume_phsa = 879,                    /* -fassume-phsa */
  OPT_fasynchronous_unwind_tables = 880,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 881,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 882,                   /* -fauto-profile */
  OPT_fauto_profile_ = 883,                  /* -fauto-profile= */
  OPT_fautomatic = 884,                      /* -fautomatic */
  OPT_fbackslash = 885,                      /* -fbackslash */
  OPT_fbacktrace = 886,                      /* -fbacktrace */
  OPT_fbit_tests = 887,                      /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 888,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 889,                   /* -fbounds-check */
  OPT_fbounds_check_ = 890,                  /* -fbounds-check= */
  OPT_fbranch_count_reg = 891,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 892,           /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 893, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 894, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 895, */         /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 896,                /* -fbuilding-libgcc */
  OPT_fbuilding_libphobos_tests = 897,       /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 898,                        /* -fbuiltin */
  OPT_fbuiltin_ = 899,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 900,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 901,                   /* -fc-prototypes */
  OPT_fc_prototypes_external = 902,          /* -fc-prototypes-external */
  OPT_fcall_saved_ = 903,                    /* -fcall-saved- */
  OPT_fcall_used_ = 904,                     /* -fcall-used- */
  OPT_fcaller_saves = 905,                   /* -fcaller-saves */
  OPT_fcallgraph_info = 906,                 /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 907,                /* -fcallgraph-info= */
  OPT_fcanonical_system_headers = 908,       /* -fcanonical-system-headers */
  /* OPT_fcf_protection = 909, */            /* -fcf-protection */
  OPT_fcf_protection_ = 910,                 /* -fcf-protection= */
  OPT_fchar8_t = 911,                        /* -fchar8_t */
  OPT_fcheck_array_temporaries = 912,        /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 913, */          /* -fcheck-data-deps */
  OPT_fcheck_new = 914,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 915,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 916,                         /* -fcheck= */
  OPT_fchecking = 917,                       /* -fchecking */
  OPT_fchecking_ = 918,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 919,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 920,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 921,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 922,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 923,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 924,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 925,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 926,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 927, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 928,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 929,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 930,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 931, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 932,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 933,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 934,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 935,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 936,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 937, */                 /* -fcilkplus */
  OPT_fcoarray_ = 938,                       /* -fcoarray= */
  OPT_fcode_hoisting = 939,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 940,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 941,                         /* -fcommon */
  OPT_fcompare_debug = 942,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 943,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 944,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 945,                   /* -fcompare-elim */
  OPT_fconcepts = 946,                       /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 947,    /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 948,                    /* -fconcepts-ts */
  OPT_fcond_mismatch = 949,                  /* -fcond-mismatch */
  /* OPT_fconserve_space = 950, */           /* -fconserve-space */
  OPT_fconserve_stack = 951,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 952,         /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 953,         /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 954,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 955,          /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 956,           /* -fconstexpr-ops-limit= */
  OPT_fconvert_ = 957,                       /* -fconvert= */
  OPT_fcoroutines = 958,                     /* -fcoroutines */
  OPT_fcprop_registers = 959,                /* -fcprop-registers */
  OPT_fcray_pointer = 960,                   /* -fcray-pointer */
  OPT_fcrossjumping = 961,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 962,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 963, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 964,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 965,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 966,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 967,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 968,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 969,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 970,                       /* -fdbg-cnt= */
  OPT_fdce = 971,                            /* -fdce */
  OPT_fdebug = 972,                          /* -fdebug */
  OPT_fdebug_aux_vars = 973,                 /* -fdebug-aux-vars */
  OPT_fdebug_cpp = 974,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 975,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 976,            /* -fdebug-types-section */
  OPT_fdebug_ = 977,                         /* -fdebug= */
  OPT_fdec = 978,                            /* -fdec */
  OPT_fdec_blank_format_item = 979,          /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 980,           /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 981,            /* -fdec-format-defaults */
  OPT_fdec_include = 982,                    /* -fdec-include */
  OPT_fdec_intrinsic_ints = 983,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 984,                       /* -fdec-math */
  OPT_fdec_static = 985,                     /* -fdec-static */
  OPT_fdec_structure = 986,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 987,              /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 988, */         /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 989,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 990, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 991,              /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 992,                /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 993,                /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 994,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 995,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 996,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 997,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 998,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 999,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1000,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1001,    /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 1002, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1003,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1004,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1005,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_format_ = 1006,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1007,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_minimum_margin_width_ = 1008,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1009,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1010,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1011,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_show_caret = 1012,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1013,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_labels = 1014,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1015, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1016,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1017,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1018,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_template_tree = 1019,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_urls_ = 1020,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1021,               /* -fdirectives-only */
  OPT_fdisable_ = 1022,                      /* -fdisable- */
  OPT_fdoc = 1023,                           /* -fdoc */
  OPT_fdoc_dir_ = 1024,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1025,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1026,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1027,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1028,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1029,                      /* -fdruntime */
  OPT_fdse = 1030,                           /* -fdse */
  OPT_fdump_ = 1031,                         /* -fdump- */
  OPT_fdump_ada_spec = 1032,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1033,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1034,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1035,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1036,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1037,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1038,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1039,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_feasibility = 1040,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_json = 1041,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1042,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1043,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1044,      /* -fdump-analyzer-supergraph */
  /* OPT_fdump_core = 1045, */               /* -fdump-core */
  OPT_fdump_d_original = 1046,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1047,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1048,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1049,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1050,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1051,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1052,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1053,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1054,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1055, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1056,                   /* -fdump-passes */
  OPT_fdump_scos = 1057,                     /* -fdump-scos */
  OPT_fdump_unnumbered = 1058,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1059,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1060,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1061,                /* -fearly-inlining */
  OPT_felide_constructors = 1062,            /* -felide-constructors */
  OPT_felide_type = 1063,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1064, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1065,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1066,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1067,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1068,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1069,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1070,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1071,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1072,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1073,                /* -fenum-int-equiv */
  OPT_fexceptions = 1074,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1075,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1076,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1077,       /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 1078,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1079,          /* -fextended-identifiers */
  OPT_fextern_tls_init = 1080,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1081,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1082,            /* -fexternal-templates */
  OPT_ff2c = 1083,                           /* -ff2c */
  OPT_ffast_math = 1084,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1085,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1086,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1087,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1088,              /* -ffinite-math-only */
  OPT_ffixed_ = 1089,                        /* -ffixed- */
  OPT_ffixed_form = 1090,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1091,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1092,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1093,                   /* -ffloat-store */
  OPT_ffor_scope = 1094,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1095, */              /* -fforce-addr */
  OPT_fforward_propagate = 1096,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1097,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1098,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1099,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1100,                     /* -ffpe-trap= */
  OPT_ffree_form = 1101,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1102,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1103,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1104,                  /* -ffreestanding */
  OPT_ffriend_injection = 1105,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1106,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1107,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1108,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1109,             /* -ffunction-sections */
  OPT_fgcse = 1110,                          /* -fgcse */
  OPT_fgcse_after_reload = 1111,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1112,                      /* -fgcse-las */
  OPT_fgcse_lm = 1113,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1114,                       /* -fgcse-sm */
  OPT_fgimple = 1115,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1116,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1117,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1118,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1119,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1120,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1121,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1122,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1123,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1124,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1125,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1126,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1127,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1128,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1129,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1130,                  /* -fgo-embedcfg= */
  OPT_fgo_optimize_ = 1131,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1132,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1133,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1134,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1135,                      /* -fgraphite */
  OPT_fgraphite_identity = 1136,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1137,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1138,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1139, */       /* -fhandle-exceptions */
  /* OPT_fhelp = 1140, */                    /* -fhelp */
  /* OPT_fhelp_ = 1141, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1142,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1143,                     /* -fhonor-std */
  OPT_fhosted = 1144,                        /* -fhosted */
  OPT_fhuge_objects = 1145,                  /* -fhuge-objects */
  OPT_fident = 1146,                         /* -fident */
  OPT_fif_conversion = 1147,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1148,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1149,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1150,             /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 1151,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1152,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1153,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1154,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1155,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1156,               /* -finit-character= */
  OPT_finit_derived = 1157,                  /* -finit-derived */
  OPT_finit_integer_ = 1158,                 /* -finit-integer= */
  OPT_finit_local_zero = 1159,               /* -finit-local-zero */
  OPT_finit_logical_ = 1160,                 /* -finit-logical= */
  OPT_finit_real_ = 1161,                    /* -finit-real= */
  OPT_finline = 1162,                        /* -finline */
  OPT_finline_arg_packing = 1163,            /* -finline-arg-packing */
  OPT_finline_atomics = 1164,                /* -finline-atomics */
  OPT_finline_functions = 1165,              /* -finline-functions */
  OPT_finline_functions_called_once = 1166,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1167, */           /* -finline-limit- */
  OPT_finline_limit_ = 1168,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1169,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1170,        /* -finline-small-functions */
  OPT_finput_charset_ = 1171,                /* -finput-charset= */
  OPT_finstrument_functions = 1172,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1173,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1174,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1175,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1176,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1177,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1178,                    /* -finvariants */
  OPT_fipa_bit_cp = 1179,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1180,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1181, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1182,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1183,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1184,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1185,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1186, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1187,                    /* -fipa-modref */
  OPT_fipa_profile = 1188,                   /* -fipa-profile */
  OPT_fipa_pta = 1189,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1190,                /* -fipa-pure-const */
  OPT_fipa_ra = 1191,                        /* -fipa-ra */
  OPT_fipa_reference = 1192,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1193,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1194,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1195,           /* -fipa-stack-alignment */
  /* OPT_fipa_struct_reorg = 1196, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1197,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1198,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1199,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1200,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1201,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1202,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1203,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1204,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1205,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1206,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1207,              /* -fivar-visibility= */
  OPT_fivopts = 1208,                        /* -fivopts */
  OPT_fjump_tables = 1209,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1210,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1211,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1212,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1213,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1214,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1215,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1216,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1217,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1218,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1219,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1220,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1221,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1222,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1223,            /* -fleading-underscore */
  OPT_flifetime_dse = 1224,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1225,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1226,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1227,                /* -flinker-output= */
  /* OPT_flive_patching = 1228, */           /* -flive-patching */
  OPT_flive_patching_ = 1229,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1230,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1231,                   /* -flocal-ivars */
  /* OPT_floop_block = 1232, */              /* -floop-block */
  /* OPT_floop_flatten = 1233, */            /* -floop-flatten */
  OPT_floop_interchange = 1234,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1235,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1236, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1237,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1238, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1239,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1240,                     /* -flra-remat */
  OPT_flto = 1241,                           /* -flto */
  OPT_flto_compression_level_ = 1242,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1243, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1244,                /* -flto-partition= */
  OPT_flto_report = 1245,                    /* -flto-report */
  OPT_flto_report_wpa = 1246,                /* -flto-report-wpa */
  OPT_flto_ = 1247,                          /* -flto= */
  OPT_fltrans = 1248,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1249,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1250,             /* -fmacro-prefix-map= */
  OPT_fmain = 1251,                          /* -fmain */
  OPT_fmath_errno = 1252,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1253,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1254,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1255,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1256,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1257,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1258,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1259,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1260,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1261,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1262,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1263,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1264,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1265,                  /* -fmodule-file= */
  OPT_fmodule_header = 1266,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1267,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1268,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1269,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1270,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1271,                   /* -fmodule-only */
  OPT_fmodule_private = 1272,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1273,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1274,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1275,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1276,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1277,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1278,          /* -fmove-loop-invariants */
  OPT_fms_extensions = 1279,                 /* -fms-extensions */
  OPT_fmudflap = 1280,                       /* -fmudflap */
  OPT_fmudflapir = 1281,                     /* -fmudflapir */
  OPT_fmudflapth = 1282,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1283,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1284,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1285,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1286,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1287,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1288,                 /* -fnil-receivers */
  OPT_fno_modules = 1289,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1290,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1291,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1292,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1293,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1294,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1295,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1296,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1297,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1298,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1299,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1300,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1301,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1302,                  /* -foffload-abi= */
  OPT_foffload_ = 1303,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1304,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1305,                         /* -fonly= */
  OPT_fopenacc = 1306,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1307,                  /* -fopenacc-dim= */
  ...
  OPT_m32 = 1680,                            /* -m32 */
  OPT_m64 = 1681,                            /* -m64 */
  OPT_mabi_altivec = 1682,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1683,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1684,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1685,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1686,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1687,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1688,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1689,                /* -mabi=no-altivec */
  OPT_mabi_vec_default = 1690,               /* -mabi=vec-default */
  OPT_mabi_vec_extabi = 1691,                /* -mabi=vec-extabi */
  OPT_mads = 1692,                           /* -mads */
  OPT_maix_struct_return = 1693,             /* -maix-struct-return */
  OPT_malign_ = 1694,                        /* -malign- */
  OPT_malign_branch_targets = 1695,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 1696,             /* -mallow-movmisalign */
  OPT_maltivec = 1697,                       /* -maltivec */
  OPT_malways_hint = 1698,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1699,       /* -mavoid-indexed-addresses */
  OPT_mbaserel32 = 1700,                     /* -mbaserel32 */
  OPT_mbig = 1701,                           /* -mbig */
  OPT_mbig_endian = 1702,                    /* -mbig-endian */
  OPT_mbit_align = 1703,                     /* -mbit-align */
  OPT_mbit_word = 1704,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1705,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 1706,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 1707,      /* -mblock-move-inline-limit= */
  OPT_mblock_ops_unaligned_vsx = 1708,       /* -mblock-ops-unaligned-vsx */
  OPT_mblock_ops_vector_pair = 1709,         /* -mblock-ops-vector-pair */
  OPT_mbss_plt = 1710,                       /* -mbss-plt */
  OPT_mcall_ = 1711,                         /* -mcall- */
  OPT_mclib_ = 1712,                         /* -mclib= */
  OPT_mcmpb = 1713,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1714,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1715,                          /* -mcpu= */
  OPT_mcrypto = 1716,                        /* -mcrypto */
  OPT_mdebug_ = 1717,                        /* -mdebug= */
  OPT_mdirect_move = 1718,                   /* -mdirect-move */
  OPT_mdlmzb = 1719,                         /* -mdlmzb */
  OPT_meabi = 1720,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1721,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1722,                           /* -memb */
  OPT_mfloat128 = 1723,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1724,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1725,             /* -mfloat128-hardware */
  OPT_mfold_gimple = 1726,                   /* -mfold-gimple */
  OPT_mfp_in_toc = 1727,                     /* -mfp-in-toc */
  OPT_mfprnd = 1728,                         /* -mfprnd */
  OPT_mfriz = 1729,                          /* -mfriz */
  OPT_mfull_toc = 1730,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1731, */              /* -mfused-madd */
  /* OPT_mgen_cell_microcode = 1732, */      /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 1733,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1734,                      /* -mhard-dfp */
  OPT_mhard_float = 1735,                    /* -mhard-float */
  OPT_mhtm = 1736,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1737,            /* -minsert-sched-nops= */
  OPT_misel = 1738,                          /* -misel */
  OPT_mlittle = 1739,                        /* -mlittle */
  OPT_mlittle_endian = 1740,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1741,                  /* -mlong-double- */
  OPT_mlongcall = 1742,                      /* -mlongcall */
  /* OPT_mlra = 1743, */                     /* -mlra */
  OPT_mmfcrf = 1744,                         /* -mmfcrf */
  OPT_mmfpgpr = 1745,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1746,                   /* -mminimal-toc */
  OPT_mmma = 1747,                           /* -mmma */
  OPT_mmodulo = 1748,                        /* -mmodulo */
  OPT_mmulhw = 1749,                         /* -mmulhw */
  OPT_mmultiple = 1750,                      /* -mmultiple */
  OPT_mmvme = 1751,                          /* -mmvme */
  OPT_mnewlib = 1752,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1753,                  /* -mno-fp-in-toc */
  /* OPT_mno_mfpgpr = 1754, */               /* -mno-mfpgpr */
  /* OPT_mno_string = 1755, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1756,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1757,                        /* -mno-toc */
  OPT_mno_traceback = 1758,                  /* -mno-traceback */
  OPT_mno_update = 1759,                     /* -mno-update */
  OPT_moptimize_swaps = 1760,                /* -moptimize-swaps */
  OPT_mpcrel = 1761,                         /* -mpcrel */
  OPT_mpcrel_opt = 1762,                     /* -mpcrel-opt */
  OPT_mpltseq = 1763,                        /* -mpltseq */
  OPT_mpointers_to_nested_functions = 1764,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1765,                       /* -mpopcntb */
  OPT_mpopcntd = 1766,                       /* -mpopcntd */
  OPT_mpower10 = 1767,                       /* -mpower10 */
  OPT_mpower10_fusion = 1768,                /* -mpower10-fusion */
  OPT_mpower10_fusion_2add = 1769,           /* -mpower10-fusion-2add */
  OPT_mpower10_fusion_2logical = 1770,       /* -mpower10-fusion-2logical */
  OPT_mpower10_fusion_add_logical = 1771,    /* -mpower10-fusion-add-logical */
  OPT_mpower10_fusion_ld_cmpi = 1772,        /* -mpower10-fusion-ld-cmpi */
  OPT_mpower10_fusion_logical_add = 1773,    /* -mpower10-fusion-logical-add */
  OPT_mpower8_fusion = 1774,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1775,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1776,                 /* -mpower8-vector */
  OPT_mpower9_minmax = 1777,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1778,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1779,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1780, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1781,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1782,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1783,                     /* -mpowerpc64 */
  OPT_mprefixed = 1784,                      /* -mprefixed */
  OPT_mprioritize_restricted_insns_ = 1785,  /* -mprioritize-restricted-insns= */
  OPT_mprivileged = 1786,                    /* -mprivileged */
  OPT_mprototype = 1787,                     /* -mprototype */
  OPT_mquad_memory = 1788,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1789,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 1790,             /* -mreadonly-in-sdata */
  OPT_mrecip = 1791,                         /* -mrecip */
  OPT_mrecip_precision = 1792,               /* -mrecip-precision */
  OPT_mrecip_ = 1793,                        /* -mrecip= */
  OPT_mregnames = 1794,                      /* -mregnames */
  OPT_mrelative_jumptables = 1795,           /* -mrelative-jumptables */
  OPT_mrelocatable = 1796,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1797,               /* -mrelocatable-lib */
  OPT_mresident32 = 1798,                    /* -mresident32 */
  OPT_mrop_protect = 1799,                   /* -mrop-protect */
  OPT_msave_toc_indirect = 1800,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1801,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1802,                  /* -msched-epilog */
  OPT_msched_groups = 1803,                  /* -msched-groups */
  OPT_msched_prolog = 1804,                  /* -msched-prolog */
  OPT_msdata = 1805,                         /* -msdata */
  OPT_msdata_ = 1806,                        /* -msdata= */
  OPT_msecure_plt = 1807,                    /* -msecure-plt */
  OPT_mshlib = 1808,                         /* -mshlib */
  OPT_msim = 1809,                           /* -msim */
  OPT_msingle_pic_base = 1810,               /* -msingle-pic-base */
  OPT_msoft_float = 1811,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 1812,      /* -mspeculate-indirect-jumps */
  ...
  OPT_mstring = 1817,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1818,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1819,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1820,            /* -msvr4-struct-return */
  OPT_mtls_size_ = 1821,                     /* -mtls-size= */
  OPT_mtoc = 1822,                           /* -mtoc */
  OPT_mtoc_fusion = 1823,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1824,                    /* -mtraceback= */
  OPT_mtune_ = 1825,                         /* -mtune= */
  OPT_munroll_only_small_loops = 1826,       /* -munroll-only-small-loops */
  OPT_mupdate = 1827,                        /* -mupdate */
  OPT_mveclibabi_ = 1828,                    /* -mveclibabi= */
  OPT_mvrsave = 1829,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1830, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1831, */              /* -mvrsave=yes */
  OPT_mvsx = 1832,                           /* -mvsx */
  OPT_mvsx_align_128 = 1833,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 1834, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1835,             /* -mwarn-altivec-long */
  OPT_mxl_compat = 1836,                     /* -mxl-compat */
  OPT_myellowknife = 1837,                   /* -myellowknife */
  OPT_n = 1838,                              /* -n */
  ...
  /* OPT_noixemul = 1845, */                 /* -noixemul */
  OPT_nolibc = 1846,                         /* -nolibc */
  OPT_nophoboslib = 1847,                    /* -nophoboslib */
  OPT_nostartfiles = 1848,                   /* -nostartfiles */
  OPT_nostdinc = 1849,                       /* -nostdinc */
  OPT_nostdinc__ = 1850,                     /* -nostdinc++ */
  OPT_nostdlib = 1851,                       /* -nostdlib */
  OPT_o = 1852,                              /* -o */
  ...
  OPT_pthread = 1873,                        /* -pthread */
  OPT_quiet = 1874,                          /* -quiet */
  OPT_r = 1875,                              /* -r */
  OPT_remap = 1876,                          /* -remap */
  OPT_reverse_sort = 1877,                   /* -reverse-sort */
  OPT_s = 1878,                              /* -s */
  OPT_save_temps = 1879,                     /* -save-temps */
  OPT_save_temps_ = 1880,                    /* -save-temps= */
  OPT_shared = 1881,                         /* -shared */
  OPT_shared_libgcc = 1882,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1883,               /* -shared-libphobos */
  OPT_size_sort = 1884,                      /* -size-sort */
  /* OPT_specs = 1885, */                    /* -specs */
  OPT_specs_ = 1886,                         /* -specs= */
  OPT_static = 1887,                         /* -static */
  OPT_static_libasan = 1888,                 /* -static-libasan */
  OPT_static_libgcc = 1889,                  /* -static-libgcc */
  OPT_static_libgfortran = 1890,             /* -static-libgfortran */
  OPT_static_libgo = 1891,                   /* -static-libgo */
  OPT_static_libhwasan = 1892,               /* -static-libhwasan */
  OPT_static_liblsan = 1893,                 /* -static-liblsan */
  OPT_static_libmpx = 1894,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1895,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1896,               /* -static-libphobos */
