...
#define HAVE_ATTR_size 1
extern enum attr_size get_attr_size (rtx_insn *);

#define HAVE_ATTR_cost 1
extern int get_attr_cost (rtx_insn *);
#define HAVE_ATTR_dot 1
extern enum attr_dot get_attr_dot (rtx_insn *);

#define HAVE_ATTR_sign_extend 1
extern enum attr_sign_extend get_attr_sign_extend (rtx_insn *);

#define HAVE_ATTR_cr_logical_3op 1
extern enum attr_cr_logical_3op get_attr_cr_logical_3op (rtx_insn *);

#define HAVE_ATTR_indexed 1
extern enum attr_indexed get_attr_indexed (rtx_insn *);

#define HAVE_ATTR_update 1
extern enum attr_update get_attr_update (rtx_insn *);

#define HAVE_ATTR_maybe_var_shift 1
extern enum attr_maybe_var_shift get_attr_maybe_var_shift (rtx_insn *);

#define HAVE_ATTR_var_shift 1
extern enum attr_var_shift get_attr_var_shift (rtx_insn *);

#define HAVE_ATTR_cannot_copy 1
extern enum attr_cannot_copy get_attr_cannot_copy (rtx_insn *);

#define HAVE_ATTR_maybe_prefixed 1
extern enum attr_maybe_prefixed get_attr_maybe_prefixed (rtx_insn *);

#define HAVE_ATTR_prefixed 1
extern enum attr_prefixed get_attr_prefixed (rtx_insn *);

#define HAVE_ATTR_loads_external_address 1
extern enum attr_loads_external_address get_attr_loads_external_address (rtx_insn *);

#define HAVE_ATTR_num_insns 1
extern int get_attr_num_insns (rtx_insn *);
#define HAVE_ATTR_max_prefixed_insns 1
extern int get_attr_max_prefixed_insns (rtx_insn *);
...
#define HAVE_ATTR_cell_micro 1
extern enum attr_cell_micro get_attr_cell_micro (rtx_insn *);
