...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_OOmode: return 32;
    case E_XOmode: return 64;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_OOmode: return 1;
    case E_XOmode: return 1;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_OOmode: return E_OOmode;
    case E_XOmode: return E_XOmode;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case E_KFmode: return 16*BITS_PER_UNIT;
    case E_TFmode: return 16*BITS_PER_UNIT;
    case E_IFmode: return 16*BITS_PER_UNIT;
    ...
    case E_ICmode: return 16*BITS_PER_UNIT;
    case E_TCmode: return 16*BITS_PER_UNIT;
    case E_KCmode: return 16*BITS_PER_UNIT;
    ...
    case E_V2IFmode: return 16*BITS_PER_UNIT;
    case E_V2TFmode: return 16*BITS_PER_UNIT;
    case E_V2KFmode: return 16*BITS_PER_UNIT;
    case E_OOmode: return 32*BITS_PER_UNIT;
    case E_XOmode: return 64*BITS_PER_UNIT;
