...
#define gt_ggc_m_15toc_hash_struct(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_toc_hash_struct (X);\
  } while (0)
extern void gt_ggc_mx_toc_hash_struct (void *);
#define gt_ggc_m_22hash_table_toc_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_ggc_mx_hash_table_toc_hasher_ (X);\
  } while (0)
...
#define gt_pch_n_15toc_hash_struct(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_toc_hash_struct (X);\
  } while (0)
extern void gt_pch_nx_toc_hash_struct (void *);
#define gt_pch_n_22hash_table_toc_hasher_(X) do { \
  if ((intptr_t)(X) != 0) gt_pch_nx_hash_table_toc_hasher_ (X);\
  } while (0)
