...
#endif
#ifdef GENERATOR_FILE
extern int rs6000_density_load_num_threshold;
#else
  int x_rs6000_density_load_num_threshold;
#define rs6000_density_load_num_threshold global_options.x_rs6000_density_load_num_threshold
#endif
#ifdef GENERATOR_FILE
extern int rs6000_density_load_pct_threshold;
#else
  int x_rs6000_density_load_pct_threshold;
#define rs6000_density_load_pct_threshold global_options.x_rs6000_density_load_pct_threshold
#endif
#ifdef GENERATOR_FILE
extern int rs6000_density_pct_threshold;
#else
  int x_rs6000_density_pct_threshold;
#define rs6000_density_pct_threshold global_options.x_rs6000_density_pct_threshold
#endif
#ifdef GENERATOR_FILE
extern int rs6000_density_penalty;
#else
  int x_rs6000_density_penalty;
#define rs6000_density_penalty global_options.x_rs6000_density_penalty
#endif
#ifdef GENERATOR_FILE
extern int rs6000_density_size_threshold;
#else
  int x_rs6000_density_size_threshold;
#define rs6000_density_size_threshold global_options.x_rs6000_density_size_threshold
#endif
#ifdef GENERATOR_FILE
extern int rs6000_vect_unroll_issue;
#else
  int x_rs6000_vect_unroll_issue;
#define rs6000_vect_unroll_issue global_options.x_rs6000_vect_unroll_issue
#endif
#ifdef GENERATOR_FILE
extern int rs6000_vect_unroll_limit;
#else
  int x_rs6000_vect_unroll_limit;
#define rs6000_vect_unroll_limit global_options.x_rs6000_vect_unroll_limit
#endif
#ifdef GENERATOR_FILE
extern int rs6000_vect_unroll_reduc_threshold;
#else
  int x_rs6000_vect_unroll_reduc_threshold;
#define rs6000_vect_unroll_reduc_threshold global_options.x_rs6000_vect_unroll_reduc_threshold
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_IEEE128_CONSTANT;
#else
  int x_TARGET_IEEE128_CONSTANT;
#define TARGET_IEEE128_CONSTANT global_options.x_TARGET_IEEE128_CONSTANT
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int rs6000_privileged;
#else
  int x_rs6000_privileged;
#define rs6000_privileged global_options.x_rs6000_privileged
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_RESIDENT;
#else
  int x_TARGET_RESIDENT;
#define TARGET_RESIDENT global_options.x_TARGET_RESIDENT
#endif
#ifdef GENERATOR_FILE
extern int rs6000_rop_protect;
#else
  int x_rs6000_rop_protect;
#define rs6000_rop_protect global_options.x_rs6000_rop_protect
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_SPLAT_FLOAT_CONSTANT;
#else
  int x_TARGET_SPLAT_FLOAT_CONSTANT;
#define TARGET_SPLAT_FLOAT_CONSTANT global_options.x_TARGET_SPLAT_FLOAT_CONSTANT
#endif
#ifdef GENERATOR_FILE
extern int TARGET_SPLAT_WORD_CONSTANT;
#else
  int x_TARGET_SPLAT_WORD_CONSTANT;
#define TARGET_SPLAT_WORD_CONSTANT global_options.x_TARGET_SPLAT_WORD_CONSTANT
#endif
#ifdef GENERATOR_FILE
extern int TARGET_SPLIT_PATCH_NOPS;
#else
  int x_TARGET_SPLIT_PATCH_NOPS;
#define TARGET_SPLIT_PATCH_NOPS global_options.x_TARGET_SPLIT_PATCH_NOPS
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  const char *x_VAR_mclib_;
#define x_VAR_mclib_ do_not_use
#endif
#ifndef GENERATOR_FILE
...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mdirect_move;
#define x_VAR_mdirect_move do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_memb;
...
struct GTY(()) cl_target_option
{
  ...
  signed char x_TARGET_IEEE128_CONSTANT;
  ...
  signed char x_TARGET_SPLAT_FLOAT_CONSTANT;
  signed char x_TARGET_SPLAT_WORD_CONSTANT;
...
#define OPTION_MASK_DLMZB (HOST_WIDE_INT_1U << 7)
#define OPTION_MASK_EABI (HOST_WIDE_INT_1U << 8)
#define OPTION_MASK_EFFICIENT_UNALIGNED_VSX (HOST_WIDE_INT_1U << 9)
#define OPTION_MASK_FLOAT128_KEYWORD (HOST_WIDE_INT_1U << 10)
#define OPTION_MASK_FLOAT128_CVT (HOST_WIDE_INT_1U << 11)
#define OPTION_MASK_FLOAT128_HW (HOST_WIDE_INT_1U << 12)
#define OPTION_MASK_FPRND (HOST_WIDE_INT_1U << 13)
#define OPTION_MASK_DFP (HOST_WIDE_INT_1U << 14)
#define OPTION_MASK_SOFT_FLOAT (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_HTM (HOST_WIDE_INT_1U << 16)
#define OPTION_MASK_ISEL (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1U << 18)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_MMA (HOST_WIDE_INT_1U << 20)
#define OPTION_MASK_MODULO (HOST_WIDE_INT_1U << 21)
#define OPTION_MASK_MULHW (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_MULTIPLE (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_NO_UPDATE (HOST_WIDE_INT_1U << 24)
#define OPTION_MASK_PCREL (HOST_WIDE_INT_1U << 25)
#define OPTION_MASK_PCREL_OPT (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1U << 28)
#define OPTION_MASK_POWER10 (HOST_WIDE_INT_1U << 29)
#define OPTION_MASK_P10_FUSION (HOST_WIDE_INT_1U << 30)
#define OPTION_MASK_POWER11 (HOST_WIDE_INT_1U << 31)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1U << 32)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_POWER8 (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_P9_MINMAX (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_P9_MISC (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_P9_VECTOR (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_PREFIXED (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1U << 46)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1U << 47)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1U << 48)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1U << 49)
...
#define TARGET_64BIT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_64BIT) != 0)
#define TARGET_EXPLICIT_64BIT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_64BIT) != 0)
#define SET_TARGET_64BIT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_64BIT
/* ALTIVEC mask */
...
#define TARGET_ALTIVEC_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_ALTIVEC) != 0)
#define TARGET_EXPLICIT_ALTIVEC_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_ALTIVEC) != 0)
#define SET_TARGET_ALTIVEC(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_ALTIVEC
/* BASEREL mask */
#define TARGET_BASEREL ((target_flags & MASK_BASEREL) != 0)
#define TARGET_BASEREL_P(target_flags) (((target_flags) & MASK_BASEREL) != 0)
#define TARGET_BASEREL_OPTS_P(opts) (((opts->x_target_flags) & MASK_BASEREL) != 0)
#define TARGET_EXPLICIT_BASEREL_P(opts) ((opts->x_target_flags_explicit & MASK_BASEREL) != 0)
#define SET_TARGET_BASEREL(opts) opts->x_target_flags |= MASK_BASEREL
/* LITTLE_ENDIAN mask */
...
#define TARGET_LITTLE_ENDIAN_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_LITTLE_ENDIAN) != 0)
#define TARGET_EXPLICIT_LITTLE_ENDIAN_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_LITTLE_ENDIAN) != 0)
#define SET_TARGET_LITTLE_ENDIAN(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_LITTLE_ENDIAN
/* BLOCK_OPS_UNALIGNED_VSX mask */
...
#define TARGET_BLOCK_OPS_UNALIGNED_VSX_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_BLOCK_OPS_UNALIGNED_VSX) != 0)
#define TARGET_EXPLICIT_BLOCK_OPS_UNALIGNED_VSX_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_BLOCK_OPS_UNALIGNED_VSX) != 0)
#define SET_TARGET_BLOCK_OPS_UNALIGNED_VSX(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_BLOCK_OPS_UNALIGNED_VSX
/* BLOCK_OPS_VECTOR_PAIR mask */
...
#define TARGET_BLOCK_OPS_VECTOR_PAIR_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_BLOCK_OPS_VECTOR_PAIR) != 0)
#define TARGET_EXPLICIT_BLOCK_OPS_VECTOR_PAIR_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_BLOCK_OPS_VECTOR_PAIR) != 0)
#define SET_TARGET_BLOCK_OPS_VECTOR_PAIR(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_BLOCK_OPS_VECTOR_PAIR
/* CMPB mask */
...
#define TARGET_CMPB_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_CMPB) != 0)
#define TARGET_EXPLICIT_CMPB_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_CMPB) != 0)
#define SET_TARGET_CMPB(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_CMPB
/* CRYPTO mask */
...
#define TARGET_CRYPTO_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_CRYPTO) != 0)
#define TARGET_EXPLICIT_CRYPTO_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_CRYPTO) != 0)
#define SET_TARGET_CRYPTO(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_CRYPTO
/* DLMZB mask */
...
#define TARGET_DLMZB_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_DLMZB) != 0)
#define TARGET_EXPLICIT_DLMZB_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_DLMZB) != 0)
#define SET_TARGET_DLMZB(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_DLMZB
/* EABI mask */
...
#define TARGET_EABI_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_EABI) != 0)
#define TARGET_EXPLICIT_EABI_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_EABI) != 0)
#define SET_TARGET_EABI(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_EABI
/* EFFICIENT_UNALIGNED_VSX mask */
...
#define TARGET_EFFICIENT_UNALIGNED_VSX_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_EFFICIENT_UNALIGNED_VSX) != 0)
#define TARGET_EXPLICIT_EFFICIENT_UNALIGNED_VSX_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_EFFICIENT_UNALIGNED_VSX) != 0)
#define SET_TARGET_EFFICIENT_UNALIGNED_VSX(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_EFFICIENT_UNALIGNED_VSX
/* FLOAT128_KEYWORD mask */
...
#define TARGET_FLOAT128_KEYWORD_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_FLOAT128_KEYWORD) != 0)
#define TARGET_EXPLICIT_FLOAT128_KEYWORD_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_FLOAT128_KEYWORD) != 0)
#define SET_TARGET_FLOAT128_KEYWORD(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_FLOAT128_KEYWORD
/* FLOAT128_CVT mask */
...
#define TARGET_FLOAT128_CVT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_FLOAT128_CVT) != 0)
#define TARGET_EXPLICIT_FLOAT128_CVT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_FLOAT128_CVT) != 0)
#define SET_TARGET_FLOAT128_CVT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_FLOAT128_CVT
/* FLOAT128_HW mask */
...
#define TARGET_FLOAT128_HW_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_FLOAT128_HW) != 0)
#define TARGET_EXPLICIT_FLOAT128_HW_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_FLOAT128_HW) != 0)
#define SET_TARGET_FLOAT128_HW(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_FLOAT128_HW
/* FPRND mask */
...
#define TARGET_FPRND_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_FPRND) != 0)
#define TARGET_EXPLICIT_FPRND_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_FPRND) != 0)
#define SET_TARGET_FPRND(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_FPRND
/* DFP mask */
...
#define TARGET_DFP_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_DFP) != 0)
#define TARGET_EXPLICIT_DFP_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_DFP) != 0)
#define SET_TARGET_DFP(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_DFP
/* SOFT_FLOAT mask */
...
#define TARGET_SOFT_FLOAT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_SOFT_FLOAT) != 0)
#define TARGET_EXPLICIT_SOFT_FLOAT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_SOFT_FLOAT) != 0)
#define SET_TARGET_SOFT_FLOAT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_SOFT_FLOAT
/* HTM mask */
...
#define TARGET_HTM_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_HTM) != 0)
#define TARGET_EXPLICIT_HTM_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_HTM) != 0)
#define SET_TARGET_HTM(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_HTM
/* ISEL mask */
...
#define TARGET_ISEL_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_ISEL) != 0)
#define TARGET_EXPLICIT_ISEL_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_ISEL) != 0)
#define SET_TARGET_ISEL(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_ISEL
/* MFCRF mask */
...
#define TARGET_MFCRF_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MFCRF) != 0)
#define TARGET_EXPLICIT_MFCRF_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MFCRF) != 0)
#define SET_TARGET_MFCRF(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MFCRF
/* MINIMAL_TOC mask */
...
#define TARGET_MINIMAL_TOC_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MINIMAL_TOC) != 0)
#define TARGET_EXPLICIT_MINIMAL_TOC_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MINIMAL_TOC) != 0)
#define SET_TARGET_MINIMAL_TOC(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MINIMAL_TOC
/* MMA mask */
...
#define TARGET_MMA_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MMA) != 0)
#define TARGET_EXPLICIT_MMA_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MMA) != 0)
#define SET_TARGET_MMA(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MMA
/* MODULO mask */
...
#define TARGET_MODULO_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MODULO) != 0)
#define TARGET_EXPLICIT_MODULO_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MODULO) != 0)
#define SET_TARGET_MODULO(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MODULO
/* MULHW mask */
...
#define TARGET_MULHW_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MULHW) != 0)
#define TARGET_EXPLICIT_MULHW_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MULHW) != 0)
#define SET_TARGET_MULHW(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MULHW
/* MULTIPLE mask */
...
#define TARGET_MULTIPLE_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_MULTIPLE) != 0)
#define TARGET_EXPLICIT_MULTIPLE_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_MULTIPLE) != 0)
#define SET_TARGET_MULTIPLE(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_MULTIPLE
/* NO_UPDATE mask */
...
#define TARGET_NO_UPDATE_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_NO_UPDATE) != 0)
#define TARGET_EXPLICIT_NO_UPDATE_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_NO_UPDATE) != 0)
#define SET_TARGET_NO_UPDATE(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_NO_UPDATE
/* PCREL mask */
...
#define TARGET_PCREL_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_PCREL) != 0)
#define TARGET_EXPLICIT_PCREL_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_PCREL) != 0)
#define SET_TARGET_PCREL(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_PCREL
/* PCREL_OPT mask */
...
#define TARGET_PCREL_OPT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_PCREL_OPT) != 0)
#define TARGET_EXPLICIT_PCREL_OPT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_PCREL_OPT) != 0)
#define SET_TARGET_PCREL_OPT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_PCREL_OPT
/* POPCNTB mask */
...
#define TARGET_POPCNTB_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POPCNTB) != 0)
#define TARGET_EXPLICIT_POPCNTB_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POPCNTB) != 0)
#define SET_TARGET_POPCNTB(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POPCNTB
/* POPCNTD mask */
...
#define TARGET_POPCNTD_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POPCNTD) != 0)
#define TARGET_EXPLICIT_POPCNTD_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POPCNTD) != 0)
#define SET_TARGET_POPCNTD(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POPCNTD
/* POWER10 mask */
...
#define TARGET_POWER10_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POWER10) != 0)
#define TARGET_EXPLICIT_POWER10_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POWER10) != 0)
#define SET_TARGET_POWER10(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POWER10
/* P10_FUSION mask */
...
#define TARGET_P10_FUSION_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P10_FUSION) != 0)
#define TARGET_EXPLICIT_P10_FUSION_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P10_FUSION) != 0)
#define SET_TARGET_P10_FUSION(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P10_FUSION
/* POWER11 mask */
#define TARGET_POWER11 ((rs6000_isa_flags & OPTION_MASK_POWER11) != 0)
#define TARGET_POWER11_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_POWER11) != 0)
#define TARGET_POWER11_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POWER11) != 0)
#define TARGET_EXPLICIT_POWER11_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POWER11) != 0)
#define SET_TARGET_POWER11(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POWER11
/* P8_FUSION mask */
...
#define TARGET_P8_FUSION_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P8_FUSION) != 0)
#define TARGET_EXPLICIT_P8_FUSION_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P8_FUSION) != 0)
#define SET_TARGET_P8_FUSION(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P8_FUSION
/* P8_FUSION_SIGN mask */
...
#define TARGET_P8_FUSION_SIGN_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P8_FUSION_SIGN) != 0)
#define TARGET_EXPLICIT_P8_FUSION_SIGN_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P8_FUSION_SIGN) != 0)
#define SET_TARGET_P8_FUSION_SIGN(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P8_FUSION_SIGN
/* POWER8 mask */
#define TARGET_POWER8 ((rs6000_isa_flags & OPTION_MASK_POWER8) != 0)
#define TARGET_POWER8_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_POWER8) != 0)
#define TARGET_POWER8_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POWER8) != 0)
#define TARGET_EXPLICIT_POWER8_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POWER8) != 0)
#define SET_TARGET_POWER8(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POWER8
/* P8_VECTOR mask */
...
#define TARGET_P8_VECTOR_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P8_VECTOR) != 0)
#define TARGET_EXPLICIT_P8_VECTOR_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P8_VECTOR) != 0)
#define SET_TARGET_P8_VECTOR(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P8_VECTOR
/* P9_MINMAX mask */
...
#define TARGET_P9_MINMAX_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P9_MINMAX) != 0)
#define TARGET_EXPLICIT_P9_MINMAX_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P9_MINMAX) != 0)
#define SET_TARGET_P9_MINMAX(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P9_MINMAX
/* P9_MISC mask */
...
#define TARGET_P9_MISC_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P9_MISC) != 0)
#define TARGET_EXPLICIT_P9_MISC_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P9_MISC) != 0)
#define SET_TARGET_P9_MISC(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P9_MISC
/* P9_VECTOR mask */
...
#define TARGET_P9_VECTOR_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_P9_VECTOR) != 0)
#define TARGET_EXPLICIT_P9_VECTOR_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_P9_VECTOR) != 0)
#define SET_TARGET_P9_VECTOR(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_P9_VECTOR
/* PPC_GFXOPT mask */
...
#define TARGET_PPC_GFXOPT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_PPC_GFXOPT) != 0)
#define TARGET_EXPLICIT_PPC_GFXOPT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_PPC_GFXOPT) != 0)
#define SET_TARGET_PPC_GFXOPT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_PPC_GFXOPT
/* PPC_GPOPT mask */
...
#define TARGET_PPC_GPOPT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_PPC_GPOPT) != 0)
#define TARGET_EXPLICIT_PPC_GPOPT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_PPC_GPOPT) != 0)
#define SET_TARGET_PPC_GPOPT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_PPC_GPOPT
/* POWERPC64 mask */
...
#define TARGET_POWERPC64_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_POWERPC64) != 0)
#define TARGET_EXPLICIT_POWERPC64_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_POWERPC64) != 0)
#define SET_TARGET_POWERPC64(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_POWERPC64
/* PREFIXED mask */
...
#define TARGET_PREFIXED_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_PREFIXED) != 0)
#define TARGET_EXPLICIT_PREFIXED_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_PREFIXED) != 0)
#define SET_TARGET_PREFIXED(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_PREFIXED
/* QUAD_MEMORY mask */
...
#define TARGET_QUAD_MEMORY_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_QUAD_MEMORY) != 0)
#define TARGET_EXPLICIT_QUAD_MEMORY_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_QUAD_MEMORY) != 0)
#define SET_TARGET_QUAD_MEMORY(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_QUAD_MEMORY
/* QUAD_MEMORY_ATOMIC mask */
...
#define TARGET_QUAD_MEMORY_ATOMIC_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_QUAD_MEMORY_ATOMIC) != 0)
#define TARGET_EXPLICIT_QUAD_MEMORY_ATOMIC_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_QUAD_MEMORY_ATOMIC) != 0)
#define SET_TARGET_QUAD_MEMORY_ATOMIC(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_QUAD_MEMORY_ATOMIC
/* RECIP_PRECISION mask */
...
#define TARGET_RECIP_PRECISION_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_RECIP_PRECISION) != 0)
#define TARGET_EXPLICIT_RECIP_PRECISION_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_RECIP_PRECISION) != 0)
#define SET_TARGET_RECIP_PRECISION(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_RECIP_PRECISION
/* RELOCATABLE mask */
...
#define TARGET_RELOCATABLE_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_RELOCATABLE) != 0)
#define TARGET_EXPLICIT_RELOCATABLE_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_RELOCATABLE) != 0)
#define SET_TARGET_RELOCATABLE(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_RELOCATABLE
/* SAVE_TOC_INDIRECT mask */
...
#define TARGET_SAVE_TOC_INDIRECT_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_SAVE_TOC_INDIRECT) != 0)
#define TARGET_EXPLICIT_SAVE_TOC_INDIRECT_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_SAVE_TOC_INDIRECT) != 0)
#define SET_TARGET_SAVE_TOC_INDIRECT(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_SAVE_TOC_INDIRECT
/* STRICT_ALIGN mask */
...
#define TARGET_STRICT_ALIGN_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_STRICT_ALIGN) != 0)
#define TARGET_EXPLICIT_STRICT_ALIGN_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_STRICT_ALIGN) != 0)
#define SET_TARGET_STRICT_ALIGN(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_STRICT_ALIGN
/* VSX mask */
...
#define TARGET_VSX_OPTS_P(opts) (((opts->x_rs6000_isa_flags) & OPTION_MASK_VSX) != 0)
#define TARGET_EXPLICIT_VSX_P(opts) ((opts->x_rs6000_isa_flags_explicit & OPTION_MASK_VSX) != 0)
#define SET_TARGET_VSX(opts) opts->x_rs6000_isa_flags |= OPTION_MASK_VSX
...
enum opt_code
{
  ...
  OPT__param_rs6000_density_load_num_threshold_ = 303,/* --param=rs6000-density-load-num-threshold= */
  OPT__param_rs6000_density_load_pct_threshold_ = 304,/* --param=rs6000-density-load-pct-threshold= */
  OPT__param_rs6000_density_pct_threshold_ = 305,/* --param=rs6000-density-pct-threshold= */
  OPT__param_rs6000_density_penalty_ = 306,  /* --param=rs6000-density-penalty= */
  OPT__param_rs6000_density_size_threshold_ = 307,/* --param=rs6000-density-size-threshold= */
  OPT__param_rs6000_vect_unroll_issue_ = 308,/* --param=rs6000-vect-unroll-issue= */
  OPT__param_rs6000_vect_unroll_limit_ = 309,/* --param=rs6000-vect-unroll-limit= */
  OPT__param_rs6000_vect_unroll_reduc_threshold_ = 310,/* --param=rs6000-vect-unroll-reduc-threshold= */
  ...
  OPT__param_switch_lower_slow_alg_max_cases_ = 339,/* --param=switch-lower-slow-alg-max-cases= */
  OPT__param_threader_debug_ = 340,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 341,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 342,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 343, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 344,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 345,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 346,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 347, /* --param=tracer-min-branch-ratio= */
  OPT__param_transitive_relations_work_bound_ = 348,/* --param=transitive-relations-work-bound= */
  OPT__param_tree_reassoc_width_ = 349,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 350,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 351,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 352,/* --param=uninit-control-dep-attempts= */
  OPT__param_uninit_max_chain_len_ = 353,    /* --param=uninit-max-chain-len= */
  OPT__param_uninit_max_num_chains_ = 354,   /* --param=uninit-max-num-chains= */
  OPT__param_uninit_max_prune_work_ = 355,   /* --param=uninit-max-prune-work= */
  OPT__param_uninlined_function_insns_ = 356,/* --param=uninlined-function-insns= */
  OPT__param_uninlined_function_time_ = 357, /* --param=uninlined-function-time= */
  OPT__param_uninlined_thunk_insns_ = 358,   /* --param=uninlined-thunk-insns= */
  OPT__param_uninlined_thunk_time_ = 359,    /* --param=uninlined-thunk-time= */
  OPT__param_unlikely_bb_count_fraction_ = 360,/* --param=unlikely-bb-count-fraction= */
  OPT__param_unroll_jam_max_unroll_ = 361,   /* --param=unroll-jam-max-unroll= */
  OPT__param_unroll_jam_min_percent_ = 362,  /* --param=unroll-jam-min-percent= */
  OPT__param_use_after_scope_direct_emission_threshold_ = 363,/* --param=use-after-scope-direct-emission-threshold= */
  OPT__param_use_canonical_types_ = 364,     /* --param=use-canonical-types= */
  OPT__param_vect_epilogues_nomask_ = 365,   /* --param=vect-epilogues-nomask= */
  OPT__param_vect_force_slp_ = 366,          /* --param=vect-force-slp= */
  ...
  OPT__param_vrp_block_limit_ = 374,         /* --param=vrp-block-limit= */
  ...
  /* OPT__print_file_name = 386, */          /* --print-file-name */
  /* OPT__print_file_name_ = 387, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 388, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 389, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 390, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 391, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 392, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 393, */          /* --print-multiarch */
  /* OPT__print_prog_name = 394, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 395, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 396, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 397, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 398, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 399, */                  /* --profile */
  /* OPT__save_temps = 400, */               /* --save-temps */
  /* OPT__shared = 401, */                   /* --shared */
  /* OPT__specs = 402, */                    /* --specs */
  /* OPT__specs_ = 403, */                   /* --specs= */
  /* OPT__static = 404, */                   /* --static */
  /* OPT__static_pie = 405, */               /* --static-pie */
  /* OPT__symbolic = 406, */                 /* --symbolic */
  /* OPT__sysroot = 407, */                  /* --sysroot */
  OPT__sysroot_ = 408,                       /* --sysroot= */
  OPT__target_help = 409,                    /* --target-help */
  /* OPT__time = 410, */                     /* --time */
  /* OPT__trace_includes = 411, */           /* --trace-includes */
  /* OPT__traditional = 412, */              /* --traditional */
  /* OPT__traditional_cpp = 413, */          /* --traditional-cpp */
  /* OPT__trigraphs = 414, */                /* --trigraphs */
  /* OPT__undefine_macro = 415, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 416, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 417, */        /* --user-dependencies */
  /* OPT__verbose = 418, */                  /* --verbose */
  OPT__version = 419,                        /* --version */
  /* OPT__write_dependencies = 420, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 421, */  /* --write-user-dependencies */
  OPT_A = 422,                               /* -A */
  OPT_B = 423,                               /* -B */
  OPT_C = 424,                               /* -C */
  OPT_CC = 425,                              /* -CC */
  ...
  OPT_Wa_ = 469,                             /* -Wa, */
  OPT_Wabi = 470,                            /* -Wabi */
  OPT_Wabi_tag = 471,                        /* -Wabi-tag */
  OPT_Wabi_ = 472,                           /* -Wabi= */
  OPT_Wabsolute_value = 473,                 /* -Wabsolute-value */
  OPT_Waddress = 474,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 475,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 476,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 477,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 478,                       /* -Waliasing */
  OPT_Walign_commons = 479,                  /* -Walign-commons */
  /* OPT_Waligned_new = 480, */              /* -Waligned-new */
  OPT_Waligned_new_ = 481,                   /* -Waligned-new= */
  OPT_Wall = 482,                            /* -Wall */
  OPT_Walloc_size = 483,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 484,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 485,                     /* -Walloc-zero */
  OPT_Walloca = 486,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 487,            /* -Walloca-larger-than= */
  /* OPT_Waltivec_long_deprecated = 488, */  /* -Waltivec-long-deprecated */
  ...
  OPT_Wanalyzer_too_complex = 528,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 529,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 530,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 531,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 532,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 533,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 534,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 535,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 536,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 537,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 538,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 539,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 540,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 541,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 542,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 543, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 544,                  /* -Warray-bounds= */
  OPT_Warray_compare = 545,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 546, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 547,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 548,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 549,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 550, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 551,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 552,              /* -Wattribute-warning */
  OPT_Wattributes = 553,                     /* -Wattributes */
  OPT_Wattributes_ = 554,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 555,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 556, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 557,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 558,                   /* -Wbool-compare */
  OPT_Wbool_operation = 559,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 560,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 561,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 562,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 563, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 564,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 565,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 566,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 567,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 568,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 569,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 570, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 571,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 572,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 573,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 574,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 575, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 576,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 577,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 578, */           /* -Wc11-c2x-compat */
  OPT_Wc23_c2y_compat = 579,                 /* -Wc23-c2y-compat */
  OPT_Wc90_c99_compat = 580,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 581,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 582,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 583,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 584,                      /* -Wcase-enum */
  OPT_Wcast_align = 585,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 586,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 587,             /* -Wcast-function-type */
  OPT_Wcast_qual = 588,                      /* -Wcast-qual */
  OPT_Wcast_result = 589,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 590,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 591, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 592,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 593,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 594,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 595,           /* -Wcharacter-truncation */
  OPT_Wchkp = 596,                           /* -Wchkp */
  OPT_Wclass_conversion = 597,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 598,                /* -Wclass-memaccess */
  OPT_Wclobbered = 599,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 600,                /* -Wcomma-subscript */
  OPT_Wcomment = 601,                        /* -Wcomment */
  /* OPT_Wcomments = 602, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 603, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 604,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 605,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 606,        /* -Wconditionally-supported */
  OPT_Wconversion = 607,                     /* -Wconversion */
  OPT_Wconversion_extra = 608,               /* -Wconversion-extra */
  OPT_Wconversion_null = 609,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 610,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 611,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 612,   /* -Wcoverage-too-many-conditions */
  OPT_Wcoverage_too_many_paths = 613,        /* -Wcoverage-too-many-paths */
  OPT_Wcpp = 614,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 615,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 616,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 617,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 618, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 619,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 620,             /* -Wdangling-reference */
  OPT_Wdate_time = 621,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 622,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 623,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdefaulted_function_deleted = 624,     /* -Wdefaulted-function-deleted */
  OPT_Wdelete_incomplete = 625,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 626,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 627,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 628,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 629,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 630,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 631,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 632,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdeprecated_literal_operator = 633,    /* -Wdeprecated-literal-operator */
  OPT_Wdeprecated_non_prototype = 634,       /* -Wdeprecated-non-prototype */
  OPT_Wdeprecated_variadic_comma_omission = 635,/* -Wdeprecated-variadic-comma-omission */
  OPT_Wdesignated_init = 636,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 637,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 638,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 639,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 640,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 641,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 642,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 643,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 644,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 645,                /* -Wduplicated-cond */
  OPT_Weffc__ = 646,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 647,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 648,                     /* -Wempty-body */
  OPT_Wendif_labels = 649,                   /* -Wendif-labels */
  OPT_Wenum_compare = 650,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 651,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 652,              /* -Wenum-int-mismatch */
  OPT_Werror = 653,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 654, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 655,                         /* -Werror= */
  OPT_Wexceptions = 656,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 657,           /* -Wexpansion-to-defined */
  OPT_Wexternal_argument_mismatch = 658,     /* -Wexternal-argument-mismatch */
  OPT_Wextra = 659,                          /* -Wextra */
  OPT_Wextra_semi = 660,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 661,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 662,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 663,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 664,                    /* -Wfloat-equal */
  /* OPT_Wformat = 665, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 666,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 667,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 668,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 669,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 670, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 671,               /* -Wformat-overflow= */
  OPT_Wformat_security = 672,                /* -Wformat-security */
  OPT_Wformat_signedness = 673,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 674, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 675,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 676,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 677,             /* -Wformat-zero-length */
  OPT_Wformat_ = 678,                        /* -Wformat= */
  OPT_Wframe_address = 679,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 680,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 681,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 682,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 683,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 684,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 685,                  /* -Wglobal-module */
  OPT_Whardened = 686,                       /* -Whardened */
  OPT_Wheader_guard = 687,                   /* -Wheader-guard */
  /* OPT_Whsa = 688, */                      /* -Whsa */
  OPT_Wif_not_aligned = 689,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 690,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 691,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 692,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 693, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 694,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 695,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 696,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 697,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 698,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 699, */                   /* -Wimport */
  OPT_Winaccessible_base = 700,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 701,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 702,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 703,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 704,             /* -Winit-list-lifetime */
  OPT_Winit_self = 705,                      /* -Winit-self */
  OPT_Winline = 706,                         /* -Winline */
  OPT_Wint_conversion = 707,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 708,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 709,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 710,               /* -Winteger-division */
  OPT_Winterference_size = 711,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 712,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 713,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 714,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 715,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 716,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 717,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 718,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 719,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 720,               /* -Wjump-misses-init */
  OPT_Wl_ = 721,                             /* -Wl, */
  ...
  OPT_Wmultistatement_macros = 758,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 759,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 760,                     /* -Wnamespaces */
  OPT_Wnarrowing = 761,                      /* -Wnarrowing */
  OPT_Wnested_externs = 762,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 763, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 764, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 765, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 766, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 767, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 768, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 769,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 770,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 771,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 772,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 773,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 774,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 775, */               /* -Wnormalized */
  OPT_Wnormalized_ = 776,                    /* -Wnormalized= */
  OPT_Wnrvo = 777,                           /* -Wnrvo */
  OPT_Wnull_dereference = 778,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 779,                /* -Wobjc-root-class */
  OPT_Wodr = 780,                            /* -Wodr */
  OPT_Wold_style_cast = 781,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 782,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 783,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 784,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 785,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 786,                    /* -Wopenmp-simd */
  OPT_Woverflow = 787,                       /* -Woverflow */
  OPT_Woverlength_strings = 788,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 789, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 790,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 791,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 792,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 793,            /* -Woverwrite-recursive */
  OPT_Wp_ = 794,                             /* -Wp, */
  OPT_Wpacked = 795,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 796,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 797,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 798,                         /* -Wpadded */
  OPT_Wparentheses = 799,                    /* -Wparentheses */
  OPT_Wpedantic = 800,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 801,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 802,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 803,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 804, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 805,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 806,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 807,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 808,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 809,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 810,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 811,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 812,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 813,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 814,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 815,                       /* -Wprotocol */
  OPT_Wpsabi = 816,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 817,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 818,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 819,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 820,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 821,                /* -Wredundant-decls */
  OPT_Wredundant_move = 822,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 823,                 /* -Wredundant-tags */
  OPT_Wregister = 824,                       /* -Wregister */
  OPT_Wreorder = 825,                        /* -Wreorder */
  OPT_Wrestrict = 826,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 827,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 828,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 829,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 830,           /* -Wscalar-storage-order */
  OPT_Wselector = 831,                       /* -Wselector */
  OPT_Wself_move = 832,                      /* -Wself-move */
  OPT_Wsequence_point = 833,                 /* -Wsequence-point */
  OPT_Wshadow = 834,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 835, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 836,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 837, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 838,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 839, */            /* -Wshadow=global */
  OPT_Wshadow_local = 840,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 841,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 842,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 843,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 844, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 845,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 846,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 847,                /* -Wsign-conversion */
  OPT_Wsign_promo = 848,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 849,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 850,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 851,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 852,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 853,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 854,                    /* -Wspeculative */
  OPT_Wstack_protector = 855,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 856,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 857,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 858,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 859,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 860,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 861,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 862,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 863,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 864,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 865,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 866, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 867,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 868,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 869,            /* -Wstringop-truncation */
  OPT_Wstyle = 870,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 871,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 872,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 873,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 874,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 875,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 876,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 877,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 878,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 879,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 880,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 881,               /* -Wsuggest-override */
  OPT_Wsurprising = 882,                     /* -Wsurprising */
  OPT_Wswitch = 883,                         /* -Wswitch */
  OPT_Wswitch_bool = 884,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 885,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 886,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 887,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 888,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 889,                      /* -Wsync-nand */
  OPT_Wsynth = 890,                          /* -Wsynth */
  OPT_Wsystem_headers = 891,                 /* -Wsystem-headers */
  OPT_Wtabs = 892,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 893,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 894,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 895,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 896,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 897,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 898,                      /* -Wtemplates */
  OPT_Wterminate = 899,                      /* -Wterminate */
  OPT_Wtraditional = 900,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 901,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 902, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 903,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 904,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 905,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 906,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 907,                           /* -Wtsan */
  OPT_Wtype_limits = 908,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 909,            /* -Wundeclared-selector */
  OPT_Wundef = 910,                          /* -Wundef */
  OPT_Wundefined_do_loop = 911,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 912,                      /* -Wunderflow */
  OPT_Wunicode = 913,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 914,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 915,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 916,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 917,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 918, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 919, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 920,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 921,/* -Wunterminated-string-initialization */
  OPT_Wunused = 922,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 923,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 924,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 925, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 926,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 927,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 928,                /* -Wunused-function */
  OPT_Wunused_label = 929,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 930,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 931,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 932,               /* -Wunused-parameter */
  OPT_Wunused_result = 933,                  /* -Wunused-result */
  OPT_Wunused_value = 934,                   /* -Wunused-value */
  OPT_Wunused_variable = 935,                /* -Wunused-variable */
  OPT_Wuse_after_free = 936,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 937,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 938,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 939,                   /* -Wuseless-cast */
  OPT_Wvarargs = 940,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 941,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 942,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 943,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 944,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 945,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 946,            /* -Wvirtual-move-assign */
  OPT_Wvla = 947,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 948,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 949,                  /* -Wvla-parameter */
  OPT_Wvolatile = 950,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 951,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 952,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 953,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 954,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 955,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 956,                       /* -Wzerotrip */
  OPT_X = 957,                               /* -X */
  OPT_Xassembler = 958,                      /* -Xassembler */
  OPT_Xf = 959,                              /* -Xf */
  OPT_Xlinker = 960,                         /* -Xlinker */
  OPT_Xpreprocessor = 961,                   /* -Xpreprocessor */
  OPT_Z = 962,                               /* -Z */
  OPT_ansi = 963,                            /* -ansi */
  OPT_aux_info = 964,                        /* -aux-info */
  /* OPT_aux_info_ = 965, */                 /* -aux-info= */
  OPT_c = 966,                               /* -c */
  OPT_callgraph = 967,                       /* -callgraph */
  OPT_copyext = 968,                         /* -copyext */
  OPT_coverage = 969,                        /* -coverage */
  OPT_cpp = 970,                             /* -cpp */
  OPT_cpp_ = 971,                            /* -cpp= */
  OPT_d = 972,                               /* -d */
  OPT_debuglib_ = 973,                       /* -debuglib= */
  OPT_defaultlib_ = 974,                     /* -defaultlib= */
  OPT_defined_only = 975,                    /* -defined-only */
  OPT_demangle = 976,                        /* -demangle */
  OPT_dialect = 977,                         /* -dialect */
  OPT_dstartfiles = 978,                     /* -dstartfiles */
  OPT_dump_body_ = 979,                      /* -dump-body= */
  OPT_dump_level_ = 980,                     /* -dump-level= */
  OPT_dumpbase = 981,                        /* -dumpbase */
  OPT_dumpbase_ext = 982,                    /* -dumpbase-ext */
  OPT_dumpdir = 983,                         /* -dumpdir */
  OPT_dumpfullversion = 984,                 /* -dumpfullversion */
  OPT_dumpmachine = 985,                     /* -dumpmachine */
  OPT_dumpspecs = 986,                       /* -dumpspecs */
  OPT_dumpversion = 987,                     /* -dumpversion */
  OPT_e = 988,                               /* -e */
  OPT_export_dynamic = 989,                  /* -export-dynamic */
  OPT_fPIC = 990,                            /* -fPIC */
  OPT_fPIE = 991,                            /* -fPIE */
  OPT_fRTS_ = 992,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 993,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 994,                   /* -fabi-version= */
  OPT_faccess_control = 995,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 996,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 997,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 998,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 999,                  /* -falign-commons */
  OPT_falign_functions = 1000,               /* -falign-functions */
  OPT_falign_functions_ = 1001,              /* -falign-functions= */
  OPT_falign_jumps = 1002,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1003,                  /* -falign-jumps= */
  OPT_falign_labels = 1004,                  /* -falign-labels */
  OPT_falign_labels_ = 1005,                 /* -falign-labels= */
  OPT_falign_loops = 1006,                   /* -falign-loops */
  OPT_falign_loops_ = 1007,                  /* -falign-loops= */
  /* OPT_faligned_new = 1008, */             /* -faligned-new */
  OPT_faligned_new_ = 1009,                  /* -faligned-new= */
  OPT_fall_instantiations = 1010,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1011,                /* -fall-intrinsics */
  OPT_fall_virtual = 1012,                   /* -fall-virtual */
  OPT_fallocation_dce = 1013,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1014,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1015,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1016,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1017, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1018,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1019,        /* -falt-external-templates */
  OPT_faltivec = 1020,                       /* -faltivec */
  OPT_fanalyzer = 1021,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1022,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1023,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1024,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1025,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1026,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1027, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1028,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1029,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1030,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1031,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1032,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1033,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1034,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1035,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1036,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1037, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1038, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1039, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1040, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1041,           /* -fasan-shadow-offset= */
  OPT_fasm = 1042,                           /* -fasm */
  OPT_fassert = 1043,                        /* -fassert */
  OPT_fassociative_math = 1044,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1045,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1046,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1047,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1048,                     /* -fauto-init */
  OPT_fauto_profile = 1049,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1050,                 /* -fauto-profile= */
  OPT_fautomatic = 1051,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1052,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1053,                     /* -fbackslash */
  OPT_fbacktrace = 1054,                     /* -fbacktrace */
  OPT_fbit_tests = 1055,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1056,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1057,                        /* -fbounds */
  OPT_fbounds_check = 1058,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1059,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1060,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1061,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1062, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1063, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1064, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1065,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1066,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1067,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1068,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1069,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1070,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1071,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1072,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1073,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1074,                    /* -fcall-used- */
  OPT_fcaller_saves = 1075,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1076,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1077,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1078,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1079,      /* -fcanonical-system-headers */
  OPT_fcase = 1080,                          /* -fcase */
  /* OPT_fcf_protection = 1081, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1082,                /* -fcf-protection= */
  OPT_fchar8_t = 1083,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1084,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1085, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1086,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1087,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1088,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1089, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1090, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1091, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1092, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1093, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1094, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1095,                  /* -fcheckaction= */
  OPT_fchecking = 1096,                      /* -fchecking */
  OPT_fchecking_ = 1097,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1098,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1099,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1100,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1101,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1102,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1103,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1104,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1105,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1106,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1107,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1108,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1109,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1110,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1111,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1112,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1113,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1114,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1115,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1116, */                /* -fcilkplus */
  OPT_fcoarray_ = 1117,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1118,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1119,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1120,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1121,                        /* -fcommon */
  OPT_fcompare_debug = 1122,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1123,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1124,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1125,                  /* -fcompare-elim */
  OPT_fconcepts = 1126,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1127,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1128,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1129,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1130,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1131, */          /* -fconserve-space */
  OPT_fconserve_stack = 1132,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1133,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1134,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1135,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1136,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1137,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1138,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1139,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1140,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1141,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1142,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1143,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1144,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1145, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1146,                     /* -fcontracts */
  OPT_fconvert_ = 1147,                      /* -fconvert= */
  OPT_fcoroutines = 1148,                    /* -fcoroutines */
  OPT_fcpp = 1149,                           /* -fcpp */
  OPT_fcpp_begin = 1150,                     /* -fcpp-begin */
  OPT_fcpp_end = 1151,                       /* -fcpp-end */
  OPT_fcprop_registers = 1152,               /* -fcprop-registers */
  OPT_fcray_pointer = 1153,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1154,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1155,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1156, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1157,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1158,              /* -fcx-limited-range */
  OPT_fd = 1159,                             /* -fd */
  OPT_fd_lines_as_code = 1160,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1161,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1162,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1163,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1164,                      /* -fdbg-cnt= */
  OPT_fdce = 1165,                           /* -fdce */
  OPT_fdebug = 1166,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1167,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1168,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1169,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1170,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1171,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1172,           /* -fdebug-types-section */
  OPT_fdebug_ = 1173,                        /* -fdebug= */
  OPT_fdec = 1174,                           /* -fdec */
  OPT_fdec_blank_format_item = 1175,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1176,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1177,           /* -fdec-format-defaults */
  OPT_fdec_include = 1178,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1179,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1180,                      /* -fdec-math */
  OPT_fdec_static = 1181,                    /* -fdec-static */
  OPT_fdec_structure = 1182,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1183,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1184, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1185,                          /* -fdef= */
  OPT_fdefault_double_8 = 1186,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1187, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1188,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1189,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1190,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1191,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1192,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1193,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1194,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1195,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1196,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1197,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1198,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1199,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1200,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1201,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1202,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1203,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1204,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1205, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1206,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1207,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1208,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1209,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1210,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1211,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1212,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1213,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1214,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1215,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1216,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1217,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1218,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1219,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1220,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1221,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1222,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1223, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1224,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1225,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1226,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1227,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1228,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1229, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1230,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1231,               /* -fdirectives-only */
  OPT_fdisable_ = 1232,                      /* -fdisable- */
  OPT_fdoc = 1233,                           /* -fdoc */
  OPT_fdoc_dir_ = 1234,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1235,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1236,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1237,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1238,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1239,                      /* -fdruntime */
  OPT_fdse = 1240,                           /* -fdse */
  OPT_fdump_ = 1241,                         /* -fdump- */
  OPT_fdump_ada_spec = 1242,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1243,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1244,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1245,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1246,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1247,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1248,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1249,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1250,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1251,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1252,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1253,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1254,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1255,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1256,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1257,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1258,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1259,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1260, */               /* -fdump-core */
  OPT_fdump_d_original = 1261,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1262,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1263,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1264,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1265,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1266,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1267,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1268,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1269,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1270, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1271,                   /* -fdump-passes */
  OPT_fdump_scos = 1272,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1273,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1274,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1275,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1276,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1277,                /* -fearly-inlining */
  OPT_felide_constructors = 1278,            /* -felide-constructors */
  OPT_felide_type = 1279,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1280, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1281,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1282,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1283,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1284,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1285,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1286,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1287,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1288,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1289,                /* -fenum-int-equiv */
  OPT_fexceptions = 1290,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1291,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1292,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1293,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1294,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1295,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1296,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1297,               /* -fextended-opaque */
  OPT_fextern_std_ = 1298,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1299,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1300,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1301,            /* -fexternal-templates */
  OPT_ff2c = 1302,                           /* -ff2c */
  OPT_ffast_math = 1303,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1304,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1305,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1306,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1307,              /* -ffinite-math-only */
  OPT_ffixed_ = 1308,                        /* -ffixed- */
  OPT_ffixed_form = 1309,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1310,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1311,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1312,                    /* -fflex-debug */
  OPT_ffloat_store = 1313,                   /* -ffloat-store */
  OPT_ffloatvalue = 1314,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1315,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1316,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1317,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1318, */              /* -fforce-addr */
  OPT_fforward_propagate = 1319,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1320,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1321,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1322,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1323,                     /* -ffpe-trap= */
  OPT_ffree_form = 1324,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1325,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1326,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1327,                  /* -ffreestanding */
  OPT_ffriend_injection = 1328,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1329,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1330,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1331,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1332,             /* -ffunction-sections */
  OPT_fgcse = 1333,                          /* -fgcse */
  OPT_fgcse_after_reload = 1334,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1335,                      /* -fgcse-las */
  OPT_fgcse_lm = 1336,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1337,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1338,              /* -fgen-module-list= */
  OPT_fgimple = 1339,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1340,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1341,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1342,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1343,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1344,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1345,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1346,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1347,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1348,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1349,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1350,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1351,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1352,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1353,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1354,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1355,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1356,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1357,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1358,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1359,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1360,                      /* -fgraphite */
  OPT_fgraphite_identity = 1361,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1362,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1363,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1364, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1365,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1366, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1367, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1368,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1369,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1370,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1371,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1372,                      /* -fhardened */
  /* OPT_fhelp = 1373, */                    /* -fhelp */
  /* OPT_fhelp_ = 1374, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1375,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1376,                     /* -fhonor-std */
  OPT_fhosted = 1377,                        /* -fhosted */
  OPT_fhuge_objects = 1378,                  /* -fhuge-objects */
  OPT_fident = 1379,                         /* -fident */
  OPT_fif_conversion = 1380,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1381,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1382,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1383,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1384,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1385,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1386,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1387,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1388,            /* -fimplicit-templates */
  OPT_finclude_imports = 1389,               /* -finclude-imports */
  OPT_findex = 1390,                         /* -findex */
  OPT_findicator_column = 1391,              /* -findicator-column */
  OPT_findirect_inlining = 1392,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1393,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1394,               /* -finit-character= */
  OPT_finit_derived = 1395,                  /* -finit-derived */
  OPT_finit_integer_ = 1396,                 /* -finit-integer= */
  OPT_finit_local_zero = 1397,               /* -finit-local-zero */
  OPT_finit_logical_ = 1398,                 /* -finit-logical= */
  OPT_finit_real_ = 1399,                    /* -finit-real= */
  OPT_finline = 1400,                        /* -finline */
  OPT_finline_arg_packing = 1401,            /* -finline-arg-packing */
  OPT_finline_atomics = 1402,                /* -finline-atomics */
  OPT_finline_functions = 1403,              /* -finline-functions */
  OPT_finline_functions_called_once = 1404,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1405,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1406,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1407, */           /* -finline-limit- */
  OPT_finline_limit_ = 1408,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1409,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1410,        /* -finline-small-functions */
  OPT_finline_stringops = 1411,              /* -finline-stringops */
  OPT_finline_stringops_ = 1412,             /* -finline-stringops= */
  OPT_finput_charset_ = 1413,                /* -finput-charset= */
  OPT_finstrument_functions = 1414,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1415,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1416,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1417,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1418,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1419,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1420,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1421,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1422,                    /* -finvariants */
  OPT_fipa_bit_cp = 1423,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1424,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1425, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1426,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1427,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1428,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1429,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1430, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1431,                    /* -fipa-modref */
  OPT_fipa_profile = 1432,                   /* -fipa-profile */
  OPT_fipa_pta = 1433,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1434,                /* -fipa-pure-const */
  OPT_fipa_ra = 1435,                        /* -fipa-ra */
  OPT_fipa_reference = 1436,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1437,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1438,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1439,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1440,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1441,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1442, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1443,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1444,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1445,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1446,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1447,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1448,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1449,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1450,                  /* -fira-verbose= */
  OPT_fiso = 1451,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1452,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1453,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1454,              /* -fivar-visibility= */
  OPT_fivopts = 1455,                        /* -fivopts */
  OPT_fjump_tables = 1456,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1457,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1458,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1459,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1460,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1461,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1462,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1463,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1464,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1465,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1466,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1467,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1468, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1469,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1470,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1471,            /* -fleading-underscore */
  OPT_flibs_ = 1472,                         /* -flibs= */
  OPT_flifetime_dse = 1473,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1474,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1475,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1476,                /* -flinker-output= */
  /* OPT_flive_patching = 1477, */           /* -flive-patching */
  OPT_flive_patching_ = 1478,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1479,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1480,                   /* -flocal-ivars */
  OPT_flocation_ = 1481,                     /* -flocation= */
  /* OPT_floop_block = 1482, */              /* -floop-block */
  /* OPT_floop_flatten = 1483, */            /* -floop-flatten */
  OPT_floop_interchange = 1484,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1485,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1486, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1487,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1488, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1489,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1490,                     /* -flra-remat */
  OPT_flto = 1491,                           /* -flto */
  OPT_flto_compression_level_ = 1492,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1493,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1494,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1495, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1496,                /* -flto-partition= */
  OPT_flto_report = 1497,                    /* -flto-report */
  OPT_flto_report_wpa = 1498,                /* -flto-report-wpa */
  OPT_flto_ = 1499,                          /* -flto= */
  OPT_fltrans = 1500,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1501,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1502,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1503,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1504,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1505,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1506,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1507,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1508,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1509,                          /* -fm2-g */
  OPT_fm2_lower_case = 1510,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1511,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1512,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1513,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1514,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1515,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1516,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1517,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1518,             /* -fmacro-prefix-map= */
  OPT_fmain = 1519,                          /* -fmain */
  OPT_fmalloc_dce = 1520,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1521,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1522,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1523,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1524,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1525,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1526,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1527,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1528,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1529,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1530,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1531,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1532,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1533,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1534,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1535,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1536,                          /* -fmod= */
  OPT_fmodule_file_ = 1537,                  /* -fmodule-file= */
  OPT_fmodule_header = 1538,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1539,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1540,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1541,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1542,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1543,                   /* -fmodule-only */
  OPT_fmodule_private = 1544,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1545,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1546,                    /* -fmoduleinfo */
  OPT_fmodules = 1547,                       /* -fmodules */
  /* OPT_fmodules_ts = 1548, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1549,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1550,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1551,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1552,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1553,                 /* -fms-extensions */
  OPT_fmudflap = 1554,                       /* -fmudflap */
  OPT_fmudflapir = 1555,                     /* -fmudflapir */
  OPT_fmudflapth = 1556,                     /* -fmudflapth */
  OPT_fmultiflags = 1557,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1558,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1559,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1560,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1561,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1562,                  /* -fnext-runtime */
  OPT_fnil = 1563,                           /* -fnil */
  OPT_fnil_receivers = 1564,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1565,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1566,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1567,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1568,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1569,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1570,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1571,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1572,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1573,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1574,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1575,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1576,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1577,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1578,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1579,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1580,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1581,              /* -foffload-options= */
  OPT_foffload_ = 1582,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1583,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1584,                         /* -fonly= */
  OPT_fopenacc = 1585,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1586,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1587,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1588,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1589,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1590, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1591,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1592,                /* -foperator-names */
  OPT_fopt_info = 1593,                      /* -fopt-info */
  OPT_fopt_info_ = 1594,                     /* -fopt-info- */
  OPT_foptimize_crc = 1595,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1596, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1597,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1598,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1599, */          /* -foptional-diags */
  OPT_fpack_derived = 1600,                  /* -fpack-derived */
  OPT_fpack_struct = 1601,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1602,                  /* -fpack-struct= */
  OPT_fpad_source = 1603,                    /* -fpad-source */
  OPT_fpartial_inlining = 1604,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1605,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1606,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1607,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1608,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1609,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1610,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1611,                    /* -fpeel-loops */
  OPT_fpeephole = 1612,                      /* -fpeephole */
  OPT_fpeephole2 = 1613,                     /* -fpeephole2 */
  OPT_fpermissive = 1614,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1615,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1616,                           /* -fpic */
  OPT_fpie = 1617,                           /* -fpie */
  OPT_fpim = 1618,                           /* -fpim */
  OPT_fpim2 = 1619,                          /* -fpim2 */
  OPT_fpim3 = 1620,                          /* -fpim3 */
  OPT_fpim4 = 1621,                          /* -fpim4 */
  OPT_fplan9_extensions = 1622,              /* -fplan9-extensions */
  OPT_fplt = 1623,                           /* -fplt */
  OPT_fplugin_arg_ = 1624,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1625,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1626,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1627,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1628,                /* -fpostconditions */
  OPT_fpre_include_ = 1629,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1630,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1631,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1632,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1633,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1634,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1635,              /* -fpretty-templates */
  OPT_fpreview_all = 1636,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1637,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1638,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1639,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1640,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1641,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1642,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1643,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1644,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1645,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1646,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1647,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1648,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1649,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1650,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1651,           /* -fprintf-return-value */
  OPT_fprofile = 1652,                       /* -fprofile */
  OPT_fprofile_abs_path = 1653,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1654,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1655,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1656,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1657,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1658,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1659,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1660,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1661,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1662,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1663,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1664,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1665,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1666,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1667,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1668,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1669,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1670,               /* -fprofile-update= */
  OPT_fprofile_use = 1671,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1672,                  /* -fprofile-use= */
  OPT_fprofile_values = 1673,                /* -fprofile-values */
  OPT_fprotect_parens = 1674,                /* -fprotect-parens */
  OPT_fpthread = 1675,                       /* -fpthread */
  OPT_fq = 1676,                             /* -fq */
  OPT_frandom_seed = 1677,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1678,                  /* -frandom-seed= */
  OPT_frange = 1679,                         /* -frange */
  OPT_frange_check = 1680,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1681,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1682,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1683,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1684,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1685,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1686,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1687,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1688,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1689,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1690,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1691,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1692,               /* -frecord-marker=8 */
  OPT_frecursive = 1693,                     /* -frecursive */
  OPT_free = 1694,                           /* -free */
  /* OPT_freg_struct_return = 1695, */       /* -freg-struct-return */
  /* OPT_fregmove = 1696, */                 /* -fregmove */
  OPT_frelease = 1697,                       /* -frelease */
  OPT_frename_registers = 1698,              /* -frename-registers */
  OPT_freorder_blocks = 1699,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1700,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1701,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1702,             /* -freorder-functions */
  OPT_frepack_arrays = 1703,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1704,          /* -freplace-objc-classes */
  OPT_frepo = 1705,                          /* -frepo */
  OPT_freport_bug = 1706,                    /* -freport-bug */
  OPT_frequire_return_statement = 1707,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1708,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1709, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1710,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1711,                   /* -fresolution= */
  OPT_freturn = 1712,                        /* -freturn */
  OPT_frevert_all = 1713,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1714,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1715,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1716,             /* -frevert=intpromote */
  OPT_frounding_math = 1717,                 /* -frounding-math */
  OPT_frtti = 1718,                          /* -frtti */
  OPT_fruntime_modules_ = 1719,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1720,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1721,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1722,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1723,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1724,                   /* -frust-crate= */
  OPT_frust_debug = 1725,                    /* -frust-debug */
  OPT_frust_dump_ = 1726,                    /* -frust-dump- */
  OPT_frust_edition_ = 1727,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1728,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1729,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1730,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1731,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1732,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1733,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1734,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1735,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1736,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1737,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1738,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1739,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1740,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1741,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1742,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1743,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1744, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1745,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1746,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1747,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1748,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1749,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1750,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1751,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1752,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1753, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1754,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1755,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1756,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1757,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1758,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1759,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1760,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1761,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1762,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1763,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1764,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1765,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1766,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1767,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1768,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1769,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1770, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1771,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1772,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1773,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1774,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1775,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1776,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1777,               /* -fsection-anchors */
  /* OPT_fsee = 1778, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1779,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1780,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1781,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1782,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1783,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1784,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1785,        /* -fsemantic-interposition */
  OPT_fshared = 1786,                        /* -fshared */
  OPT_fshort_enums = 1787,                   /* -fshort-enums */
  OPT_fshort_wchar = 1788,                   /* -fshort-wchar */
  OPT_fshow_column = 1789,                   /* -fshow-column */
  OPT_fshrink_wrap = 1790,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1791,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1792,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1793,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1794,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1795,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1796,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1797,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1798,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1799,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1800,                /* -fsoft-check-all */
  OPT_fsources = 1801,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1802,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1803,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1804,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1805,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1806,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1807,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1808,                      /* -fsquangle */
  OPT_fssa_backprop = 1809,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1810,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1811,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1812,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1813, */             /* -fstack-check */
  OPT_fstack_check_ = 1814,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1815,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1816,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1817,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1818,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1819,               /* -fstack-protector */
  OPT_fstack_protector_all = 1820,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1821,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1822,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1823,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1824,                   /* -fstack-usage */
  OPT_fstatic_call = 1825,                   /* -fstatic-call */
  OPT_fstats = 1826,                         /* -fstats */
  OPT_fstdarg_opt = 1827,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1828,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1829, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1830,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1831,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1832, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1833,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1834,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1835,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1836,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1837, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1838,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1839,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1840,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1841,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1842,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1843,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1844,                  /* -fstrub=strict */
  OPT_fswig = 1845,                          /* -fswig */
  OPT_fswitch_errors = 1846,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1847,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1848,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1849,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1850, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1851,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1852, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1853,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1854, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1855,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1856,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1857,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1858,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1859,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1860,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1861,                   /* -ftime-report */
  OPT_ftime_report_details = 1862,           /* -ftime-report-details */
  OPT_ftls_model_ = 1863,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1864,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1865,                   /* -ftrace-debug */
  OPT_ftracer = 1866,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1867,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1868,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1869,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1870,                   /* -ftrampolines */
  OPT_ftransition_all = 1871,                /* -ftransition=all */
  OPT_ftransition_field = 1872,              /* -ftransition=field */
  OPT_ftransition_in = 1873,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1874,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1875,          /* -ftransition=templates */
  OPT_ftransition_tls = 1876,                /* -ftransition=tls */
  OPT_ftrapping_math = 1877,                 /* -ftrapping-math */
  OPT_ftrapv = 1878,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1879,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1880,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1881,                      /* -ftree-ccp */
  OPT_ftree_ch = 1882,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1883, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1884,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1885,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1886, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1887,                   /* -ftree-cselim */
  OPT_ftree_dce = 1888,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1889,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1890,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1891,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1892,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1893, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1894,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1895,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1896, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1897,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1898,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1899, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1900,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1901,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1902,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1903,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1904,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1905,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1906,                      /* -ftree-pre */
  OPT_ftree_pta = 1907,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1908,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1909, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1910,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1911,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1912,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1913,                     /* -ftree-slsr */
  OPT_ftree_sra = 1914,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1915, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1916, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1917,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1918,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1919,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1920, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1921,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1922, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1923,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1924,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1925,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1926,         /* -funconstrained-commons */
  OPT_funderscoring = 1927,                  /* -funderscoring */
  OPT_funit_at_a_time = 1928,                /* -funit-at-a-time */
  OPT_funittest = 1929,                      /* -funittest */
  OPT_funreachable_traps = 1930,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1931,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1932,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1933,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1934, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1935,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1936,                      /* -funsigned */
  OPT_funsigned_bitfields = 1937,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1938,                 /* -funsigned-char */
  OPT_funswitch_loops = 1939,                /* -funswitch-loops */
  OPT_funwind_tables = 1940,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1941,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1942,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1943,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1944,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1945,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1946,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1947,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1948,                     /* -fuse-list= */
  OPT_fvar_tracking = 1949,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1950,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1951,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1952,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1953,/* -fvariable-expansion-in-unroller */
  OPT_fvec = 1954,                           /* -fvec */
  /* OPT_fvect_cost_model = 1955, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1956,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1957,                   /* -fverbose-asm */
  /* OPT_fversion = 1958, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1959,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1960,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1961,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1962,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1963,                   /* -fvisibility= */
  OPT_fvpt = 1964,                           /* -fvpt */
  OPT_fvtable_gc = 1965,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1966,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1967,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1968,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1969,                     /* -fvtv-debug */
  OPT_fweak = 1970,                          /* -fweak */
  OPT_fweak_templates = 1971,                /* -fweak-templates */
  OPT_fweb = 1972,                           /* -fweb */
  /* OPT_fwhole_file = 1973, */              /* -fwhole-file */
  OPT_fwhole_program = 1974,                 /* -fwhole-program */
  OPT_fwholediv = 1975,                      /* -fwholediv */
  OPT_fwholevalue = 1976,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1977,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1978,             /* -fworking-directory */
  OPT_fwpa = 1979,                           /* -fwpa */
  OPT_fwpa_ = 1980,                          /* -fwpa= */
  OPT_fwrapv = 1981,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1982,                 /* -fwrapv-pointer */
  OPT_fxref = 1983,                          /* -fxref */
  OPT_fyacc_debug = 1984,                    /* -fyacc-debug */
  /* OPT_fzee = 1985, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1986,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1987,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1988,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1989,                     /* -fzero-link */
  OPT_g = 1990,                              /* -g */
  OPT_gant = 1991,                           /* -gant */
  OPT_gas_loc_support = 1992,                /* -gas-loc-support */
  OPT_gas_locview_support = 1993,            /* -gas-locview-support */
  OPT_gbtf = 1994,                           /* -gbtf */
  OPT_gcodeview = 1995,                      /* -gcodeview */
  OPT_gcoff = 1996,                          /* -gcoff */
  OPT_gcoff1 = 1997,                         /* -gcoff1 */
  OPT_gcoff2 = 1998,                         /* -gcoff2 */
  OPT_gcoff3 = 1999,                         /* -gcoff3 */
  OPT_gcolumn_info = 2000,                   /* -gcolumn-info */
  OPT_gctf = 2001,                           /* -gctf */
  OPT_gdescribe_dies = 2002,                 /* -gdescribe-dies */
  OPT_gdwarf = 2003,                         /* -gdwarf */
  OPT_gdwarf_ = 2004,                        /* -gdwarf- */
  OPT_gdwarf32 = 2005,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2006,                       /* -gdwarf64 */
  OPT_gen_decls = 2007,                      /* -gen-decls */
  OPT_ggdb = 2008,                           /* -ggdb */
  OPT_ggnu_pubnames = 2009,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2010,                   /* -gimple-stats */
  OPT_ginline_points = 2011,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2012, /* -ginternal-reset-location-views */
  OPT_gnat = 2013,                           /* -gnat */
  OPT_gnatO = 2014,                          /* -gnatO */
  OPT_gno_ = 2015,                           /* -gno- */
  OPT_gno_pubnames = 2016,                   /* -gno-pubnames */
  OPT_gprune_btf = 2017,                     /* -gprune-btf */
  OPT_gpubnames = 2018,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2019,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2020,                   /* -gsplit-dwarf */
  OPT_gstabs = 2021,                         /* -gstabs */
  OPT_gstabs_ = 2022,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2023,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2024,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2025,                        /* -gtoggle */
  OPT_gvariable_location_views = 2026,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2027,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2028,                           /* -gvms */
  OPT_gxcoff = 2029,                         /* -gxcoff */
  OPT_gxcoff_ = 2030,                        /* -gxcoff+ */
  OPT_gz = 2031,                             /* -gz */
  OPT_gz_ = 2032,                            /* -gz= */
  OPT_h = 2033,                              /* -h */
  OPT_help = 2034,                           /* -help */
  OPT_idirafter = 2035,                      /* -idirafter */
  OPT_imacros = 2036,                        /* -imacros */
  OPT_imultiarch = 2037,                     /* -imultiarch */
  OPT_imultilib = 2038,                      /* -imultilib */
  OPT_include = 2039,                        /* -include */
  OPT_iplugindir_ = 2040,                    /* -iplugindir= */
  OPT_iprefix = 2041,                        /* -iprefix */
  OPT_iquote = 2042,                         /* -iquote */
  OPT_isysroot = 2043,                       /* -isysroot */
  OPT_isystem = 2044,                        /* -isystem */
  OPT_iwithprefix = 2045,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2046,              /* -iwithprefixbefore */
  OPT_k8 = 2047,                             /* -k8 */
  OPT_l = 2048,                              /* -l */
  OPT_lang_asm = 2049,                       /* -lang-asm */
  OPT_list = 2050,                           /* -list */
  OPT_m32 = 2051,                            /* -m32 */
  OPT_m64 = 2052,                            /* -m64 */
  OPT_mabi_altivec = 2053,                   /* -mabi=altivec */
  OPT_mabi_d32 = 2054,                       /* -mabi=d32 */
  OPT_mabi_d64 = 2055,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 2056,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 2057,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 2058,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 2059,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 2060,                /* -mabi=no-altivec */
  OPT_mabi_vec_default = 2061,               /* -mabi=vec-default */
  OPT_mabi_vec_extabi = 2062,                /* -mabi=vec-extabi */
  OPT_mads = 2063,                           /* -mads */
  OPT_main = 2064,                           /* -main */
  OPT_main_ = 2065,                          /* -main= */
  OPT_maix_struct_return = 2066,             /* -maix-struct-return */
  OPT_malign_ = 2067,                        /* -malign- */
  OPT_malign_branch_targets = 2068,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 2069,             /* -mallow-movmisalign */
  OPT_maltivec = 2070,                       /* -maltivec */
  OPT_malways_hint = 2071,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 2072,       /* -mavoid-indexed-addresses */
  OPT_mbaserel32 = 2073,                     /* -mbaserel32 */
  OPT_mbig = 2074,                           /* -mbig */
  OPT_mbig_endian = 2075,                    /* -mbig-endian */
  OPT_mbit_align = 2076,                     /* -mbit-align */
  OPT_mbit_word = 2077,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 2078,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 2079,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 2080,      /* -mblock-move-inline-limit= */
  OPT_mblock_ops_unaligned_vsx = 2081,       /* -mblock-ops-unaligned-vsx */
  OPT_mblock_ops_vector_pair = 2082,         /* -mblock-ops-vector-pair */
  OPT_mbss_plt = 2083,                       /* -mbss-plt */
  OPT_mcall_ = 2084,                         /* -mcall- */
  OPT_mclib_ = 2085,                         /* -mclib= */
  OPT_mcmpb = 2086,                          /* -mcmpb */
  OPT_mcompat_align_parm = 2087,             /* -mcompat-align-parm */
  OPT_mcpu_ = 2088,                          /* -mcpu= */
  OPT_mcrypto = 2089,                        /* -mcrypto */
  OPT_mdebug_ = 2090,                        /* -mdebug= */
  OPT_mdirect_move = 2091,                   /* -mdirect-move */
  OPT_mdlmzb = 2092,                         /* -mdlmzb */
  OPT_meabi = 2093,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 2094,       /* -mefficient-unaligned-vsx */
  OPT_memb = 2095,                           /* -memb */
  OPT_mfloat128 = 2096,                      /* -mfloat128 */
  OPT_mfloat128_convert = 2097,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 2098,             /* -mfloat128-hardware */
  OPT_mfp_in_toc = 2099,                     /* -mfp-in-toc */
  OPT_mfprnd = 2100,                         /* -mfprnd */
  OPT_mfriz = 2101,                          /* -mfriz */
  OPT_mfull_toc = 2102,                      /* -mfull-toc */
  /* OPT_mfused_madd = 2103, */              /* -mfused-madd */
  /* OPT_mgen_cell_microcode = 2104, */      /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 2105,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 2106,                      /* -mhard-dfp */
  OPT_mhard_float = 2107,                    /* -mhard-float */
  OPT_mhtm = 2108,                           /* -mhtm */
  OPT_mieee128_constant = 2109,              /* -mieee128-constant */
  OPT_minsert_sched_nops_ = 2110,            /* -minsert-sched-nops= */
  OPT_misel = 2111,                          /* -misel */
  OPT_mlittle = 2112,                        /* -mlittle */
  OPT_mlittle_endian = 2113,                 /* -mlittle-endian */
  OPT_mlong_double_ = 2114,                  /* -mlong-double- */
  OPT_mlongcall = 2115,                      /* -mlongcall */
  /* OPT_mlra = 2116, */                     /* -mlra */
  OPT_mmfcrf = 2117,                         /* -mmfcrf */
  OPT_mmfpgpr = 2118,                        /* -mmfpgpr */
  OPT_mminimal_toc = 2119,                   /* -mminimal-toc */
  OPT_mmma = 2120,                           /* -mmma */
  OPT_mmodulo = 2121,                        /* -mmodulo */
  OPT_mmulhw = 2122,                         /* -mmulhw */
  OPT_mmultiple = 2123,                      /* -mmultiple */
  OPT_mmvme = 2124,                          /* -mmvme */
  OPT_mnewlib = 2125,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 2126,                  /* -mno-fp-in-toc */
  /* OPT_mno_mfpgpr = 2127, */               /* -mno-mfpgpr */
  /* OPT_mno_string = 2128, */               /* -mno-string */
  OPT_mno_sum_in_toc = 2129,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 2130,                        /* -mno-toc */
  OPT_mno_traceback = 2131,                  /* -mno-traceback */
  OPT_mno_update = 2132,                     /* -mno-update */
  OPT_moptimize_swaps = 2133,                /* -moptimize-swaps */
  OPT_mpcrel = 2134,                         /* -mpcrel */
  OPT_mpcrel_opt = 2135,                     /* -mpcrel-opt */
  OPT_mpltseq = 2136,                        /* -mpltseq */
  OPT_mpointers_to_nested_functions = 2137,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 2138,                       /* -mpopcntb */
  OPT_mpopcntd = 2139,                       /* -mpopcntd */
  OPT_mpower10 = 2140,                       /* -mpower10 */
  OPT_mpower10_fusion = 2141,                /* -mpower10-fusion */
  OPT_mpower11 = 2142,                       /* -mpower11 */
  OPT_mpower8_fusion = 2143,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 2144,            /* -mpower8-fusion-sign */
  OPT_mpower8_internal = 2145,               /* -mpower8-internal */
  OPT_mpower8_vector = 2146,                 /* -mpower8-vector */
  OPT_mpower9_minmax = 2147,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 2148,                   /* -mpower9-misc */
  OPT_mpower9_vector = 2149,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 2150, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 2151,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 2152,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 2153,                     /* -mpowerpc64 */
  OPT_mprefixed = 2154,                      /* -mprefixed */
  OPT_mprioritize_restricted_insns_ = 2155,  /* -mprioritize-restricted-insns= */
  OPT_mprivileged = 2156,                    /* -mprivileged */
  OPT_mprototype = 2157,                     /* -mprototype */
  OPT_mquad_memory = 2158,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 2159,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 2160,             /* -mreadonly-in-sdata */
  OPT_mrecip = 2161,                         /* -mrecip */
  OPT_mrecip_precision = 2162,               /* -mrecip-precision */
  OPT_mrecip_ = 2163,                        /* -mrecip= */
  OPT_mregnames = 2164,                      /* -mregnames */
  OPT_mrelative_jumptables = 2165,           /* -mrelative-jumptables */
  OPT_mrelocatable = 2166,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 2167,               /* -mrelocatable-lib */
  OPT_mresident32 = 2168,                    /* -mresident32 */
  OPT_mrop_protect = 2169,                   /* -mrop-protect */
  OPT_msave_toc_indirect = 2170,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 2171,             /* -msched-costly-dep= */
  OPT_msched_epilog = 2172,                  /* -msched-epilog */
  OPT_msched_groups = 2173,                  /* -msched-groups */
  OPT_msched_prolog = 2174,                  /* -msched-prolog */
  OPT_msdata = 2175,                         /* -msdata */
  OPT_msdata_ = 2176,                        /* -msdata= */
  OPT_msecure_plt = 2177,                    /* -msecure-plt */
  OPT_mshlib = 2178,                         /* -mshlib */
  OPT_msim = 2179,                           /* -msim */
  OPT_msingle_pic_base = 2180,               /* -msingle-pic-base */
  OPT_msoft_float = 2181,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 2182,      /* -mspeculate-indirect-jumps */
  OPT_msplat_float_constant = 2183,          /* -msplat-float-constant */
  OPT_msplat_word_constant = 2184,           /* -msplat-word-constant */
  OPT_msplit_patch_nops = 2185,              /* -msplit-patch-nops */
  OPT_mstack_protector_guard_offset_ = 2186, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2187,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2188,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2189,                  /* -mstrict-align */
  OPT_mstring = 2190,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 2191,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 2192,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 2193,            /* -msvr4-struct-return */
  OPT_mtls_size_ = 2194,                     /* -mtls-size= */
  OPT_mtoc = 2195,                           /* -mtoc */
  OPT_mtraceback_ = 2196,                    /* -mtraceback= */
  OPT_mtune_ = 2197,                         /* -mtune= */
  OPT_munroll_only_small_loops = 2198,       /* -munroll-only-small-loops */
  OPT_mupdate = 2199,                        /* -mupdate */
  OPT_mveclibabi_ = 2200,                    /* -mveclibabi= */
  OPT_mvrsave = 2201,                        /* -mvrsave */
  /* OPT_mvrsave_no = 2202, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 2203, */              /* -mvrsave=yes */
  OPT_mvsx = 2204,                           /* -mvsx */
  OPT_mvsx_align_128 = 2205,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 2206, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 2207,             /* -mwarn-altivec-long */
  OPT_mxl_compat = 2208,                     /* -mxl-compat */
  OPT_myellowknife = 2209,                   /* -myellowknife */
  OPT_n = 2210,                              /* -n */
  OPT_name_sort = 2211,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2212,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2213,              /* -no-integrated-cpp */
  OPT_no_pie = 2214,                         /* -no-pie */
  OPT_nocpp = 2215,                          /* -nocpp */
  OPT_nodefaultlibs = 2216,                  /* -nodefaultlibs */
  /* OPT_noixemul = 2217, */                 /* -noixemul */
  OPT_nolibc = 2218,                         /* -nolibc */
  OPT_nomain = 2219,                         /* -nomain */
  OPT_nophoboslib = 2220,                    /* -nophoboslib */
  OPT_nostartfiles = 2221,                   /* -nostartfiles */
  OPT_nostdinc = 2222,                       /* -nostdinc */
  OPT_nostdinc__ = 2223,                     /* -nostdinc++ */
  OPT_nostdlib = 2224,                       /* -nostdlib */
  OPT_nostdlib__ = 2225,                     /* -nostdlib++ */
  OPT_o = 2226,                              /* -o */
  OPT_objects = 2227,                        /* -objects */
  OPT_p = 2228,                              /* -p */
  OPT_pass_exit_codes = 2229,                /* -pass-exit-codes */
  /* OPT_pedantic = 2230, */                 /* -pedantic */
  OPT_pedantic_errors = 2231,                /* -pedantic-errors */
  OPT_pg = 2232,                             /* -pg */
  OPT_pie = 2233,                            /* -pie */
  OPT_pipe = 2234,                           /* -pipe */
  OPT_preprocess = 2235,                     /* -preprocess */
  OPT_print_file_name_ = 2236,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2237,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2238,          /* -print-multi-directory */
  OPT_print_multi_lib = 2239,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2240,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2241,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2242,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2243,               /* -print-prog-name= */
  OPT_print_search_dirs = 2244,              /* -print-search-dirs */
  OPT_print_sysroot = 2245,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2246,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2247,                    /* -print-value */
  OPT_pthread = 2248,                        /* -pthread */
  OPT_quiet = 2249,                          /* -quiet */
  OPT_r = 2250,                              /* -r */
  OPT_remap = 2251,                          /* -remap */
  OPT_reverse_sort = 2252,                   /* -reverse-sort */
  OPT_s = 2253,                              /* -s */
  OPT_save_temps = 2254,                     /* -save-temps */
  OPT_save_temps_ = 2255,                    /* -save-temps= */
  OPT_shared = 2256,                         /* -shared */
  OPT_shared_libgcc = 2257,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2258,               /* -shared-libphobos */
  OPT_size_sort = 2259,                      /* -size-sort */
  /* OPT_specs = 2260, */                    /* -specs */
  OPT_specs_ = 2261,                         /* -specs= */
  OPT_static = 2262,                         /* -static */
  OPT_static_libasan = 2263,                 /* -static-libasan */
  OPT_static_libgcc = 2264,                  /* -static-libgcc */
  OPT_static_libgcobol = 2265,               /* -static-libgcobol */
  OPT_static_libgfortran = 2266,             /* -static-libgfortran */
  OPT_static_libgm2 = 2267,                  /* -static-libgm2 */
  OPT_static_libgo = 2268,                   /* -static-libgo */
  OPT_static_libhwasan = 2269,               /* -static-libhwasan */
  OPT_static_liblsan = 2270,                 /* -static-liblsan */
  OPT_static_libmpx = 2271,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2272,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2273,               /* -static-libphobos */
  OPT_static_libquadmath = 2274,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2275,               /* -static-libstdc++ */
  OPT_static_libtsan = 2276,                 /* -static-libtsan */
  OPT_static_libubsan = 2277,                /* -static-libubsan */
  OPT_static_pie = 2278,                     /* -static-pie */
  /* OPT_std_c__03 = 2279, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2280, */                /* -std=c++0x */
  OPT_std_c__11 = 2281,                      /* -std=c++11 */
  OPT_std_c__14 = 2282,                      /* -std=c++14 */
  OPT_std_c__17 = 2283,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2284, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2285, */                /* -std=c++1z */
  OPT_std_c__20 = 2286,                      /* -std=c++20 */
  OPT_std_c__23 = 2287,                      /* -std=c++23 */
  OPT_std_c__26 = 2288,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2289, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2290, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2291, */                /* -std=c++2c */
  OPT_std_c__98 = 2292,                      /* -std=c++98 */
  OPT_std_c11 = 2293,                        /* -std=c11 */
  OPT_std_c17 = 2294,                        /* -std=c17 */
  /* OPT_std_c18 = 2295, */                  /* -std=c18 */
  /* OPT_std_c1x = 2296, */                  /* -std=c1x */
  OPT_std_c23 = 2297,                        /* -std=c23 */
  /* OPT_std_c2x = 2298, */                  /* -std=c2x */
  OPT_std_c2y = 2299,                        /* -std=c2y */
  /* OPT_std_c89 = 2300, */                  /* -std=c89 */
  OPT_std_c90 = 2301,                        /* -std=c90 */
  OPT_std_c99 = 2302,                        /* -std=c99 */
  /* OPT_std_c9x = 2303, */                  /* -std=c9x */
  OPT_std_f2003 = 2304,                      /* -std=f2003 */
  OPT_std_f2008 = 2305,                      /* -std=f2008 */
  OPT_std_f2008ts = 2306,                    /* -std=f2008ts */
  OPT_std_f2018 = 2307,                      /* -std=f2018 */
  OPT_std_f2023 = 2308,                      /* -std=f2023 */
  OPT_std_f202y = 2309,                      /* -std=f202y */
  OPT_std_f95 = 2310,                        /* -std=f95 */
  OPT_std_gnu = 2311,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2312, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2313, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2314,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2315,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2316,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2317, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2318, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2319,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2320,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2321,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2322, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2323, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2324, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2325,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2326,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2327,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2328, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2329, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2330,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2331, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2332,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2333, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2334,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2335,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2336, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2337, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2338,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2339, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2340, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2341, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2342, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2343, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2344, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2345,                     /* -std=legacy */
  OPT_stdlib_ = 2346,                        /* -stdlib= */
  OPT_symbol_ = 2347,                        /* -symbol= */
  OPT_symbolic = 2348,                       /* -symbolic */
  OPT_t = 2349,                              /* -t */
  OPT_time = 2350,                           /* -time */
  OPT_time_ = 2351,                          /* -time= */
  OPT_traditional = 2352,                    /* -traditional */
  OPT_traditional_cpp = 2353,                /* -traditional-cpp */
  OPT_tree_stats = 2354,                     /* -tree-stats */
  OPT_trigraphs = 2355,                      /* -trigraphs */
  OPT_truncate = 2356,                       /* -truncate */
  OPT_type_stats = 2357,                     /* -type-stats */
  OPT_u = 2358,                              /* -u */
  OPT_undef = 2359,                          /* -undef */
  OPT_v = 2360,                              /* -v */
  OPT_version = 2361,                        /* -version */
  OPT_w = 2362,                              /* -w */
  OPT_wrapper = 2363,                        /* -wrapper */
  OPT_x = 2364,                              /* -x */
  OPT_z = 2365,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
