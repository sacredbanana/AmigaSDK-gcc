...
#define HAVE_maddldsi4 (TARGET_MADDLD)
#define HAVE_maddlddi4 ((TARGET_MADDLD) && (TARGET_POWERPC64))
#define HAVE_madddi4_highpart (TARGET_MADDLD && BYTES_BIG_ENDIAN && TARGET_POWERPC64)
#define HAVE_umadddi4_highpart (TARGET_MADDLD && BYTES_BIG_ENDIAN && TARGET_POWERPC64)
#define HAVE_madddi4_highpart_le (TARGET_MADDLD && !BYTES_BIG_ENDIAN && TARGET_POWERPC64)
#define HAVE_umadddi4_highpart_le (TARGET_MADDLD && !BYTES_BIG_ENDIAN && TARGET_POWERPC64)
...
#define HAVE_rotlsi3_insert_3 (INTVAL (operands[2]) > 0 \
   && INTVAL (operands[2]) == exact_log2 (UINTVAL (operands[4]) + 1))
#define HAVE_rotldi3_insert_3 ((INTVAL (operands[2]) > 0 \
...
#define HAVE_signbitkf2_dm ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_signbittf2_dm ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_signbitkf2_dm_mem ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_signbittf2_dm_mem ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
...
#define HAVE_fmaxsf3 (TARGET_VSX && !flag_finite_math_only)
#define HAVE_fminsf3 (TARGET_VSX && !flag_finite_math_only)
#define HAVE_fmaxdf3 (TARGET_VSX && !flag_finite_math_only)
#define HAVE_fmindf3 (TARGET_VSX && !flag_finite_math_only)
#define HAVE_isel_cc_si (TARGET_ISEL)
#define HAVE_isel_cc_di ((TARGET_ISEL) && (TARGET_POWERPC64))
#define HAVE_isel_ccuns_si (TARGET_ISEL)
#define HAVE_isel_ccuns_di ((TARGET_ISEL) && (TARGET_POWERPC64))
#define HAVE_setbc_cc_si (TARGET_POWER10)
#define HAVE_setbc_cc_di ((TARGET_POWER10) && (TARGET_POWERPC64))
#define HAVE_setbc_ccuns_si (TARGET_POWER10)
#define HAVE_setbc_ccuns_di ((TARGET_POWER10) && (TARGET_POWERPC64))
...
#define HAVE_floatsisf2_lfiwax_qi_mem_zext (TARGET_HARD_FLOAT && TARGET_FCFIDS && TARGET_P9_VECTOR \
   && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatsisf2_lfiwax_hi_mem_zext (TARGET_HARD_FLOAT && TARGET_FCFIDS && TARGET_P9_VECTOR \
   && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatsidf2_lfiwax_qi_mem_zext (TARGET_HARD_FLOAT && TARGET_FCFID && TARGET_P9_VECTOR \
   && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatsidf2_lfiwax_hi_mem_zext (TARGET_HARD_FLOAT && TARGET_FCFID && TARGET_P9_VECTOR \
   && TARGET_DIRECT_MOVE_64BIT)
...
#define HAVE_rs6000_mffscrni (TARGET_P9_MISC)
...
#define HAVE_lrintsfdi2 (TARGET_HARD_FLOAT && TARGET_FCTID)
#define HAVE_lrintdfdi2 (TARGET_HARD_FLOAT && TARGET_FCTID)
#define HAVE_lrintsfsi_di (TARGET_HARD_FLOAT && !TARGET_POPCNTD)
#define HAVE_lrintdfsi_di (TARGET_HARD_FLOAT && !TARGET_POPCNTD)
...
#define HAVE_floattikf2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floattitf2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatunstikf2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatunstitf2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fix_trunckfti2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fix_trunctfti2 ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
...
#define HAVE_movsf_from_si2_ashiftrt (TARGET_NO_SF_SUBREG)
#define HAVE_movsf_from_si2_lshiftrt (TARGET_NO_SF_SUBREG)
#define HAVE_xxspltidp_sf_internal (TARGET_POWER10)
#define HAVE_xxspltidp_df_internal (TARGET_POWER10)
#define HAVE_xxspltiw_sf_internal (TARGET_POWER10)
#define HAVE_xxspltiw_df_internal (TARGET_POWER10)
...
#define HAVE_extenddfif2_vsx ((TARGET_LONG_DOUBLE_128 && TARGET_VSX) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_extenddftf2_vsx ((TARGET_LONG_DOUBLE_128 && TARGET_VSX) && (FLOAT128_IBM_P (TFmode)))
#define HAVE_truncifdf2_internal1 ((!TARGET_XL_COMPAT \
   && TARGET_HARD_FLOAT && TARGET_LONG_DOUBLE_128) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_trunctfdf2_internal1 ((!TARGET_XL_COMPAT \
   && TARGET_HARD_FLOAT && TARGET_LONG_DOUBLE_128) && (FLOAT128_IBM_P (TFmode)))
#define HAVE_truncifdf2_internal2 ((TARGET_XL_COMPAT && TARGET_HARD_FLOAT \
   && TARGET_LONG_DOUBLE_128) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_trunctfdf2_internal2 ((TARGET_XL_COMPAT && TARGET_HARD_FLOAT \
   && TARGET_LONG_DOUBLE_128) && (FLOAT128_IBM_P (TFmode)))
#define HAVE_fix_trunc_helperif ((TARGET_HARD_FLOAT) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_fix_trunc_helpertf ((TARGET_HARD_FLOAT) && (FLOAT128_IBM_P (TFmode)))
#define HAVE_negif2_internal ((TARGET_HARD_FLOAT) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_negtf2_internal ((TARGET_HARD_FLOAT) && (FLOAT128_IBM_P (TFmode)))
...
#define HAVE_ieee_128bit_vsx_abskf2 ((TARGET_FLOAT128_TYPE && !TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_ieee_128bit_vsx_abstf2 ((TARGET_FLOAT128_TYPE && !TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
...
#define HAVE_p8_mtvsrd_v16qidi2 (TARGET_DIRECT_MOVE_64BIT)
...
#define HAVE_p8_mtvsrd_df (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v16qi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v8hi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v4si (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v4sf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v2di (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v2df (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_v1ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_xxpermdi_kf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_p8_xxpermdi_tf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_reload_vsx_from_gprti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv16qi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv8hi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv4si (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv4sf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv2di (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv2df (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprv1ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprkf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_reload_vsx_from_gprtf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_p8_mtvsrd_sf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_vsx_from_gprsf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v16qi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v8hi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v4si (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v4sf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v2di (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v2df (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_v1ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_p8_mfvsrd_3_kf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_p8_mfvsrd_3_tf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_reload_gpr_from_vsxti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv16qi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv8hi (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv4si (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv4sf (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv2di (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv2df (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxv1ti (TARGET_DIRECT_MOVE_64BIT)
#define HAVE_reload_gpr_from_vsxkf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_reload_gpr_from_vsxtf ((TARGET_DIRECT_MOVE_64BIT) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_reload_gpr_from_vsxsf (TARGET_DIRECT_MOVE_64BIT)
...
#define HAVE_unpacktf_dm ((TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (TFmode)) && (TARGET_LONG_DOUBLE_128))
#define HAVE_unpackif_dm ((TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (IFmode)) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_unpacktd_dm ((TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (TDmode)) && (TARGET_HARD_FLOAT))
#define HAVE_unpacktf_nodm ((!TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (TFmode)) && (TARGET_LONG_DOUBLE_128))
#define HAVE_unpackif_nodm ((!TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (IFmode)) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_unpacktd_nodm ((!TARGET_DIRECT_MOVE_64BIT && FLOAT128_2REG_P (TDmode)) && (TARGET_HARD_FLOAT))
#define HAVE_packtf_hard ((FLOAT128_2REG_P (TFmode) && TARGET_HARD_FLOAT) && (TARGET_LONG_DOUBLE_128))
#define HAVE_packif_hard ((FLOAT128_2REG_P (IFmode) && TARGET_HARD_FLOAT) && (FLOAT128_IBM_P (IFmode)))
#define HAVE_packtd_hard ((FLOAT128_2REG_P (TDmode) && TARGET_HARD_FLOAT) && (TARGET_HARD_FLOAT))
#define HAVE_packtf_soft ((FLOAT128_2REG_P (TFmode) && TARGET_SOFT_FLOAT) && (TARGET_LONG_DOUBLE_128))
...
#define HAVE_addkf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_addtf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_subkf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_subtf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_mulkf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_multf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_divkf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_divtf3 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_sqrtkf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_sqrttf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_copysignkf3_hard ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_copysigntf3_hard ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_copysignkf3_soft ((!TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_copysigntf3_soft ((!TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_negkf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_negtf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_abskf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_abstf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fmakf4_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fmatf4_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_extendsfkf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_extendsftf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_extenddfkf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_extenddftf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_trunckfdf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_trunctfdf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_trunckfsf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_trunctfsf2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fix_kfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fixuns_kfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fix_tfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fixuns_tfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fix_kfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fixuns_kfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fix_tfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fixuns_tfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fix_trunckfqi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fixuns_trunckfqi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fix_trunckfhi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fixuns_trunckfhi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fix_trunctfqi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fixuns_trunctfqi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fix_trunctfhi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fixuns_trunctfhi2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_float_kfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_float_tfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_float_kfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_float_tfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatqikf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floathikf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatqitf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floathitf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatuns_kfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatuns_tfdi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatuns_kfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatuns_tfsi2_hw ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatunsqikf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatunshikf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floatunsqitf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floatunshitf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_floorkf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_floortf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_ceilkf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_ceiltf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_btrunckf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_btrunctf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_roundkf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_roundtf2 ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_addkf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_addtf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_subkf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_subtf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_mulkf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_multf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_divkf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_divtf3_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_sqrtkf2_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_sqrttf2_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_fmakf4_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_fmatf4_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_trunckfdf2_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_trunctfdf2_odd ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_darnsi (TARGET_P9_MISC)
#define HAVE_darndi ((TARGET_P9_MISC) && (TARGET_POWERPC64))
#define HAVE_setb_signed (TARGET_P9_MISC)
#define HAVE_setb_unsigned (TARGET_P9_MISC)
#define HAVE_hashst (rs6000_rop_protect)
#define HAVE_hashchk (rs6000_rop_protect)
#define HAVE_isync 1
...
#define HAVE_vsx_stxvd2x4_le_const_v4sf (!BYTES_BIG_ENDIAN \
   && VECTOR_MEM_VSX_P (V4SFmode) \
   && !TARGET_P9_VECTOR \
   && !altivec_indexed_or_indirect_operand (operands[0], V4SFmode) \
   && const_vec_duplicate_p (operands[1]))
#define HAVE_vsx_stxvd2x4_le_const_v4si (!BYTES_BIG_ENDIAN \
   && VECTOR_MEM_VSX_P (V4SImode) \
   && !TARGET_P9_VECTOR \
   && !altivec_indexed_or_indirect_operand (operands[0], V4SImode) \
   && const_vec_duplicate_p (operands[1]))
...
#define HAVE_vsx_extract_v4si_w1 (TARGET_DIRECT_MOVE_64BIT \
...
#define HAVE_vreplace_un_si (TARGET_POWER10)
#define HAVE_vreplace_un_sf (TARGET_POWER10)
#define HAVE_vreplace_un_di (TARGET_POWER10)
#define HAVE_vreplace_un_df (TARGET_POWER10)
...
#define HAVE_vsx_sign_extend_v16qi_v4si (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v16qi_v2di (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v16qi_di (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v16qi_si (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v8hi_v4si (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v8hi_v2di (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v8hi_di (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v8hi_si (TARGET_P9_VECTOR)
#define HAVE_vsx_sign_extend_v4si_v2di (TARGET_P9_VECTOR)
#define HAVE_extendditi2 (TARGET_POWERPC64 && TARGET_POWER10)
#define HAVE_extendditi2_vector (TARGET_POWER10)
#define HAVE_xsxexpqp_kf_v2di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsxexpqp_kf_di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsxexpqp_tf_v2di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsxexpqp_tf_di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsxexpdp_si (TARGET_P9_VECTOR)
#define HAVE_xsxexpdp_di ((TARGET_P9_VECTOR) && (TARGET_POWERPC64))
#define HAVE_xsxsigqp_kf_v1ti ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsxsigqp_tf_v1ti ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsxsigqp_kf_ti ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsxsigqp_tf_ti ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsxsigdp (TARGET_P9_VECTOR && TARGET_POWERPC64)
#define HAVE_xsiexpqpf_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsiexpqpf_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsiexpqp_kf_v2di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsiexpqp_kf_di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xsiexpqp_tf_v2di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsiexpqp_tf_di ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xsiexpdp_si (TARGET_P9_VECTOR && TARGET_POWERPC64)
#define HAVE_xsiexpdp_di ((TARGET_P9_VECTOR && TARGET_POWERPC64) && (TARGET_POWERPC64))
#define HAVE_xsiexpdpf_si (TARGET_P9_VECTOR && TARGET_POWERPC64)
#define HAVE_xsiexpdpf_di ((TARGET_P9_VECTOR && TARGET_POWERPC64) && (TARGET_POWERPC64))
...
#define HAVE_modv2di3 (TARGET_POWER10)
#define HAVE_modv4si3 (TARGET_POWER10)
#define HAVE_umodv2di3 (TARGET_POWER10)
#define HAVE_umodv4si3 (TARGET_POWER10)
#define HAVE_smulv2di3_highpart (TARGET_POWER10)
#define HAVE_smulv4si3_highpart (TARGET_POWER10)
#define HAVE_umulv2di3_highpart (TARGET_POWER10)
#define HAVE_umulv4si3_highpart (TARGET_POWER10)
...
#define HAVE_vmsumcud (TARGET_POWER10)
#define HAVE_sldoi_to_movv4si (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv8hi (VECTOR_MEM_ALTIVEC_OR_VSX_P (V8HImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv16qi (VECTOR_MEM_ALTIVEC_OR_VSX_P (V16QImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv4sf (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SFmode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv2df (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DFmode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv2di (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movv1ti (VECTOR_MEM_ALTIVEC_OR_VSX_P (V1TImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movti (VECTOR_MEM_ALTIVEC_OR_VSX_P (TImode) && can_create_pseudo_p ())
#define HAVE_sldoi_to_movkf ((VECTOR_MEM_ALTIVEC_OR_VSX_P (KFmode) && can_create_pseudo_p ()) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_sldoi_to_movtf ((VECTOR_MEM_ALTIVEC_OR_VSX_P (TFmode) && can_create_pseudo_p ()) && (FLOAT128_VECTOR_P (TFmode)))
...
#define HAVE_altivec_vselv4si (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SImode))
#define HAVE_altivec_vselv8hi (VECTOR_MEM_ALTIVEC_OR_VSX_P (V8HImode))
#define HAVE_altivec_vselv16qi (VECTOR_MEM_ALTIVEC_OR_VSX_P (V16QImode))
#define HAVE_altivec_vselv4sf (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SFmode))
#define HAVE_altivec_vselv2df (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DFmode))
#define HAVE_altivec_vselv2di (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DImode))
#define HAVE_altivec_vselv1ti (VECTOR_MEM_ALTIVEC_OR_VSX_P (V1TImode))
#define HAVE_altivec_vselti (VECTOR_MEM_ALTIVEC_OR_VSX_P (TImode))
#define HAVE_altivec_vselkf ((VECTOR_MEM_ALTIVEC_OR_VSX_P (KFmode)) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_altivec_vseltf ((VECTOR_MEM_ALTIVEC_OR_VSX_P (TFmode)) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_altivec_vselv4si2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SImode))
#define HAVE_altivec_vselv8hi2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V8HImode))
#define HAVE_altivec_vselv16qi2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V16QImode))
#define HAVE_altivec_vselv4sf2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SFmode))
#define HAVE_altivec_vselv2df2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DFmode))
#define HAVE_altivec_vselv2di2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DImode))
#define HAVE_altivec_vselv1ti2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V1TImode))
#define HAVE_altivec_vselti2 (VECTOR_MEM_ALTIVEC_OR_VSX_P (TImode))
#define HAVE_altivec_vselkf2 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (KFmode)) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_altivec_vseltf2 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (TFmode)) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_altivec_vselv4si3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SImode))
#define HAVE_altivec_vselv8hi3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V8HImode))
#define HAVE_altivec_vselv16qi3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V16QImode))
#define HAVE_altivec_vselv4sf3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SFmode))
#define HAVE_altivec_vselv2df3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DFmode))
#define HAVE_altivec_vselv2di3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DImode))
#define HAVE_altivec_vselv1ti3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V1TImode))
#define HAVE_altivec_vselti3 (VECTOR_MEM_ALTIVEC_OR_VSX_P (TImode))
#define HAVE_altivec_vselkf3 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (KFmode)) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_altivec_vseltf3 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (TFmode)) && (FLOAT128_VECTOR_P (TFmode)))
#define HAVE_altivec_vselv4si4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SImode))
#define HAVE_altivec_vselv8hi4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V8HImode))
#define HAVE_altivec_vselv16qi4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V16QImode))
#define HAVE_altivec_vselv4sf4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V4SFmode))
#define HAVE_altivec_vselv2df4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DFmode))
#define HAVE_altivec_vselv2di4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V2DImode))
#define HAVE_altivec_vselv1ti4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (V1TImode))
#define HAVE_altivec_vselti4 (VECTOR_MEM_ALTIVEC_OR_VSX_P (TImode))
#define HAVE_altivec_vselkf4 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (KFmode)) && (FLOAT128_VECTOR_P (KFmode)))
#define HAVE_altivec_vseltf4 ((VECTOR_MEM_ALTIVEC_OR_VSX_P (TFmode)) && (FLOAT128_VECTOR_P (TFmode)))
...
#define HAVE_vsldb_v1ti (TARGET_POWER10)
#define HAVE_vsrdb_v1ti (TARGET_POWER10)
#define HAVE_vstrir_direct_v8hi (TARGET_POWER10)
#define HAVE_vstrir_direct_v16qi (TARGET_POWER10)
#define HAVE_vstrir_p_direct_v8hi (TARGET_POWER10)
#define HAVE_vstrir_p_direct_v16qi (TARGET_POWER10)
#define HAVE_vstril_direct_v8hi (TARGET_POWER10)
#define HAVE_vstril_direct_v16qi (TARGET_POWER10)
#define HAVE_vstril_p_direct_v8hi (TARGET_POWER10)
#define HAVE_vstril_p_direct_v16qi (TARGET_POWER10)
...
#define HAVE_altivec_vmrghb_direct_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghb_direct_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghh_direct_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghh_direct_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghw_direct_v4sf_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghw_direct_v4si_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghw_direct_v4sf_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrghw_direct_v4si_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglb_direct_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglb_direct_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglh_direct_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglh_direct_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglw_direct_v4sf_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglw_direct_v4si_be (TARGET_ALTIVEC && BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglw_direct_v4sf_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
#define HAVE_altivec_vmrglw_direct_v4si_le (TARGET_ALTIVEC && !BYTES_BIG_ENDIAN)
...
#define HAVE_altivec_vrlw (VECTOR_UNIT_ALTIVEC_P (V4SImode))
#define HAVE_altivec_vrlh (VECTOR_UNIT_ALTIVEC_P (V8HImode))
#define HAVE_altivec_vrlb (VECTOR_UNIT_ALTIVEC_P (V16QImode))
#define HAVE_altivec_vrld (VECTOR_UNIT_P8_VECTOR_P (V2DImode))
...
#define HAVE_altivec_vupkhsw_direct (VECTOR_UNIT_P8_VECTOR_P (V2DImode))
#define HAVE_altivec_vupkhsh_direct (VECTOR_UNIT_ALTIVEC_P (V4SImode))
#define HAVE_altivec_vupkhsb_direct (VECTOR_UNIT_ALTIVEC_P (V8HImode))
...
#define HAVE_uabdv4si3 (TARGET_P9_VECTOR)
#define HAVE_uabdv8hi3 (TARGET_P9_VECTOR)
#define HAVE_uabdv16qi3 (TARGET_P9_VECTOR)
#define HAVE_rs6000_vprtybv8hi2 (TARGET_P9_VECTOR)
#define HAVE_rs6000_vprtybv4si2 (TARGET_P9_VECTOR)
#define HAVE_rs6000_vprtybv2di2 (TARGET_P9_VECTOR)
#define HAVE_rs6000_vprtybv1ti2 (TARGET_P9_VECTOR)
#define HAVE_rs6000_vprtybti2 (TARGET_P9_VECTOR)
#define HAVE_p8v_vgbbd (TARGET_P8_VECTOR)
#define HAVE_addv1ti3 (TARGET_VADDUQM)
#define HAVE_altivec_vaddcuq (TARGET_VADDUQM)
#define HAVE_subv1ti3 (TARGET_VADDUQM)
...
#define HAVE_dfp_dqua_dd (TARGET_DFP)
#define HAVE_dfp_dqua_td (TARGET_DFP)
#define HAVE_dfp_dquai_dd (TARGET_DFP)
#define HAVE_dfp_dquai_td (TARGET_DFP)
...
#define HAVE_umaddditi4 (TARGET_MADDLD && TARGET_POWERPC64)
...
#define HAVE_fmodsf3 (TARGET_HARD_FLOAT \
   && TARGET_FPRND \
   && flag_unsafe_math_optimizations)
#define HAVE_fmoddf3 (TARGET_HARD_FLOAT \
   && TARGET_FPRND \
   && flag_unsafe_math_optimizations)
#define HAVE_remaindersf3 (TARGET_HARD_FLOAT \
   && TARGET_FPRND \
   && flag_unsafe_math_optimizations)
#define HAVE_remainderdf3 (TARGET_HARD_FLOAT \
   && TARGET_FPRND \
   && flag_unsafe_math_optimizations)
...
#define HAVE_movkfcc ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_movtfcc ((TARGET_POWER10 && TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
...
#define HAVE_floatqisf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floathisf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatqidf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floathidf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatunsqisf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatunshisf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatunsqidf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
#define HAVE_floatunshidf2 (TARGET_P9_VECTOR && TARGET_DIRECT_MOVE_64BIT)
...
#define HAVE_lrintsfsi2 (TARGET_HARD_FLOAT && TARGET_STFIWX)
#define HAVE_lrintdfsi2 (TARGET_HARD_FLOAT && TARGET_STFIWX)
#define HAVE_lroundsfdi2 (TARGET_HARD_FLOAT && TARGET_VSX && TARGET_FCTID)
#define HAVE_lrounddfdi2 (TARGET_HARD_FLOAT && TARGET_VSX && TARGET_FCTID)
...
#define HAVE_fegetroundsi (TARGET_HARD_FLOAT)
#define HAVE_feclearexceptsi (TARGET_HARD_FLOAT)
#define HAVE_feraiseexceptsi (TARGET_HARD_FLOAT)
...
#define HAVE_andnti3 1
#define HAVE_andnpti3 1
#define HAVE_andnv16qi3 (TARGET_ALTIVEC)
#define HAVE_andnv8hi3 (TARGET_ALTIVEC)
#define HAVE_andnv4si3 (TARGET_ALTIVEC)
#define HAVE_andnv4sf3 (TARGET_ALTIVEC)
#define HAVE_andnv2di3 (TARGET_ALTIVEC)
#define HAVE_andnv2df3 (TARGET_ALTIVEC)
#define HAVE_andnv1ti3 (TARGET_ALTIVEC)
...
#define HAVE_iornti3 1
#define HAVE_iornpti3 1
#define HAVE_iornv16qi3 ((V16QImode == TImode || V16QImode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv8hi3 ((V8HImode == TImode || V8HImode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv4si3 ((V4SImode == TImode || V4SImode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv4sf3 ((V4SFmode == TImode || V4SFmode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv2di3 ((V2DImode == TImode || V2DImode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv2df3 ((V2DFmode == TImode || V2DFmode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
#define HAVE_iornv1ti3 ((V1TImode == TImode || V1TImode == PTImode || TARGET_P8_VECTOR) && (TARGET_ALTIVEC))
...
#define HAVE_extenddfkf2 ((TARGET_HARD_FLOAT \
   && (TARGET_LONG_DOUBLE_128 || FLOAT128_IEEE_P (KFmode))) && (TARGET_FLOAT128_TYPE))
#define HAVE_extenddfif2 ((TARGET_HARD_FLOAT \
   && (TARGET_LONG_DOUBLE_128 || FLOAT128_IEEE_P (IFmode))) && (TARGET_FLOAT128_TYPE))
#define HAVE_extenddftf2 ((TARGET_HARD_FLOAT \
   && (TARGET_LONG_DOUBLE_128 || FLOAT128_IEEE_P (TFmode))) && (TARGET_LONG_DOUBLE_128))
...
#define HAVE_extendkftf2 (TARGET_FLOAT128_TYPE)
#define HAVE_trunciftf2 (TARGET_FLOAT128_TYPE)
#define HAVE_trunctfkf2 (TARGET_FLOAT128_TYPE)
#define HAVE_truncifkf2 (TARGET_FLOAT128_TYPE)
#define HAVE_extendkfif2 (TARGET_FLOAT128_TYPE)
...
#define HAVE_darn_32_si (TARGET_P9_MISC)
#define HAVE_darn_32_di ((TARGET_P9_MISC) && (TARGET_POWERPC64))
#define HAVE_darn_64_si (TARGET_P9_MISC)
#define HAVE_darn_64_di ((TARGET_P9_MISC) && (TARGET_POWERPC64))
#define HAVE_darn_raw_si (TARGET_P9_MISC)
#define HAVE_darn_raw_di ((TARGET_P9_MISC) && (TARGET_POWERPC64))
...
#define HAVE_vec_cmpv1tiv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vec_cmpuv1tiv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_nltv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_gtuv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_nltuv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_geuv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_ngtv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_ngtuv1ti ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vector_gtu_v1ti_p ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vec_shr_v16qi (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V16QImode))
#define HAVE_vec_shr_v8hi (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V8HImode))
#define HAVE_vec_shr_v4si (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V4SImode))
#define HAVE_vec_shr_v2di (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V2DImode))
#define HAVE_vec_shr_v4sf (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V4SFmode))
#define HAVE_vec_shr_v2df (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V2DFmode))
#define HAVE_vec_shr_v1ti (VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode))
#define HAVE_vec_shr_ti (VECTOR_UNIT_ALTIVEC_OR_VSX_P (TImode))
#define HAVE_vec_shr_kf (VECTOR_UNIT_ALTIVEC_OR_VSX_P (KFmode))
#define HAVE_vec_shr_tf (VECTOR_UNIT_ALTIVEC_OR_VSX_P (TFmode))
...
#define HAVE_vrotlv1ti3 ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vashrv1ti3 ((VECTOR_UNIT_ALTIVEC_OR_VSX_P (V1TImode)) && (TARGET_POWER10))
...
#define HAVE_vsignede_v4sf (VECTOR_UNIT_VSX_P (V2DFmode))
#define HAVE_vsignedo_v4sf (VECTOR_UNIT_VSX_P (V2DFmode))
#define HAVE_vunsignede_v4sf (VECTOR_UNIT_VSX_P (V2DFmode))
#define HAVE_vunsignedo_v4sf (VECTOR_UNIT_VSX_P (V2DFmode))
...
#define HAVE_vsx_extract_v4si (TARGET_DIRECT_MOVE_64BIT)
...
#define HAVE_xscmpexpqp_eq_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xscmpexpqp_lt_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xscmpexpqp_gt_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xscmpexpqp_unordered_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xscmpexpqp_eq_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xscmpexpqp_lt_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xscmpexpqp_gt_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xscmpexpqp_unordered_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xststdc_sf (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (SFmode) || TARGET_FLOAT128_HW))
#define HAVE_xststdc_df (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (DFmode) || TARGET_FLOAT128_HW))
#define HAVE_xststdc_kf ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (KFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xststdc_tf ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (TFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_isinfsf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (SFmode) || TARGET_FLOAT128_HW))
#define HAVE_isinfdf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (DFmode) || TARGET_FLOAT128_HW))
#define HAVE_isinfkf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (KFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_isinftf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (TFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_isfinitesf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (SFmode) || TARGET_FLOAT128_HW))
#define HAVE_isfinitedf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (DFmode) || TARGET_FLOAT128_HW))
#define HAVE_isfinitekf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (KFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_isfinitetf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (TFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_isnormalsf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (SFmode) || TARGET_FLOAT128_HW))
#define HAVE_isnormaldf2 (TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (DFmode) || TARGET_FLOAT128_HW))
#define HAVE_isnormalkf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (KFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_isnormaltf2 ((TARGET_P9_VECTOR \
   && (!FLOAT128_IEEE_P (TFmode) || TARGET_FLOAT128_HW)) && (FLOAT128_IEEE_P (TFmode)))
#define HAVE_xststdcnegqp_kf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (KFmode)))
#define HAVE_xststdcnegqp_tf ((TARGET_FLOAT128_HW) && (FLOAT128_IEEE_P (TFmode)))
...
#define HAVE_cbranchv16qi4 (VECTOR_MEM_VSX_P (V16QImode) \
   && TARGET_EFFICIENT_UNALIGNED_VSX)
#define HAVE_altivec_vcmpne_v16qi (TARGET_ALTIVEC)
#define HAVE_altivec_vcmpne_v8hi (TARGET_ALTIVEC)
#define HAVE_altivec_vcmpne_v4si (TARGET_ALTIVEC)
...
#define HAVE_udot_prodv4siv8hi (TARGET_ALTIVEC)
#define HAVE_udot_prodv4siv16qi (TARGET_ALTIVEC)
#define HAVE_sdot_prodv4siv8hi (TARGET_ALTIVEC)
...
static inline rtx gen_machopic_high_si                  (rtx, rtx);
static inline rtx
gen_machopic_high_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_machopic_high_di                  (rtx, rtx);
static inline rtx
gen_machopic_high_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_machopic_low_si                   (rtx, rtx, rtx);
static inline rtx
gen_machopic_low_si(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_machopic_low_di                   (rtx, rtx, rtx);
static inline rtx
gen_machopic_low_di(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_maddldsi4                         (rtx, rtx, rtx, rtx);
extern rtx        gen_maddlddi4                         (rtx, rtx, rtx, rtx);
extern rtx        gen_madddi4_highpart                  (rtx, rtx, rtx, rtx);
extern rtx        gen_umadddi4_highpart                 (rtx, rtx, rtx, rtx);
extern rtx        gen_madddi4_highpart_le               (rtx, rtx, rtx, rtx);
extern rtx        gen_umadddi4_highpart_le              (rtx, rtx, rtx, rtx);
...
static inline rtx gen_umodti3                           (rtx, rtx, rtx);
static inline rtx
gen_umodti3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_modti3                            (rtx, rtx, rtx);
static inline rtx
gen_modti3(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_signbitkf2_dm_mem                 (rtx, rtx);
extern rtx        gen_signbittf2_dm_mem                 (rtx, rtx);
...
extern rtx        gen_isel_cc_si                        (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_isel_cc_di                        (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_isel_ccuns_si                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_isel_ccuns_di                     (rtx, rtx, rtx, rtx, rtx);
extern rtx        gen_setbc_cc_si                       (rtx, rtx, rtx);
extern rtx        gen_setbc_cc_di                       (rtx, rtx, rtx);
extern rtx        gen_setbc_ccuns_si                    (rtx, rtx, rtx);
extern rtx        gen_setbc_ccuns_di                    (rtx, rtx, rtx);
...
extern rtx        gen_floatsisf2_lfiwax_qi_mem_zext     (rtx, rtx);
extern rtx        gen_floatsisf2_lfiwax_hi_mem_zext     (rtx, rtx);
extern rtx        gen_floatsidf2_lfiwax_qi_mem_zext     (rtx, rtx);
extern rtx        gen_floatsidf2_lfiwax_hi_mem_zext     (rtx, rtx);
...
extern rtx        gen_rs6000_mffscrni                   (rtx, rtx);
...
extern rtx        gen_lrintsfsi_di                      (rtx, rtx);
extern rtx        gen_lrintdfsi_di                      (rtx, rtx);
...
extern rtx        gen_movsf_from_si2_ashiftrt           (rtx, rtx, rtx, rtx);
extern rtx        gen_movsf_from_si2_lshiftrt           (rtx, rtx, rtx, rtx);
extern rtx        gen_xxspltidp_sf_internal             (rtx, rtx);
extern rtx        gen_xxspltidp_df_internal             (rtx, rtx);
extern rtx        gen_xxspltiw_sf_internal              (rtx, rtx);
extern rtx        gen_xxspltiw_df_internal              (rtx, rtx);
...
extern rtx        gen_packtf_hard                       (rtx, rtx, rtx);
extern rtx        gen_packif_hard                       (rtx, rtx, rtx);
extern rtx        gen_packtd_hard                       (rtx, rtx, rtx);
extern rtx        gen_packtf_soft                       (rtx, rtx, rtx);
static inline rtx gen_packif_soft                       (rtx, rtx, rtx);
static inline rtx
gen_packif_soft(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
static inline rtx gen_packtd_soft                       (rtx, rtx, rtx);
static inline rtx
gen_packtd_soft(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c))
{
  return 0;
}
...
extern rtx        gen_darnsi                            (rtx, rtx);
extern rtx        gen_darndi                            (rtx, rtx);
...
extern rtx        gen_vsx_stxvd2x4_le_const_v4sf        (rtx, rtx);
extern rtx        gen_vsx_stxvd2x4_le_const_v4si        (rtx, rtx);
...
extern rtx        gen_vsx_extract_v4si_w1               (rtx, rtx, rtx);
...
extern rtx        gen_vreplace_un_si                    (rtx, rtx, rtx, rtx);
extern rtx        gen_vreplace_un_sf                    (rtx, rtx, rtx, rtx);
extern rtx        gen_vreplace_un_di                    (rtx, rtx, rtx, rtx);
extern rtx        gen_vreplace_un_df                    (rtx, rtx, rtx, rtx);
...
extern rtx        gen_vsx_sign_extend_v16qi_v4si        (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v16qi_v2di        (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v16qi_di          (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v16qi_si          (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v8hi_v4si         (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v8hi_v2di         (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v8hi_di           (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v8hi_si           (rtx, rtx);
extern rtx        gen_vsx_sign_extend_v4si_v2di         (rtx, rtx);
extern rtx        gen_extendditi2                       (rtx, rtx);
extern rtx        gen_extendditi2_vector                (rtx, rtx);
extern rtx        gen_xsxexpqp_kf_v2di                  (rtx, rtx);
extern rtx        gen_xsxexpqp_kf_di                    (rtx, rtx);
extern rtx        gen_xsxexpqp_tf_v2di                  (rtx, rtx);
extern rtx        gen_xsxexpqp_tf_di                    (rtx, rtx);
extern rtx        gen_xsxexpdp_si                       (rtx, rtx);
extern rtx        gen_xsxexpdp_di                       (rtx, rtx);
extern rtx        gen_xsxsigqp_kf_v1ti                  (rtx, rtx);
extern rtx        gen_xsxsigqp_tf_v1ti                  (rtx, rtx);
extern rtx        gen_xsxsigqp_kf_ti                    (rtx, rtx);
extern rtx        gen_xsxsigqp_tf_ti                    (rtx, rtx);
extern rtx        gen_xsxsigdp                          (rtx, rtx);
extern rtx        gen_xsiexpqpf_kf                      (rtx, rtx, rtx);
extern rtx        gen_xsiexpqpf_tf                      (rtx, rtx, rtx);
extern rtx        gen_xsiexpqp_kf_v2di                  (rtx, rtx, rtx);
extern rtx        gen_xsiexpqp_kf_di                    (rtx, rtx, rtx);
extern rtx        gen_xsiexpqp_tf_v2di                  (rtx, rtx, rtx);
extern rtx        gen_xsiexpqp_tf_di                    (rtx, rtx, rtx);
extern rtx        gen_xsiexpdp_si                       (rtx, rtx, rtx);
extern rtx        gen_xsiexpdp_di                       (rtx, rtx, rtx);
extern rtx        gen_xsiexpdpf_si                      (rtx, rtx, rtx);
extern rtx        gen_xsiexpdpf_di                      (rtx, rtx, rtx);
...
extern rtx        gen_smulv2di3_highpart                (rtx, rtx, rtx);
extern rtx        gen_smulv4si3_highpart                (rtx, rtx, rtx);
extern rtx        gen_umulv2di3_highpart                (rtx, rtx, rtx);
extern rtx        gen_umulv4si3_highpart                (rtx, rtx, rtx);
...
extern rtx        gen_vmsumcud                          (rtx, rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv4si                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv8hi                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv16qi                 (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv4sf                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv2df                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv2di                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movv1ti                  (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movti                    (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movkf                    (rtx, rtx, rtx);
extern rtx        gen_sldoi_to_movtf                    (rtx, rtx, rtx);
...
extern rtx        gen_altivec_vselv4si                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv8hi                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv16qi                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4sf                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2df                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2di                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv1ti                  (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselti                    (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselkf                    (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vseltf                    (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4si2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv8hi2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv16qi2                (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4sf2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2df2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2di2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv1ti2                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselti2                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselkf2                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vseltf2                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4si3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv8hi3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv16qi3                (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4sf3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2df3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2di3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv1ti3                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselti3                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselkf3                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vseltf3                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4si4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv8hi4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv16qi4                (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv4sf4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2df4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv2di4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselv1ti4                 (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselti4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vselkf4                   (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vseltf4                   (rtx, rtx, rtx, rtx);
...
extern rtx        gen_vsldb_v1ti                        (rtx, rtx, rtx, rtx);
extern rtx        gen_vsrdb_v1ti                        (rtx, rtx, rtx, rtx);
extern rtx        gen_vstrir_direct_v8hi                (rtx, rtx);
extern rtx        gen_vstrir_direct_v16qi               (rtx, rtx);
extern rtx        gen_vstrir_p_direct_v8hi              (rtx, rtx);
extern rtx        gen_vstrir_p_direct_v16qi             (rtx, rtx);
extern rtx        gen_vstril_direct_v8hi                (rtx, rtx);
extern rtx        gen_vstril_direct_v16qi               (rtx, rtx);
extern rtx        gen_vstril_p_direct_v8hi              (rtx, rtx);
extern rtx        gen_vstril_p_direct_v16qi             (rtx, rtx);
...
extern rtx        gen_altivec_vmrghb_direct_be          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghb_direct_le          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghh_direct_be          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghh_direct_le          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghw_direct_v4sf_be     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghw_direct_v4si_be     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghw_direct_v4sf_le     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrghw_direct_v4si_le     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglb_direct_be          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglb_direct_le          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglh_direct_be          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglh_direct_le          (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4sf_be     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4si_be     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4sf_le     (rtx, rtx, rtx);
extern rtx        gen_altivec_vmrglw_direct_v4si_le     (rtx, rtx, rtx);
...
extern rtx        gen_altivec_vrld                      (rtx, rtx, rtx);
...
extern rtx        gen_altivec_vupkhsw_direct            (rtx, rtx);
extern rtx        gen_altivec_vupkhsh_direct            (rtx, rtx);
extern rtx        gen_altivec_vupkhsb_direct            (rtx, rtx);
...
extern rtx        gen_uabdv4si3                         (rtx, rtx, rtx);
extern rtx        gen_uabdv8hi3                         (rtx, rtx, rtx);
extern rtx        gen_uabdv16qi3                        (rtx, rtx, rtx);
extern rtx        gen_rs6000_vprtybv8hi2                (rtx, rtx);
extern rtx        gen_rs6000_vprtybv4si2                (rtx, rtx);
extern rtx        gen_rs6000_vprtybv2di2                (rtx, rtx);
extern rtx        gen_rs6000_vprtybv1ti2                (rtx, rtx);
extern rtx        gen_rs6000_vprtybti2                  (rtx, rtx);
...
extern rtx        gen_dfp_dqua_dd                       (rtx, rtx, rtx, rtx);
extern rtx        gen_dfp_dqua_td                       (rtx, rtx, rtx, rtx);
extern rtx        gen_dfp_dquai_dd                      (rtx, rtx, rtx, rtx);
extern rtx        gen_dfp_dquai_td                      (rtx, rtx, rtx, rtx);
...
extern rtx        gen_rs6000_set_fpscr_rn               (rtx, rtx);
...
extern rtx        gen_fegetroundsi                      (rtx);
extern rtx        gen_feclearexceptsi                   (rtx, rtx);
extern rtx        gen_feraiseexceptsi                   (rtx, rtx);
...
extern rtx        gen_andnti3                           (rtx, rtx, rtx);
extern rtx        gen_andnpti3                          (rtx, rtx, rtx);
extern rtx        gen_andnv16qi3                        (rtx, rtx, rtx);
extern rtx        gen_andnv8hi3                         (rtx, rtx, rtx);
extern rtx        gen_andnv4si3                         (rtx, rtx, rtx);
extern rtx        gen_andnv4sf3                         (rtx, rtx, rtx);
extern rtx        gen_andnv2di3                         (rtx, rtx, rtx);
extern rtx        gen_andnv2df3                         (rtx, rtx, rtx);
extern rtx        gen_andnv1ti3                         (rtx, rtx, rtx);
...
extern rtx        gen_iornti3                           (rtx, rtx, rtx);
extern rtx        gen_iornpti3                          (rtx, rtx, rtx);
extern rtx        gen_iornv16qi3                        (rtx, rtx, rtx);
extern rtx        gen_iornv8hi3                         (rtx, rtx, rtx);
extern rtx        gen_iornv4si3                         (rtx, rtx, rtx);
extern rtx        gen_iornv4sf3                         (rtx, rtx, rtx);
extern rtx        gen_iornv2di3                         (rtx, rtx, rtx);
extern rtx        gen_iornv2df3                         (rtx, rtx, rtx);
extern rtx        gen_iornv1ti3                         (rtx, rtx, rtx);
...
extern rtx        gen_extendkfif2                       (rtx, rtx);
...
extern rtx        gen_darn_32_si                        (rtx);
extern rtx        gen_darn_32_di                        (rtx);
extern rtx        gen_darn_64_si                        (rtx);
extern rtx        gen_darn_64_di                        (rtx);
extern rtx        gen_darn_raw_si                       (rtx);
extern rtx        gen_darn_raw_di                       (rtx);
...
extern rtx        gen_vec_cmpuv1tiv1ti                  (rtx, rtx, rtx, rtx);
...
extern rtx        gen_vector_geuv1ti                    (rtx, rtx, rtx);
...
extern rtx        gen_vsignede_v4sf                     (rtx, rtx);
extern rtx        gen_vsignedo_v4sf                     (rtx, rtx);
extern rtx        gen_vunsignede_v4sf                   (rtx, rtx);
extern rtx        gen_vunsignedo_v4sf                   (rtx, rtx);
...
extern rtx        gen_xststdc_sf                        (rtx, rtx, rtx);
extern rtx        gen_xststdc_df                        (rtx, rtx, rtx);
extern rtx        gen_xststdc_kf                        (rtx, rtx, rtx);
extern rtx        gen_xststdc_tf                        (rtx, rtx, rtx);
extern rtx        gen_isinfsf2                          (rtx, rtx);
extern rtx        gen_isinfdf2                          (rtx, rtx);
extern rtx        gen_isinfkf2                          (rtx, rtx);
extern rtx        gen_isinftf2                          (rtx, rtx);
extern rtx        gen_isfinitesf2                       (rtx, rtx);
extern rtx        gen_isfinitedf2                       (rtx, rtx);
extern rtx        gen_isfinitekf2                       (rtx, rtx);
extern rtx        gen_isfinitetf2                       (rtx, rtx);
extern rtx        gen_isnormalsf2                       (rtx, rtx);
extern rtx        gen_isnormaldf2                       (rtx, rtx);
extern rtx        gen_isnormalkf2                       (rtx, rtx);
extern rtx        gen_isnormaltf2                       (rtx, rtx);
...
extern rtx        gen_len_load_v16qi                    (rtx, rtx, rtx, rtx);
extern rtx        gen_len_store_v16qi                   (rtx, rtx, rtx, rtx);
...
extern rtx        gen_altivec_vcmpne_v16qi              (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vcmpne_v8hi               (rtx, rtx, rtx, rtx);
extern rtx        gen_altivec_vcmpne_v4si               (rtx, rtx, rtx, rtx);
