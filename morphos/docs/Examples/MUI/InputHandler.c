...
ULONG mCleanup(struct IClass *cl,Object *obj,Msg msg)
{
	...
	if (!CheckIO((struct IORequest *)data->req)) AbortIO((struct IORequest *)data->req);
...
int main(int argc,char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: Class5 20.165 (04.04.03)",
