...
APTR MakePage3(VOID)
{
					...
					Child, HGroup,
						...
						Child, VGroup,
							Child, ColGroup(2), GroupFrameT("Cycle Gadgets"),
								...
								End,
							Child, LV_Computer =	ListObject, InputListFrame, End,
	/*
	...
	*/
							End,
						End,
	//				Child, o2 = ScrollgroupObject, MUIA_Scrollgroup_Contents, VGroupV, VirtualFrame,
							Child, ColGroup(4), GroupFrameT("Button Field"),
								Child, BT_Button[ 0] = SimpleButton("Button0"),
								Child, BT_Button[ 1] = SimpleButton("Button1"),
	...
	//if (BT_Button[0]) DoMethod(BT_Button[0],MUIM_Notify,MUIA_Pressed,FALSE,obj,3,MUIM_Set,MUIA_Scrollgroup_NoVertBar,TRUE);
	//if (BT_Button[1]) DoMethod(BT_Button[1],MUIM_Notify,MUIA_Pressed,FALSE,obj,3,MUIM_Set,MUIA_Scrollgroup_NoVertBar,FALSE);

/*
	if (o2)
	{
		DoMethod(_parent(o2),OM_REMMEMBER,o2);
		set(o2,MUIA_Scrollgroup_NoVertBar,TRUE);
...
//static char *x4Sex[]     = { "male","female",NULL };
static char *x4Pages[]   = { "Race","Class","Armors","Weapons","Levels",NULL };
static char *x4Races[]   = { "Human","Elf","Dwarf","Hobbit","Gnome",NULL };
static char *x4Classes[] = { "Warrior","Rogue","Bard","Monk","Magician","Archmage",NULL };
static char *x4Weapons[] = { "Staff","Dagger","Sword","Axe","Grenade",NULL };
...
int main(int argc,char *argv[])
{
	...
	app = ApplicationObject,
		...
		MUIA_Application_Version    , "$VER: VirtualDemo 20.177 (15.05.03)",
